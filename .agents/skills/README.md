...
| [`shopware-fuzz-tests`](shopware-fuzz-tests/SKILL.md) | "add a fuzz test", "is this a good fuzz target", "design an Eris generator", "why did this fuzz test fail" | Applies Shopware's property-based/fuzz testing conventions under `tests/fuzz` — invariant design, Eris generators, and reproducing failures. |
