...
|---|---|---|---|
| `bugfixer` | `qi:fix` issue label, `workflow_dispatch`, `/bugfixer ...` on PRs | `claude` / `claude-sonnet-4-6` | draft PR via `create-pull-request`, PR branch update via `push-to-pull-request-branch`, comment/no-op |
