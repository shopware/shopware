...
BRANCH_MATCHING_REGEX="${BRANCH_MATCHING_REGEX:-"^(trunk|6\\.4|6\\.[0-9]+\\.[0-9]+\\.0)\$"}"
BRANCH_DENY_REGEX="${BRANCH_DENY_REGEX:-"^(next|ntr)-"}"
...
echo "$BRANCH_MATCHING_REGEX"
echo "$BRANCH_DENY_REGEX"
