...
* Core
    ...
    * Changed `product.listing_prices` data structure. The new structure will be applied over the `\Shopware\Core\Content\Product\DataAbstractionLayer\ProductIndexer`
