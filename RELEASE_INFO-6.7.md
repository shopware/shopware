...
The DAL field, the `sales_channel.maintenance_ip_whitelist` database column and the Admin API field are intentionally left unchanged and will be renamed with Shopware 6.8.
