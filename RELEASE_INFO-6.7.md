...
Document V2 can now open and download files generated by Document V1, including legacy files in the V2 archive download. Document V1 can also open and download files generated by Document V2 when the `DOCUMENT_GENERATION_REWORK` feature flag is disabled.
