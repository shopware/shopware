...
ALTER TABLE `blog_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `blog_media`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `blog_product`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `blog_tag`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `category_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `category_avoid_customer_group`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `config_form`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `config_form_field`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `config_form_field_value`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `currency`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer_address`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer_address_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer_group`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer_group_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `customer_group_discount`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_option`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_option_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_product`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_relation`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_value`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `filter_value_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `holiday`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `listing_facet`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `listing_sorting`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `locale`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `log`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `mail`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `mail_attachment`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `mail_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `media_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `order`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `order_address`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `order_delivery`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `order_delivery_position`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `order_line_item`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `order_state`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `payment_method`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `payment_method_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `payment_method_country`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `payment_method_shop`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `plugin_category`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `premium_product`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `price_group`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `price_group_discount`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_accessory`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_also_bought_ro`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_attachment`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_attachment_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `product_configurator_option`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_option_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_option_relation`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_price_variation`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_set`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_set_group_relation`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_set_option_relation`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_template`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `product_media_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_media_mapping`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_media_mapping_rule`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_similar`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_stream`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_stream_assignment`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_stream_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_stream_tab`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `product_top_seller_ro`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_category`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_country`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_holiday`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_payment_method`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_price`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_currency`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_form`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_form_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_page`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_page_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_page_group`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_page_group_mapping`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_template`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_form`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_form_field`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_form_field_value`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_preset`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shopping_world_component`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `shopping_world_component_field`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `statistic_address_pool`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `statistic_current_customer`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `statistic_product_impression`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `statistic_referer`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `tax`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `tax_area_rule`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
...
ALTER TABLE `user_attribute`  ADD COLUMN `created_at`     DATETIME DEFAULT CURRENT_TIMESTAMP;
ALTER TABLE `album` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `area` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `area_country` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `area_country_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `area_country_state` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `area_country_state_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `attribute_configuration` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `blog` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `blog_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `blog_comment` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `blog_media` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `blog_product` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `blog_tag` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `category_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `category_avoid_customer_group` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `config_form` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `config_form_field` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `config_form_field_value` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `currency` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer_address` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer_address_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer_group` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer_group_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `customer_group_discount` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_option` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_option_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_product` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_relation` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_value` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `filter_value_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `holiday` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `listing_facet` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `listing_sorting` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `locale` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `log` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `mail` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `mail_attachment` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `mail_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `media_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `order` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `order_address` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `order_delivery` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `order_delivery_position` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `order_line_item` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `order_state` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `payment_method` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `payment_method_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `payment_method_country` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `payment_method_shop` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `plugin` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `plugin_category` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `premium_product` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `price_group` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `price_group_discount` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_accessory` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_also_bought_ro` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_attachment` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_attachment_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_avoid_customer_group` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_category` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_category_ro` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_category_seo` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_dependency` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_group` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_group_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_option` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_option_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_option_relation` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_price_variation` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_set` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_set_group_relation` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_set_option_relation` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_template` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_template_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_template_price` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_configurator_template_price_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_detail` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_detail_price` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_detail_price_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_esd` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_esd_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_esd_serial` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_link` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_link_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_listing_price_ro` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_manufacturer_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_media` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_media_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_media_mapping` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_media_mapping_rule` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_notification` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_similar` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_similar_shown_ro` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_stream` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_stream_assignment` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_stream_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_stream_tab` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_top_seller_ro` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `product_vote` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `seo_url` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_category` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_country` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_holiday` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_payment_method` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shipping_method_price` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_currency` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_form` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_form_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_form_field` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_page` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_page_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_page_group` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_page_group_mapping` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_template` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_form` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_form_field` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_form_field_value` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shop_template_config_preset` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shopping_world_component` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `shopping_world_component_field` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `statistic_address_pool` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `statistic_current_customer` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `statistic_product_impression` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `statistic_referer` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `statistic_search` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `statistic_visitor` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `tax` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `tax_area_rule` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `unit` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `user` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;
ALTER TABLE `user_attribute` ADD COLUMN `updated_at` DATETIME ON UPDATE CURRENT_TIMESTAMP;