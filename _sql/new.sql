CREATE TABLE `product_detail_translation` (
  `product_detail_uuid` VARCHAR(42) NOT NULL COLLATE 'utf8_unicode_ci',
  `language_uuid` VARCHAR(42) NOT NULL COLLATE 'utf8_unicode_ci',
  `additional_text` VARCHAR(255) NOT NULL DEFAULT '' COLLATE 'utf8_unicode_ci',
  `pack_unit` VARCHAR(255) NULL DEFAULT NULL DEFAULT '' COLLATE 'utf8_unicode_ci',
