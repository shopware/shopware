...
**This part of the decision is superseded by [2026-08-11 - Remove product.available_stock](2026-08-11-remove-product-available-stock.md): the field, the column and `AvailableStockMirrorSubscriber` are removed in 6.8. The rest of this ADR is untouched.**
