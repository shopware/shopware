...
* Change block `sw_category_detail_product_assignment_column_name` in `administration/Resources/app/administration/src/module/sw-category/view/sw-category-detail-products/sw-category-detail-products.html.twig` to fetch the product name with the new function `getItemName`
