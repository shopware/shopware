...
---
# Core
* Changed `src/Core/Content/Product/Cms/ProductListingCmsElementResolver.php` to load all active sorting options once from the db and reuse them later.
* Changed `src/Core/Content/Product/SalesChannel/Listing/Processor/SortingListingProcessor.php` to reuse getAvailableSortings data if present otherwise load all active global defined sorting options.
