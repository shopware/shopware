...
* Add the new component `sw-cms-inherit-wrapper` to indicate and control inherited layout content on content pages. It emits the two events `inheritance:remove` and `inheritance:restore` for individual slot config fields.
