...
* Added a limit of 100 nested criteria to `Shopware\Core\System\SalesChannel\Entity\SalesChannelRepository`. A criteria above that limit triggers a deprecation notice and will be rejected from 6.7.0.0. No storefront request builds a criteria of that size; integrations that do should split it into several requests.
