...
---
# Storefront
* Changed the behaviour of the footer collapse panels on mobile to improve the accessibility. The changes are implemented behind the feature flag `ACCESSIBILITY_TWEAKS`:
