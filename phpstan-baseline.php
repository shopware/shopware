...
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::update() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Administration/Framework/App/Subscriber/SystemLanguageChangedSubscriber.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::search() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Administration/Service/AdminSearcher.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::search() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
...
$ignoreErrors[] = [
    ...
    'identifier' => 'shopware.queryInLoop',
    'count' => 2,
    'path' => __DIR__ . '/src/Core/Content/Cms/DataResolver/CmsSlotsDataResolver.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'SalesChannelRepository::search() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 2,
    'path' => __DIR__ . '/src/Core/Content/Cms/DataResolver/CmsSlotsDataResolver.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::searchIds() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Content/ImportExport/DataAbstractionLayer/Serializer/Entity/ProductCrossSellingSerializer.php',
];
...
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchAssociative() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Content/Media/DataAbstractionLayer/MediaFolderIndexer.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchFirstColumn() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 3,
    'path' => __DIR__ . '/src/Core/Content/Media/Subscriber/CustomFieldsUnusedMediaSubscriber.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::searchIds() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
...
$ignoreErrors[] = [
    ...
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Content/ProductExport/EventListener/ProductExportEventListener.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::update() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
...
$ignoreErrors[] = [
    ...
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Content/Seo/SalesChannel/StoreApiSeoResolver.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Content/Seo/SeoUrlPersister.php',
];
$ignoreErrors[] = [
    ...
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/App/Lifecycle/Update/AppUpdater.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchAllAssociative() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/DataAbstractionLayer/Search/SearchConfigLoader.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::create() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Framework/Demodata/Generator/CategoryGenerator.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::upsert() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
...
$ignoreErrors[] = [
    ...
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/Traits/StateMachineMigrationImporter.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 2,
    'path' => __DIR__ . '/src/Core/Migration/V6_3/Migration1563180880AddDefaultThumbnailSizes.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_3/Migration1584002637NewImportExport.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_3/Migration1589357321AddCountries.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_3/Migration1604499476AddDefaultSettingConfigValueForContactForm.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_4/Migration1620820321AddDefaultDomainForHeadlessSaleschannel.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
...
$ignoreErrors[] = [
    ...
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_6/Migration1736824370MigrationMailTemplateForDocument.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchOne() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_6/Migration1737105721MigrateOrderStateChangeDocumentToA11Y.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchAllAssociative() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/Migration/V6_7/Migration1778573083ConvertCategoryNameBlockToDedicatedElement.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::executeQuery() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/System/CustomEntity/Schema/CustomEntitySchemaUpdater.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchAllKeyValue() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 2,
    'path' => __DIR__ . '/src/Core/System/CustomField/CustomFieldSetPersister.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchAllAssociative() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
...
$ignoreErrors[] = [
    'rawMessage' => 'QueryBuilder::executeQuery() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Core/System/UsageData/Services/ManyToManyAssociationService.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'Connection::fetchAllAssociativeIndexed() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Elasticsearch/Product/ElasticsearchProductDefinition.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::search() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Storefront/Checkout/Customer/CustomerGroupSubscriber.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::search() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Storefront/Theme/Command/ThemeDumpCommand.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::upsert() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
...
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::delete() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
    'count' => 1,
    'path' => __DIR__ . '/src/Storefront/Theme/ThemeLifecycleService.php',
];
$ignoreErrors[] = [
    'rawMessage' => 'EntityRepository::searchIds() is executed inside a loop, which causes an N+1 query problem. Load the data for all iterations with a single query before the loop instead.',
    'identifier' => 'shopware.queryInLoop',
