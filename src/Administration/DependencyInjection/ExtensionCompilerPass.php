...
class ExtensionCompilerPass implements CompilerPassInterface
{
    ...
    {
        $this->replaceArgumentWithTaggedServices($container, 'shopware.administration.extension.registry', 'shopware.administration.extension', 0);

        $services = $container->findTaggedServiceIds('shopware.administration.extension');
