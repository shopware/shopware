module.exports = {
    ...
    'edit country': (browser) => {
        browser
            ...
            .waitForElementPresent('.sw-country-list__country-edit-action')
            .click('.sw-country-list__country-edit-action')
            .waitForElementVisible('.sw-settings-country-detail .sw-card__content')
            .assert.containsText('.sw-card__title', 'Settings')
    ...
    'verify edited country': (browser) => {
        browser
            ...
            .waitForElementNotPresent('.sw-alert__message')
            .waitForElementVisible('.sw-country-list__column-country-name:first-child')
            .assert.containsText('.sw-country-list__column-country-name:first-child', '1.Niemandsland x2');
    },
    'delete country': (browser) => {
        browser
            ...
            .waitForElementVisible('.sw-notifications .sw-alert')
            .assert.containsText('.sw-notifications .sw-alert', 'The country 1.Niemandsland x2 has been deleted successfully.');
    },
    after: (browser) => {
        browser.end();
    }
