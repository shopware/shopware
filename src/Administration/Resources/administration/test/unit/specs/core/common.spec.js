describe('core/common.js', () => {
    it('should contain the necessary methods for the module factory', () => {
        ...
        expect(Shopware.Module).to.have.property('getRegistry');
        expect(Shopware.Module).to.have.property('getRoutes');
    });
    ...
    it('should contain the necessary methods for the component factory', () => {
        ...
        expect(Shopware.Component).to.have.property('getRegistry');
    ...
    it('should contain the necessary methods for the template factory', () => {
        ...
        expect(Shopware.Template).to.have.property('getRegistry');
        expect(Shopware.Template).to.have.property('getOverrideRegistry');
