...
// The `shopware:*` modules are generated by a Vite plugin, which Jest does not run. The specifier list
// is read once here, in the main process; `register-mocks.js` turns each one into a virtual module.
...
const shopwareVirtualModules = allSpecifiers(readRegistry(__dirname));
