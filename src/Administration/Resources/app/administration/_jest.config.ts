...
const config: Config = {
    ...
    moduleNameMapper: {
        ...
        // The `shopware:*` modules are generated by a Vite plugin, which Jest does not run. The shims
        // resolve the same exports off the global Shopware object.
        '^shopware:(utils|data|mixins|stores)$': '<rootDir>/test/_helper_/virtual-shopware-modules/$1.js',
        '^src(.*)$': '<rootDir>/src$1',
