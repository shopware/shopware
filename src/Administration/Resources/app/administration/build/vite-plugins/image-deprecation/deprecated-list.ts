// To add an image to the list use `/src/Administration/Resources/app/administration` as the root directory and begin with '/'.
...
export default [
    ...
    '/src/module/sw-login/page/index/assets/sw-login-background.webp',
];
