...
describe('build/vite-plugins/override-component-register', () => {
    ...
    it('should transform entry file correctly', () => {
        ...
        expect(result.code).toContain('Shopware.Component.registerOverrideComponent(_swspecfoo);');
        expect(result.code).toContain(
            "import _swsetupexample from './build/vite-plugins/override-component-register/_fixtures/sw-setup-example.override.vue';",
        );
        expect(result.code).toContain('Shopware.Component.registerOverrideComponent(_swsetupexample);');
