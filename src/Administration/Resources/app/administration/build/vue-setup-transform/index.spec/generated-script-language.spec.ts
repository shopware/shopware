...
describe('build/vue-setup-transform generated script language', () => {
    ...
    it('adds an explicit generated script language when override mode had no language attribute', () => {
        const source = stripIndent`
        ...
        const result = transformOrFail(source, 'override-no-lang.vue').code;
