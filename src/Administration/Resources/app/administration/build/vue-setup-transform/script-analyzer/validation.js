...
const { RESERVED_OVERRIDE_STATE_NAME } = require('./macros');
 ...
 * @param {Set<import('@babel/types').CallExpression>} topLevelPublicCalls
 * @param {Set<import('@babel/types').CallExpression>} topLevelOverrideCalls
 * @param {Set<import('@babel/types').CallExpression>} topLevelUnsupportedMacroCalls
 * @returns {void}
 */
 ...
 *
 * @param {{ name: string, node: import('@babel/types').Node }[]} bindings
