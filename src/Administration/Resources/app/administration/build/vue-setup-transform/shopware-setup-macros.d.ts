...
declare global {
     ...
     *
     * Use this in `<script setup sw-component="...">` to declare which setup
     ...
     *
     * Use this in `<script setup sw-override="...">` to declare which public base
     ...
     */
    function useSwPreviousState<TPreviousState extends Record<PropertyKey, any> = Record<PropertyKey, any>>(): TPreviousState;
