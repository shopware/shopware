 ...
 */
function assertSwBlockAttributes(
    node: ElementNode,
    mode: ShopwareSetupMode,
    templateOffset: number,
    slotDefinitions = false,
): void {
    ...
    if (authoredDefaultSlot && (!slotDefinitions || getDefaultSlotDirective(node))) {
    ...
    if (directNamedSlot && !slotDefinitions) {
        throw new ShopwareSetupTransformError(
