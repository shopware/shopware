...
export default [
    ...
    // Twig template files: Vue parser + twig-vue processor
    {
        ...
        rules: {
            ...
            'sw-deprecation-rules/no-deprecated-template-events': ['error', 'enableFix'],
            'sw-deprecation-rules/no-deprecated-template-blocks': ['error', 'enableFix'],
    ...
    })),
    {
        ...
        rules: {
            ...
            'sw-deprecation-rules/no-compat-conditions': ['error'],
            'sw-deprecation-rules/no-deprecated-js-api': ['error', 'enableFix'],
            'sw-deprecation-rules/no-deprecated-snippet-keys': 'error',
            'sw-core-rules/enforce-async-component-registers': 'error',
            'sw-deprecation-rules/no-empty-listeners': ['error', 'enableFix'],
            'sw-deprecation-rules/no-vue-options-api': 'off',
