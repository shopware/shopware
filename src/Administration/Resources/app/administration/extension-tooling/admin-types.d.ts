 ...
 * types of this Administration. The generated extension programs inject this
 ...
 * yet, the runner writes a stub that keeps `EntitySchema.Entities` empty so
 * missing schema types fail loudly instead of degrading to `any`.
 */
