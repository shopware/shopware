...
const ignored: number[] = [
  ...
  1113459, // minimatch ReDoS, high severity, devDep only (via editorconfig -> js-beautify)
  1113465, // minimatch ReDoS, high severity, devDep only (via editorconfig -> js-beautify)
