...
const ignored: number[] = [
  ...
  1113371, // minimatch ReDoS, high severity, devDep only (eslint-plugin-import peer dep, dir-compare, twig, etc.)
  1113429, // ajv ReDoS, moderate severity, devDep only (table), no fix available
