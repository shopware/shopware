...
function createTranslatedInheritanceField({
    name,
    type,
    customFieldType,
    inputType,
...
function createTranslatedEntity({
    id = 'product-id',
    customFields = null,
...
async function withTranslatedLanguageContext({ languageId = 'de-DE', systemLanguageId = 'en-GB', parentId = 'en-GB' } = {}, callback) {
