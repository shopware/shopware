...
import { isFilelessMediaType, filelessMediaTypeIcon } from 'src/core/service/utils/media-type.utils';
    ...
    computed: {
        ...
        placeholderIcon() {
            ...
            if (isFilelessMediaType(this.trueSource)) {
                return filelessMediaTypeIcon(this.trueSource) ?? 'icons-multicolor-file-thumbnail-normal';
            }
