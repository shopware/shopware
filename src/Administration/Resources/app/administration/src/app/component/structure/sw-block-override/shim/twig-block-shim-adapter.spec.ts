            ...
            template: `
                <div>
                    <div v-if="renderHost" class="component-root">
                        <sw-block name="${blockName}" block-scope="${componentName}" :data="$dataScope">
                            ${defaultContent}
                        </sw-block>
                    </div>
                    ${nativeExtensions}
            ...
            const wrapper = mount(
                {
                    template: `
                        <div>
                            <div class="root-a">
                                <sw-block name="shim_multi_diff_block_a" block-scope="sw-product-detail" :data="$dataScope">
                                    <div class="default-a"></div>
                                </sw-block>
                            </div>
                            <div class="root-b">
                                <sw-block name="shim_multi_diff_block_b" block-scope="sw-product-detail" :data="$dataScope">
    ...
    describe('interoperability with native sw-block extends', () => {
        it('stacks a native <sw-block extends> on top of an already-registered Twig shim override', async () => {
            ...
            const wrapper = await createWrapper({
                ...
                nativeExtensions: `
                    <sw-block extends="shim_interop_native_on_shim" block-scope="sw-product-detail">
                        <sw-block-parent />
        ...
        it('renders content in the correct DOM order: default, then shim, then native', async () => {
            ...
            const wrapper = await createWrapper({
                ...
                nativeExtensions: `
                    <sw-block extends="shim_interop_shim_below_native" block-scope="sw-product-detail">
                        <sw-block-parent />
                        <div class="native-content"></div>
                    </sw-block>
                `,
        ...
        it('renders only native content when the native override has no <sw-block-parent />', async () => {
            ...
            const wrapper = await createWrapper({
                ...
                nativeExtensions: `
                    <sw-block extends="shim_interop_native_no_parent" block-scope="sw-product-detail">
                        <div class="native-content"></div>
                    </sw-block>
                `,
            });
        ...
        it('chains a Twig-only shim (no {% parent %}) with a native <sw-block extends> that uses <sw-block-parent />', async () => {
            ...
            const wrapper = await createWrapper({
                ...
                nativeExtensions: `
                    <sw-block extends="shim_interop_twig_base_native_ext" block-scope="sw-product-detail">
                        <sw-block-parent />
                        <div class="native-content"></div>
                    </sw-block>
                `,
            ...
            mount(
                {
                    template: `
                        <div>
                            <sw-block name="shim_warn_separate_a" block-scope="sw-product-detail" :data="$dataScope"></sw-block>
                            <sw-block name="shim_warn_separate_b" block-scope="sw-product-detail" :data="$dataScope"></sw-block>
                        </div>
                    `,
                },
                {
            ...
            const wrapper = mount(
                {
                    template: `
                        <div class="component-root">
                            <sw-block name="shim_global_component_ref" block-scope="sw-product-detail" :data="$dataScope"></sw-block>
                        </div>
                    `,
                },
                {
            ...
            const wrapper = mount(
                {
                    template: `
                        <div>
                            <div class="root-a">
                                <sw-block name="shim_edge_multi_top_a" block-scope="sw-product-detail" :data="$dataScope">
                                    <div class="default-a"></div>
                                </sw-block>
                            </div>
                            <div class="root-b">
                                <sw-block name="shim_edge_multi_top_b" block-scope="sw-product-detail" :data="$dataScope">
                                    <div class="default-b"></div>
                                </sw-block>
                            </div>
                        </div>
                    ...
                    template: `
                        <div>
                            <div class="instance-a">
                                <sw-block name="shim_multi_instance_isolation" block-scope="sw-product-detail" :data="$dataScope">
                                    <div class="default-content"></div>
                                </sw-block>
                            </div>
            ...
            const wrapper = mount(
                {
                    template: `
                        <div>
                            <div class="instance-a">
                                <sw-block name="shim_multi_instance_parent_isolation" block-scope="sw-product-detail" :data="$dataScope">
                                    <div class="default-content"></div>
                                </sw-block>
                            </div>
                            <div class="instance-b">
