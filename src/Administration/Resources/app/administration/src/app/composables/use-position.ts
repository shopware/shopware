...
/**
 * Composable alternative to the `position` mixin: helpers to work with position
 * integers on entity collections. Pure helpers with no `this` usage, duplicated
 * verbatim from the mixin; the mixin is kept for legacy Options API components.
 *
