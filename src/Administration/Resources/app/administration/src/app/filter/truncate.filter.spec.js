...
describe('src/app/filter/truncate.filter.ts', () => {
    ...
    [
        [
            ['Hello World, welcome to Shopwware.', 10],
            'Hello W...',
        ],
        [
            ['Hello World, welcome to Shopwware.', 20],
            'Hello World, welc...',
        ],
        [
            ['Hello World, welcome to <h1>Shopware</h1> guys.', 33],
            'Hello World, welcome to Shopwa...',
        ],
        [
            ['Hello World, welcome to <h1>Shopware</h1> guys.', 33, true, '***'],
            'Hello World, welcome to Shopwa***',
        ],
        [
            ['Hello World, welcome to <h1>Shopware</h1> guys.', 33, false],
            'Hello World, welcome to <h1>Sh...',
        ],
        [
            ['Hello World, welcome to <h1>Shopware</h1> guys.', 33, false, '...more'],
