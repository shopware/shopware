import template from './sw-first-run-wizard-introduction.html.twig';
import './sw-first-run-wizard-introduction.scss';
...
export default {
    ...
    methods: {
        ...
        setTitle() {
            this.$emit('frw-set-title', this.$t('sw-first-run-wizard.introduction.modalTitle'));
        },
