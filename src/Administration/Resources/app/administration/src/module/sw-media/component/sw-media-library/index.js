...
export default {
    ...
    computed: {
        ...
        loadMoreLoadsEverything() {
            const foldersComplete = this.folderLoaderDone ||
                (this.folderTotal > 0 && this.folderTotal - this.subFolders.length <= this.limit);
            const itemsComplete = this.itemLoaderDone ||
                (this.itemTotal > 0 && this.itemTotal - this.items.length <= this.limit);
