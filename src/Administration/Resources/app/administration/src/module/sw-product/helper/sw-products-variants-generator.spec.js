...
describe('/src/module/sw-product/helper/sw-products-variants-generator.spec.js', () => {
    ...
    it('should not filter variants with positive or negative prices', (done) => {
        ...
        const queueEventHandler = jest.fn((data) => {
            expect(data.createQueue).toEqual(expectedCreateQueue);
        ...
        variantsGenerator.generateVariants(
            currencies,
            product
        );
    });

    it('should emit `queues` event when calling generateVariants', (done) => {
        const queueEventHandler = jest.fn((data) => {
    ...
    it('should filter variants correctly', async () => {
        ...
        const variants = await variantsGenerator.filterVariations(
            newVariations,
            variationOnServer,
            currencies
        );
