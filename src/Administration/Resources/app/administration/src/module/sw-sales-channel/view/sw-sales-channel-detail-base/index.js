    ...
    methods: {
        ...
        deleteSalesChannel(salesChannelId) {
            this.salesChannelRepository.delete(salesChannelId, Context.api).then(() => {
                ...
                this.createNotificationnfo({
                    message: this.$tc('sw-sales-channel.detail.messageSalesChannelDeletedSuccess', 0, {
                        name: this.salesChannel.name || this.placeholder(this.salesChannel, 'name'),
                    }),
                });
                ...
                this.createNotificationError({
                    message: this.$tc('sw-sales-channel.detail.messageSalesChannelDeletedError', 0, {
                        name: this.salesChannel.name || this.placeholder(this.salesChannel, 'name'),
                    }),
                });
            });
