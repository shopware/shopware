...
describe('src/module/sw-promotion/utils/unit-conversion.utils.js', () => {
    ...
    describe('lengths', () => {
        ...
        it('should convert 0.0006213712 miles to 1000 m', () => {
            expect(
                convertUnit(0.0006213711922373339, {
                    from: 'mi',
                    to: 'mm',
                }),
            ).toBe(1000);
