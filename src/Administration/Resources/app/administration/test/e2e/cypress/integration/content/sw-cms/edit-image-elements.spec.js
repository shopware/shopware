...
describe('CMS: Check usage and editing of image elements', () => {
    ...
    it('@content: use image slider block', () => {
        ...
        cy.get('.sw-media-new-preview__item[alt="sw-login-background"]').should('be.visible');
        cy.awaitAndCheckNotification('File has been saved.');
        ...
        cy.get('.sw-media-new-preview__item[alt="sw-test-image"]').should('be.visible');
        cy.awaitAndCheckNotification('File has been saved.');
        ...
        cy.get('.sw-media-new-preview__item[alt="sw-storefront-en"]').should('be.visible');
