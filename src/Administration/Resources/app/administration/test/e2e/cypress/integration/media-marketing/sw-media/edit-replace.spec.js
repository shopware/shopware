...
describe('Media: Replace media', () => {
    ...
    it('@media: replace media with same file type', () => {
        ...
        cy.get('.sw-media-modal-replace .sw-media-upload-v1__fallback-icon').should('not.exist');
        cy.get('.sw-media-modal-replace .sw-media-preview-v1__item').should('be.visible');
