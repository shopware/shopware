...
describe('Media: Replace media', () => {
    ...
    it('@media: replace media with same file type', () => {
        ...
        cy.get('.sw-media-modal-replace .sw-media-new-upload__fallback-icon').should('not.exist');
        cy.get('.sw-media-modal-replace .sw-media-new-preview__item').should('be.visible');
