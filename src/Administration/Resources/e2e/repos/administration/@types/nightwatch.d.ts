...
export interface NightwatchCustomCommands {
     ...
     * Usage:
     * ```
     * browser.fillSelectField('select[name=sw-field--product-manufacturerId]', 'shopware AG')
     * ```
     *
     * @param {String} selector
     * @param {String} value
     ...
     * Usage:
     * ```
     * browser.tickCheckbox('input[name=sw-field--country-active]', 'on')
     * ```
     *
     * @param {String} selector
