...
module.exports = {
    ...
    'edit tax': (browser) => {
        ...
        browser
            .waitForElementPresent(`${page.elements.gridRow}--2 ${page.elements.taxColumnName}`)
            .getLocationInView(`${page.elements.gridRow}--2 ${page.elements.taxColumnName}`)
            .expect.element(`${page.elements.gridRow}--2 ${page.elements.taxColumnName}`).to.have.text.that.equals(global.AdminFixtureService.basicFixture.name);
    ...
    'verify edited tax': (browser) => {
        ...
        browser
            ...
            .expect.element(`${page.elements.gridRow}--2 ${page.elements.taxColumnName}`).to.have.text.that.equals('Even higher tax rate');
    }
};
