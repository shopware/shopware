...
class AlbumResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['parent'] = new ReferenceField('parentUuid', 'uuid', \Shopware\Album\Writer\AlbumResource::class);
        $this->fields['parentUuid'] = (new FkField('parent_uuid', \Shopware\Album\Writer\AlbumResource::class, 'uuid'));
        $this->fields[self::NAME_FIELD] = new TranslatedField('name', \Shopware\Shop\Writer\ShopResource::class, 'uuid');
        $this->fields['translations'] = new SubresourceField(\Shopware\Album\Writer\AlbumTranslationResource::class, 'languageUuid');
        $this->fields['s'] = new SubresourceField(\Shopware\Album\Writer\AlbumResource::class);
