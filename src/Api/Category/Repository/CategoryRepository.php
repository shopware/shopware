...
class CategoryRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(CategoryDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->writer->upsert(CategoryDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(CategoryDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->delete(CategoryDefinition::class, $ids, WriteContext::createFromShopContext($context));
