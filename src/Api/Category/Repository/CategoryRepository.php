...
class CategoryRepository implements RepositoryInterface
{
    ...
    public function readBasic(array $ids, TranslationContext $context): CategoryBasicCollection
    {
    ...
    public function readDetail(array $ids, TranslationContext $context): CategoryDetailCollection
    {
    ...
    {
        $affected = $this->writer->delete(CategoryDefinition::class, $ids, WriteContext::createFromTranslationContext($context));
