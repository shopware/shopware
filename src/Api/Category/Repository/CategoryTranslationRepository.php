...
class CategoryTranslationRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(CategoryTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->writer->upsert(CategoryTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(CategoryTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->delete(CategoryTranslationDefinition::class, $ids, WriteContext::createFromShopContext($context));
