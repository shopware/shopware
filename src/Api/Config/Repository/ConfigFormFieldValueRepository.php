...
use Shopware\Api\Config\Event\ConfigFormFieldValue\ConfigFormFieldValueIdSearchResultLoadedEvent;
...
class ConfigFormFieldValueRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ConfigFormFieldValueSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ConfigFormFieldValueBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): ConfigFormFieldValueDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigFormFieldValueDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigFormFieldValueDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigFormFieldValueDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigFormFieldValueDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigFormFieldValueDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
