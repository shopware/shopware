...
use Shopware\Api\Config\Event\ConfigForm\ConfigFormAggregationResultLoadedEvent;
use Shopware\Api\Config\Event\ConfigForm\ConfigFormBasicLoadedEvent;
use Shopware\Api\Config\Event\ConfigForm\ConfigFormDetailLoadedEvent;
use Shopware\Api\Config\Event\ConfigForm\ConfigFormIdSearchResultLoadedEvent;
use Shopware\Api\Config\Event\ConfigForm\ConfigFormSearchResultLoadedEvent;
...
class ConfigFormRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ConfigFormSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ConfigFormBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): ConfigFormDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigFormDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigFormDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigFormDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigFormDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigFormDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
