...
use Shopware\Api\Configuration\Event\ConfigurationGroup\ConfigurationGroupAggregationResultLoadedEvent;
use Shopware\Api\Configuration\Event\ConfigurationGroup\ConfigurationGroupBasicLoadedEvent;
use Shopware\Api\Configuration\Event\ConfigurationGroup\ConfigurationGroupDetailLoadedEvent;
use Shopware\Api\Configuration\Event\ConfigurationGroup\ConfigurationGroupIdSearchResultLoadedEvent;
use Shopware\Api\Configuration\Event\ConfigurationGroup\ConfigurationGroupSearchResultLoadedEvent;
...
class ConfigurationGroupRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ConfigurationGroupSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ConfigurationGroupBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): ConfigurationGroupDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigurationGroupDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigurationGroupDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigurationGroupDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigurationGroupDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigurationGroupDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
