...
class CustomerGroupRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(CustomerGroupDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->writer->upsert(CustomerGroupDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(CustomerGroupDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->delete(CustomerGroupDefinition::class, $ids, WriteContext::createFromShopContext($context));
