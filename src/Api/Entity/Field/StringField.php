...
use Shopware\Api\Write\Filter\Filter;
use Shopware\Api\Write\Filter\FilterRegistry;
use Shopware\Api\Write\Filter\HtmlFilter;
...
class StringField extends Field implements PathAware, ConstraintBuilderAware, FilterRegistryAware, ValidatorAware, StorageAware
{
    /**
