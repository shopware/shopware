...
use Shopware\Api\Media\Event\MediaAlbum\MediaAlbumUuidSearchResultLoadedEvent;
...
class MediaAlbumRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, TranslationContext $context): MediaAlbumSearchResult
    {
        ...
        $result = MediaAlbumSearchResult::createFromResults($uuids, $entities, $aggregations);
    ...
    public function searchUuids(Criteria $criteria, TranslationContext $context): UuidSearchResult
    {
        ...
        $event = new MediaAlbumUuidSearchResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);

        return $result;
    }

    public function readBasic(array $uuids, TranslationContext $context): MediaAlbumBasicCollection
    {
        /** @var MediaAlbumBasicCollection $entities */
        $entities = $this->reader->readBasic(MediaAlbumDefinition::class, $uuids, $context);
    ...
    public function readDetail(array $uuids, TranslationContext $context): MediaAlbumDetailCollection
    {
        /** @var MediaAlbumDetailCollection $entities */
        $entities = $this->reader->readDetail(MediaAlbumDefinition::class, $uuids, $context);
