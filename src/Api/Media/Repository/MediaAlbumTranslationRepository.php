...
use Shopware\Api\Media\Event\MediaAlbumTranslation\MediaAlbumTranslationIdSearchResultLoadedEvent;
...
class MediaAlbumTranslationRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): MediaAlbumTranslationSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): MediaAlbumTranslationBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): MediaAlbumTranslationDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(MediaAlbumTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(MediaAlbumTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(MediaAlbumTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(MediaAlbumTranslationDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(MediaAlbumTranslationDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
