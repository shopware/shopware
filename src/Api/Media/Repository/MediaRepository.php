...
class MediaRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): MediaSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): MediaBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): MediaDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(MediaDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(MediaDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(MediaDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(MediaDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(MediaDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
