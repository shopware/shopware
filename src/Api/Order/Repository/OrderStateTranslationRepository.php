...
class OrderStateTranslationRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): OrderStateTranslationSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): OrderStateTranslationBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): OrderStateTranslationDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(OrderStateTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(OrderStateTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(OrderStateTranslationDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(OrderStateTranslationDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(OrderStateTranslationDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
