...
use Shopware\Api\Order\Event\OrderTransactionStateTranslation\OrderTransactionStateTranslationAggregationResultLoadedEvent;
use Shopware\Api\Order\Event\OrderTransactionStateTranslation\OrderTransactionStateTranslationBasicLoadedEvent;
