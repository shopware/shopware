...
class ProductServiceBasicCollection extends EntityCollection
{
    ...
    public function filterByVersionId(string $id): ProductServiceBasicCollection
    {
    ...
    public function filterByProductId(string $id): ProductServiceBasicCollection
    {
        return $this->filter(function(ProductServiceBasicStruct $productService) use ($id) {
    ...
    public function filterByConfigurationOptionId(string $id): ProductServiceBasicCollection
    {
        return $this->filter(function(ProductServiceBasicStruct $productService) use ($id) {
    ...
    public function filterByTaxId(string $id): ProductServiceBasicCollection
    {
        return $this->filter(function(ProductServiceBasicStruct $productService) use ($id) {
    ...
    public function filterByProductVersionId(string $id): ProductServiceBasicCollection
    {
        return $this->filter(function(ProductServiceBasicStruct $productService) use ($id) {
    ...
    public function filterByConfigurationOptionVersionId(string $id): ProductServiceBasicCollection
    {
        return $this->filter(function(ProductServiceBasicStruct $productService) use ($id) {
    ...
    public function filterByTaxVersionId(string $id): ProductServiceBasicCollection
    {
        return $this->filter(function(ProductServiceBasicStruct $productService) use ($id) {
