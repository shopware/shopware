...
use Shopware\Api\Product\Event\ProductVariation\ProductVariationDeletedEvent;
use Shopware\Api\Product\Event\ProductVariation\ProductVariationWrittenEvent;
...
class ProductVariationDefinition extends MappingEntityDefinition
{
    ...
    public static function getFields(): FieldCollection
    {
        ...
        return self::$fields = new FieldCollection([
            ...
            (new FkField('configuration_option_id', 'configurationOptionId', ConfigurationGroupOptionDefinition::class))->setFlags(new PrimaryKey(), new Required()),
            new ReferenceVersionField(ConfigurationGroupOptionDefinition::class),
            new ManyToOneAssociationField('product', 'product_id', ProductDefinition::class, false),
            new ManyToOneAssociationField('configurationOption', 'configuration_option_id', ConfigurationGroupOptionDefinition::class, false),
        ]);
    }
