...
class ProductManufacturerTranslationUuidSearchResultLoadedEvent extends NestedEvent
{
    public const NAME = 'product_manufacturer_translation.uuid.search.result.loaded';
