...
class ProductContextPriceRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ProductContextPriceSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ProductContextPriceBasicCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductContextPriceDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductContextPriceDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductContextPriceDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductContextPriceDefinition::class, $ids, WriteContext::createFromShopContext($context));
