...
use Shopware\Api\Product\Event\ProductMedia\ProductMediaAggregationResultLoadedEvent;
use Shopware\Api\Product\Event\ProductMedia\ProductMediaBasicLoadedEvent;
use Shopware\Api\Product\Event\ProductMedia\ProductMediaDetailLoadedEvent;
use Shopware\Api\Product\Event\ProductMedia\ProductMediaIdSearchResultLoadedEvent;
use Shopware\Api\Product\Event\ProductMedia\ProductMediaSearchResultLoadedEvent;
...
class ProductMediaRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ProductMediaSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ProductMediaBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): ProductMediaDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductMediaDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductMediaDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductMediaDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductMediaDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductMediaDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
