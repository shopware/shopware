...
use Shopware\Api\Product\Event\ProductPrice\ProductPriceIdSearchResultLoadedEvent;
...
class ProductPriceRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, TranslationContext $context): ProductPriceSearchResult
    {
        ...
        $result = ProductPriceSearchResult::createFromResults($ids, $entities, $aggregations);
    ...
    public function searchIds(Criteria $criteria, TranslationContext $context): IdSearchResult
    {
        ...
        $event = new ProductPriceIdSearchResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);

        return $result;
    }

    public function readBasic(array $ids, TranslationContext $context): ProductPriceBasicCollection
    {
        /** @var ProductPriceBasicCollection $entities */
        $entities = $this->reader->readBasic(ProductPriceDefinition::class, $ids, $context);
    ...
    public function readDetail(array $ids, TranslationContext $context): ProductPriceDetailCollection
    {
        /** @var ProductPriceDetailCollection $entities */
        $entities = $this->reader->readDetail(ProductPriceDefinition::class, $ids, $context);
    ...
    {
        $affected = $this->writer->delete(ProductPriceDefinition::class, $ids, WriteContext::createFromTranslationContext($context));
