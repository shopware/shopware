...
use Shopware\Api\Product\Event\ProductSearchKeyword\ProductSearchKeywordAggregationResultLoadedEvent;
use Shopware\Api\Product\Event\ProductSearchKeyword\ProductSearchKeywordBasicLoadedEvent;
use Shopware\Api\Product\Event\ProductSearchKeyword\ProductSearchKeywordDetailLoadedEvent;
use Shopware\Api\Product\Event\ProductSearchKeyword\ProductSearchKeywordIdSearchResultLoadedEvent;
use Shopware\Api\Product\Event\ProductSearchKeyword\ProductSearchKeywordSearchResultLoadedEvent;
...
class ProductSearchKeywordRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ProductSearchKeywordSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ProductSearchKeywordBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): ProductSearchKeywordDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductSearchKeywordDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductSearchKeywordDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductSearchKeywordDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductSearchKeywordDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductSearchKeywordDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
