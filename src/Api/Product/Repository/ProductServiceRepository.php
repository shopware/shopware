...
use Shopware\Api\Product\Collection\ProductServiceDetailCollection;
...
use Shopware\Api\Product\Event\ProductService\ProductServiceDetailLoadedEvent;
...
class ProductServiceRepository implements RepositoryInterface
{
    ...
    public function readDetail(array $ids, ShopContext $context): ProductServiceDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductServiceDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductServiceDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductServiceDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductServiceDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductServiceDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
