...
class ShippingMethodRepository implements RepositoryInterface
{
    ...
    public function readBasic(array $ids, TranslationContext $context): ShippingMethodBasicCollection
    {
    ...
    public function readDetail(array $ids, TranslationContext $context): ShippingMethodDetailCollection
    {
