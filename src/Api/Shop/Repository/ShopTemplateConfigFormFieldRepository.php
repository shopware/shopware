...
class ShopTemplateConfigFormFieldRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ShopContext $context): ShopTemplateConfigFormFieldSearchResult
    {
    ...
    public function readBasic(array $ids, ShopContext $context): ShopTemplateConfigFormFieldBasicCollection
    {
    ...
    public function readDetail(array $ids, ShopContext $context): ShopTemplateConfigFormFieldDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ShopTemplateConfigFormFieldDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ShopTemplateConfigFormFieldDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ShopTemplateConfigFormFieldDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ShopTemplateConfigFormFieldDefinition::class, $ids, WriteContext::createFromShopContext($context));
    ...
    {
        return $this->versionManager->createVersion(ShopTemplateConfigFormFieldDefinition::class, $id, WriteContext::createFromShopContext($context), $name, $versionId);
    }
