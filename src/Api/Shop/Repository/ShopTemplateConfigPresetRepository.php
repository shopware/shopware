...
class ShopTemplateConfigPresetRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(ShopTemplateConfigPresetDefinition::class, $data, WriteContext::createFromShopContext($context));
    ...
    {
        $affected = $this->writer->upsert(ShopTemplateConfigPresetDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(ShopTemplateConfigPresetDefinition::class, $data, WriteContext::createFromShopContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->delete(ShopTemplateConfigPresetDefinition::class, $ids, WriteContext::createFromShopContext($context));
