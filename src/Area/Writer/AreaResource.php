...
class AreaResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['translations'] = new SubresourceField(\Shopware\Area\Writer\AreaTranslationResource::class, 'languageUuid');
        $this->fields['countrys'] = new SubresourceField(\Shopware\AreaCountry\Writer\AreaCountryResource::class);
