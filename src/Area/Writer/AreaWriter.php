...
use Shopware\Area\Writer\Resource\AreaResource;
...
class AreaWriter
{
    ...
    public function update(array $data, TranslationContext $context): AreaWrittenEvent
    {
        ...
        return AreaResource::createWrittenEvent($updated, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): AreaWrittenEvent
    {
        ...
        return AreaResource::createWrittenEvent($created, $errors);
    }
    ...
    private function getExtender(): FieldExtenderCollection
    {
        ...
        $event = $this->eventDispatcher->dispatch(
            AreaWriteExtenderEvent::NAME,
            new AreaWriteExtenderEvent($extenderCollection)
        );
