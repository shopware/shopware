...
namespace Shopware\AreaCountry\Gateway\Resource;
...
class AreaCountryResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['area'] = new ReferenceField('areaUuid', 'uuid', \Shopware\Area\Gateway\Resource\AreaResource::class);
        $this->fields['areaUuid'] = (new FkField('area_uuid', \Shopware\Area\Gateway\Resource\AreaResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['states'] = new SubresourceField(\Shopware\AreaCountryState\Gateway\Resource\AreaCountryStateResource::class);
        ...
        $this->fields['paymentMethodCountrys'] = new SubresourceField(\Shopware\PaymentMethod\Gateway\Resource\PaymentMethodCountryResource::class);
        $this->fields['shippingMethodCountrys'] = new SubresourceField(\Shopware\ShippingMethod\Gateway\Resource\ShippingMethodCountryResource::class);
