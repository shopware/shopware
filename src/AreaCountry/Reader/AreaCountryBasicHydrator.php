...
class AreaCountryBasicHydrator extends Hydrator
{
    ...
    public function hydrate(array $data): AreaCountryBasicStruct
    {
        ...
        $areaCountry->setShippingFree(
            isset($data['__areaCountry_shipping_free']) ? (bool)$data['__areaCountry_shipping_free'] : null
        );
        $areaCountry->setTaxFree(isset($data['__areaCountry_tax_free']) ? (bool)$data['__areaCountry_tax_free'] : null);
        $areaCountry->setTaxfreeForVatId(
            isset($data['__areaCountry_taxfree_for_vat_id']) ? (bool)$data['__areaCountry_taxfree_for_vat_id'] : null
        );
        $areaCountry->setTaxfreeVatidChecked(
            isset($data['__areaCountry_taxfree_vatid_checked']) ? (bool)$data['__areaCountry_taxfree_vatid_checked'] : null
        );
        ...
        $areaCountry->setUuid(isset($data['__areaCountry_uuid']) ? (string)$data['__areaCountry_uuid'] : null);
