...
class AreaCountryBasicReader
{
    ...
    public function __construct(Connection $connection, AreaCountryBasicHydrator $hydrator)
    {
    ...
    {
        $query = new AreaCountryBasicQuery($this->connection, $context);

        $query->andWhere('areaCountry.uuid IN (:uuids)');
