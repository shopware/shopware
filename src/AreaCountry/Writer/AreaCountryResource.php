...
namespace Shopware\AreaCountry\Writer;
...
class AreaCountryResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['areaUuid'] = (new FkField('area_uuid', \Shopware\Area\Writer\AreaResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['states'] = new SubresourceField(\Shopware\AreaCountryState\Writer\AreaCountryStateResource::class);
        $this->fields['customerAddresss'] = new SubresourceField(\Shopware\CustomerAddress\Writer\CustomerAddressResource::class);
        $this->fields['paymentMethodCountrys'] = new SubresourceField(\Shopware\PaymentMethod\Writer\PaymentMethodCountryResource::class);
        $this->fields['shippingMethodCountrys'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodCountryResource::class);
