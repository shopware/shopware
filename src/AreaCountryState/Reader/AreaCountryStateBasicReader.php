...
class AreaCountryStateBasicReader
{
    ...
    public function __construct(Connection $connection, AreaCountryStateBasicHydrator $hydrator)
    {
    ...
    {
        $query = new AreaCountryStateBasicQuery($this->connection, $context);

        $query->andWhere('areaCountryState.uuid IN (:uuids)');
