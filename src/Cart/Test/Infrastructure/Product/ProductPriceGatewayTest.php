...
namespace Shopware\Cart\Test\Infrastructure\Product;
...
class ProductPriceGatewayTest extends TestCase
{
    ...
    {
        $gateway = new ProductPriceGateway($this->createDatabaseMock([]));
     ...
     * @param string $key
     *
     * @return \Shopware\CustomerGroup\Struct\CustomerGroupBasicStruct
     */
    private function createCustomerGroup($key): CustomerGroupBasicStruct
    {
