...
class AmountCalculatorTest extends TestCase
{
     ...
     */
    public function testCalculateAmountWithNetPrices(CartPrice $expected, \Shopware\Cart\Price\Struct\PriceCollection $prices): void
    {
        $detector = $this->createMock(TaxDetector::class);
        ...
        $cartPrice = $calculator->calculateAmount($prices, new \Shopware\Cart\Price\Struct\PriceCollection(), $context);
        static::assertEquals($expected, $cartPrice);
    }
    ...
    public function calculateAmountForNetDeliveriesProvider(): array
    {
        ...
        return [
            [
                new CartPrice(19.5, 19.5, 19.5, new CalculatedTaxCollection(), new TaxRuleCollection(), \Shopware\Cart\Price\Struct\CartPrice::TAX_STATE_FREE),
                new PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(3.11, 19, 19.5)]), $highTax),
                ]),
            ], [
                new CartPrice(33.7, 33.7, 33.7, new CalculatedTaxCollection(), new TaxRuleCollection(), CartPrice::TAX_STATE_FREE),
                new PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(3.11, 19, 19.50)]), $highTax),
                    new \Shopware\Cart\Price\Struct\Price(14.20, 14.20, new CalculatedTaxCollection([new CalculatedTax(2.27, 19, 14.20)]), $highTax),
                ]),
            ], [
                new CartPrice(33.70, 33.70, 33.70, new CalculatedTaxCollection(), new TaxRuleCollection(), \Shopware\Cart\Price\Struct\CartPrice::TAX_STATE_FREE),
                new PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(3.11, 19, 19.50)]), $highTax),
                    new \Shopware\Cart\Price\Struct\Price(14.20, 14.20, new CalculatedTaxCollection([new CalculatedTax(0.93, 7, 14.20)]), $lowTax),
                ]),
            ], [
                ...
                new PriceCollection([
                    ...
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(2.18, 7, 33.30)]), $lowTax),
                ]),
            ], [
                ...
                new \Shopware\Cart\Price\Struct\PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(3.11, 19, 19.50)]), $highTax),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(5.32, 19, 33.30)]), $highTax),
                    new Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(1.28, 7, 19.50)]), $lowTax),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(2.18, 7, 33.30)]), $lowTax),
                ]),
            ], [
                ...
                new \Shopware\Cart\Price\Struct\PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(10.00, 10.00, new CalculatedTaxCollection([]), new TaxRuleCollection([])),
                    new \Shopware\Cart\Price\Struct\Price(10.00, 10.00, new CalculatedTaxCollection([]), new TaxRuleCollection([])),
                ]),
            ],
        ];
    ...
    public function calculateAmountWithNetPricesProvider(): array
    {
        ...
        return [
            [
                ...
                new \Shopware\Cart\Price\Struct\CartPrice(
                    105.6,
                    117.49,
                    105.6,
                    new CalculatedTaxCollection([
                ...
                new PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(3.11, 19, 19.50)]), $highTax),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(5.32, 19, 33.30)]), $highTax),
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(2.97, 18, 19.50)]), new TaxRuleCollection([new TaxRule(18)])),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(5.08, 18, 33.30)]), new TaxRuleCollection([new TaxRule(18)])),
                    ...
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(0.33, 1, 33.30)]), new TaxRuleCollection([new TaxRule(1)])),
                ]),
            ], [
            ...
            [
                new CartPrice(
                    ...
                    \Shopware\Cart\Price\Struct\CartPrice::TAX_STATE_NET
                ),
                new \Shopware\Cart\Price\Struct\PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(1.40, 1.40, new CalculatedTaxCollection([new CalculatedTax(0.27, 19, 1.40)]), new TaxRuleCollection([new TaxRule(19)])),
                    new Price(2.00, 2.00, new CalculatedTaxCollection([new CalculatedTax(0.38, 19, 2.00)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(2.45, 12.25, new CalculatedTaxCollection([new CalculatedTax(2.33, 19, 12.25)]), new TaxRuleCollection([new TaxRule(19)]), 5),
                    new \Shopware\Cart\Price\Struct\Price(0.50, 2.5, new CalculatedTaxCollection([new CalculatedTax(0.48, 19, 2.5)]), new TaxRuleCollection([new TaxRule(19)]), 5),
                    ...
                    new Price(1.40, 1.40, new CalculatedTaxCollection([new CalculatedTax(0.27, 19, 1.40)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(1.40, 1.40, new CalculatedTaxCollection([new CalculatedTax(0.27, 19, 1.40)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(3.78, 3.78, new CalculatedTaxCollection([new CalculatedTax(0.72, 19, 3.78)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(-0.96, -0.96, new CalculatedTaxCollection([new CalculatedTax(-0.18, 19, -0.96)]), new TaxRuleCollection([new TaxRule(19)])),
                ]),
            ],
        ];
    }
        ...
        return [
            [
                ...
                new \Shopware\Cart\Price\Struct\PriceCollection([
                    ...
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(2.97, 18, 19.50)]), new TaxRuleCollection([new TaxRule(18)])),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(5.08, 18, 33.30)]), new TaxRuleCollection([new TaxRule(18)])),
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(2.83, 17, 19.50)]), new TaxRuleCollection([new TaxRule(17)])),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(4.84, 17, 33.30)]), new TaxRuleCollection([new TaxRule(17)])),
                    new \Shopware\Cart\Price\Struct\Price(19.50, 19.50, new CalculatedTaxCollection([new CalculatedTax(1.28, 7, 19.50)]), $lowTax),
                    new \Shopware\Cart\Price\Struct\Price(33.30, 33.30, new CalculatedTaxCollection([new CalculatedTax(2.18, 7, 33.30)]), $lowTax),
                ...
                new \Shopware\Cart\Price\Struct\PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(1.67, 1.67, new CalculatedTaxCollection([new CalculatedTax(0.27, 19, 1.67)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(2.38, 2.38, new CalculatedTaxCollection([new CalculatedTax(0.38, 19, 2.38)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(14.6, 14.6, new CalculatedTaxCollection([new CalculatedTax(2.33, 19, 14.6)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(3.0, 3.0, new CalculatedTaxCollection([new CalculatedTax(0.48, 19, 3.0)]), new TaxRuleCollection([new TaxRule(19)])),
                    ...
                    new Price(1.67, 1.67, new CalculatedTaxCollection([new CalculatedTax(0.27, 19, 1.67)]), new TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.67, 1.67, new CalculatedTaxCollection([new CalculatedTax(0.27, 19, 1.67)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(4.50, 4.50, new CalculatedTaxCollection([new CalculatedTax(0.72, 19, 4.50)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(-1.15, -1.15, new CalculatedTaxCollection([new CalculatedTax(-0.18, 19, -1.15)]), new TaxRuleCollection([new TaxRule(19)])),
                ]),
            ], [
                new \Shopware\Cart\Price\Struct\CartPrice(
                    0,
                ...
                new PriceCollection([
                    new \Shopware\Cart\Price\Struct\Price(55, 55, new CalculatedTaxCollection([new CalculatedTax(8.78, 19, 55)]), new TaxRuleCollection([new TaxRule(19)])),
                    new \Shopware\Cart\Price\Struct\Price(41, 41, new CalculatedTaxCollection([new CalculatedTax(6.55, 19, 41)]), new TaxRuleCollection([new TaxRule(19)])),
