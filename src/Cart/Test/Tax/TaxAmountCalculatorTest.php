    ...
    public function calculationProvider(): array
    {
        ...
        return [
            ...
            [
                ...
                $grossPriceDetector,
                new PriceCollection([
                    new Price(1.44, 1.44, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.09, 7, 1.44)]), new TaxRuleCollection([new TaxRule(7)])),
                    ...
                    new Price(1.44, 1.44, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.09, 7, 1.44)]), new TaxRuleCollection([new TaxRule(7)])),
                ]),
            ...
            [
                ...
                $grossPriceDetector,
                new PriceCollection([
                    new Price(1.61, 1.61, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.26, 19, 1.61)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.61, 1.61, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.26, 19, 1.61)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.61, 1.61, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.26, 19, 1.61)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                ]),
                new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([
            ...
            [
                ...
                $grossPriceDetector,
                new PriceCollection([
                    new Price(1.61, 1.61, new CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.26, 19, 1.61)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
            ...
            [
                ...
                $grossPriceDetector,
                new PriceCollection([
                    new Price(3.03, 3.03, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.48, 19, 3.03)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.44, 1.44, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.09, 7, 1.44)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
            ...
            [
                ...
                new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([
                    new \Shopware\Cart\Tax\Struct\CalculatedTax(0.28, 7, 4.32),
                ]),
            ],
            ...
            [
                ...
                new CalculatedTaxCollection([
                    new \Shopware\Cart\Tax\Struct\CalculatedTax(0.51, 19, 3.22),
            ...
            [
                ...
                $netPriceDetector,
                new PriceCollection([
                    new Price(1.35, 1.35, new CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.09, 7, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(7)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.09, 7, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(7)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.09, 7, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(7)])),
                ]),
                new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([
                    new \Shopware\Cart\Tax\Struct\CalculatedTax(0.27, 7, 4.05),
                ]),
            ],
            ...
            [
                ...
                $netPriceDetector,
                new PriceCollection([
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.26, 19, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.26, 19, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.26, 19, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new \Shopware\Cart\Tax\Struct\TaxRule(19)])),
                ]),
                new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([
            ...
            [
                ...
                $netPriceDetector,
                new PriceCollection([
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.26, 19, 1.35)]), new TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.09, 7, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(7)])),
                    new Price(1.35, 1.35, new CalculatedTaxCollection([new CalculatedTax(0.26, 19, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                ]),
                new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([
            ...
            [
                ...
                $netPriceDetector,
                new PriceCollection([
                    new Price(2.55, 2.55, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new \Shopware\Cart\Tax\Struct\CalculatedTax(0.48, 19, 2.55)]), new TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.09, 7, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
            ...
            [
                ...
                $netPriceDetector,
                new PriceCollection([
                    new Price(2.55, 2.55, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.48, 19, 2.55)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
                    new Price(1.35, 1.35, new \Shopware\Cart\Tax\Struct\CalculatedTaxCollection([new CalculatedTax(0.09, 7, 1.35)]), new \Shopware\Cart\Tax\Struct\TaxRuleCollection([new TaxRule(19)])),
