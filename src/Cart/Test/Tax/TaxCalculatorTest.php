...
class TaxCalculatorTest extends TestCase
{
    ...
    public function testNotSupportedRule(): void
    {
        ...
        $rule = new \Shopware\Cart\Tax\Struct\TaxRule(19);
    ...
    public function netPricesToGross(): array
    {
        return [
            ...
            [299999.99,    new PriceRounding(2), new \Shopware\Cart\Tax\Struct\TaxRule(7),  280373.822429907],
            ...
            [299999.9999,  new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(7),  280373.831682243],
            [13.7676,      new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(7),  12.8669158878505],
