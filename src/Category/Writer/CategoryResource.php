...
class CategoryResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['parent'] = new ReferenceField('parentUuid', 'uuid', \Shopware\Category\Writer\CategoryResource::class);
        $this->fields['parentUuid'] = (new FkField('parent_uuid', \Shopware\Category\Writer\CategoryResource::class, 'uuid'));
        $this->fields['media'] = new ReferenceField('mediaUuid', 'uuid', \Shopware\Media\Writer\MediaResource::class);
        $this->fields['mediaUuid'] = (new FkField('media_uuid', \Shopware\Media\Writer\MediaResource::class, 'uuid'));
        $this->fields['s'] = new SubresourceField(\Shopware\Category\Writer\CategoryResource::class);
        $this->fields['avoidCustomerGroups'] = new SubresourceField(\Shopware\Category\Writer\CategoryAvoidCustomerGroupResource::class);
        $this->fields['productCategorys'] = new SubresourceField(\Shopware\Product\Writer\ProductCategoryResource::class);
        $this->fields['productCategorySeos'] = new SubresourceField(\Shopware\Product\Writer\ProductCategorySeoResource::class);
        $this->fields['shippingMethodCategorys'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodCategoryResource::class);
