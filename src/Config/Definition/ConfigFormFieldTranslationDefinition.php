...
use Shopware\Config\Event\ConfigFormFieldTranslation\ConfigFormFieldTranslationWrittenEvent;
use Shopware\Config\Repository\ConfigFormFieldTranslationRepository;
