...
use Shopware\Config\Event\ConfigFormField\ConfigFormFieldAggregationResultLoadedEvent;
use Shopware\Config\Event\ConfigFormField\ConfigFormFieldBasicLoadedEvent;
use Shopware\Config\Event\ConfigFormField\ConfigFormFieldDetailLoadedEvent;
use Shopware\Config\Event\ConfigFormField\ConfigFormFieldSearchResultLoadedEvent;
use Shopware\Config\Event\ConfigFormField\ConfigFormFieldUuidSearchResultLoadedEvent;
...
class ConfigFormFieldRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(ConfigFormFieldDefinition::class, $data, WriteContext::createFromTranslationContext($context));
    ...
    {
        $affected = $this->writer->upsert(ConfigFormFieldDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(ConfigFormFieldDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
