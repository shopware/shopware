...
use Shopware\Core\Checkout\Rule\Specification\CalculatedCart\OrderAmountRule;
...
class OrderAmountRuleTest extends TestCase
{
     ...
     *
     * @expectedException \Shopware\Core\Checkout\Rule\Exception\UnsupportedOperatorException
     *
