...
class OrderConverterController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/order/{orderId}/convert-to-cart/', name: 'api.action.order.convert-to-cart', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['order:update']], methods: ['POST'])]
