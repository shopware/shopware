...
class CustomerAddressDefinition extends EntityDefinition
{
    ...
    public static function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('last_name', 'lastName'))->setFlags(new Required(), new SearchRanking(SearchRanking::MIDDLE_SEARCH_RANKING)),
            ...
            (new StringField('company', 'company'))->setFlags(new SearchRanking(SearchRanking::MIDDLE_SEARCH_RANKING)),
