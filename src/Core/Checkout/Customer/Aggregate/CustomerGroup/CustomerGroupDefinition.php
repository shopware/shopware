...
class CustomerGroupDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('price_basis', 'priceBasis'))->addFlags(new ApiAware(), new Since('6.7.15.0'), new Choice([CustomerGroupEntity::PRICE_BASIS_NET, CustomerGroupEntity::PRICE_BASIS_GROSS], strict: true))->setDescription('Defines which stored price value is authoritative for the price calculation. With `net` the stored net value is always used, with `gross` the stored gross value, `null` lets the basis follow the display mode.'),
