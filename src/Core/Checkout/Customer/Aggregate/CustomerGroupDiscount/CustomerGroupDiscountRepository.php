...
use Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Event\CustomerGroupDiscountAggregationResultLoadedEvent;
use Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Event\CustomerGroupDiscountBasicLoadedEvent;
use Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Event\CustomerGroupDiscountDetailLoadedEvent;
use Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Event\CustomerGroupDiscountIdSearchResultLoadedEvent;
use Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Event\CustomerGroupDiscountSearchResultLoadedEvent;
...
class CustomerGroupDiscountRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): CustomerGroupDiscountSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): CustomerGroupDiscountBasicCollection
    {
        /** @var \Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Collection\CustomerGroupDiscountBasicCollection $entities */
    ...
    public function readDetail(array $ids, ApplicationContext $context): CustomerGroupDiscountDetailCollection
    {
        /** @var \Shopware\Checkout\Customer\Aggregate\CustomerGroupDiscount\Collection\CustomerGroupDiscountDetailCollection $entities */
    ...
    {
        $affected = $this->versionManager->update(CustomerGroupDiscountDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(CustomerGroupDiscountDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(CustomerGroupDiscountDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(CustomerGroupDiscountDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(CustomerGroupDiscountDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
