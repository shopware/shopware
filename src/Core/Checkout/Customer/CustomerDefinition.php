...
class CustomerDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        $fields = new FieldCollection([
            ...
            (new EmailField('email', 'email'))->addFlags(new ApiAware(), new Required(), new SearchRanking(SearchRanking::MIDDLE_SEARCH_RANKING)),
            ...
            (new BoolField('doubleOptInRegistration', 'doubleOptInRegistration'))->addFlags(new ApiAware()),
            (new DateTimeField('doubleOptInEmailSentDate', 'doubleOptInEmailSentDate'))->addFlags(new ApiAware()),
            (new DateTimeField('doubleOptInConfirmDate', 'doubleOptInConfirmDate'))->addFlags(new ApiAware()),
