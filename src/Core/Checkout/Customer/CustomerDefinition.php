...
class CustomerDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        ...
        return new FieldCollection([
            ...
            (new StringField('display_name', 'displayName'))->addFlags(new ApiAware(), new Runtime())->setDescription('The name to render for this customer: the contact person, or the company when a commercial account has none.'),
