...
class CustomerDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        ...
        return new FieldCollection([
            ...
            (new StringField('last_name', 'lastName', self::MAX_LENGTH_LAST_NAME))->addFlags(new ApiAware(), new Required(), new AllowEmptyString(), new SearchRanking(SearchRanking::HIGH_SEARCH_RANKING))->setDescription('Last name of the customer.'),
            (new StringField('display_name', 'displayName'))->addFlags(new ApiAware(), new Runtime(['firstName', 'lastName', 'company', 'accountType']))->setDescription('The name to render for this customer: the contact person, or the company when a commercial account has none.'),
            ...
            (new StringField('hash', 'hash'))->setDescription('Customer registration double opt-in hash for confirming the customer account.'),
