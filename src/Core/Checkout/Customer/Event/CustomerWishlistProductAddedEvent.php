...
/**
 * Fires when a customer adds a product to their wishlist through the sales channel —
 * the add route and the merge route (for items the merge actually inserts). Raw Admin
 * API writes to customer_wishlist_product are not a customer action and do not fire it.
 */
#[Package('checkout')]
class CustomerWishlistProductAddedEvent extends Event implements CustomerAware, ProductAware, SalesChannelAware, ScalarValuesAware, FlowEventAware, MailAware
{
    final public const EVENT_NAME = 'customer.wishlist.product.added';
