...
class ShippingHouseNumberRule extends Rule
{
    final public const RULE_NAME = 'customerShippingHouseNumber';
    ...
    public function match(RuleScope $scope): bool
    {
        ...
        return RuleComparison::string($location->getHouseNumber() ?? '', $this->houseNumber ?? '', $this->operator);
    }
