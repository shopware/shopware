...
class AddressValidationFactory implements DataValidationFactoryInterface
{
    ...
    private function buildCommonValidation(DataValidationDefinition $definition, SalesChannelContext $context): DataValidationDefinition
    {
        ...
        $definition
            ...
            ->add('firstName', new NotBlank(message: 'VIOLATION::FIRST_NAME_IS_BLANK_ERROR', normalizer: 'trim'))
            ->add('lastName', new NotBlank(message: 'VIOLATION::LAST_NAME_IS_BLANK_ERROR', normalizer: 'trim'))
            ->add('street', new NotBlank(message: 'VIOLATION::STREET_IS_BLANK_ERROR', normalizer: 'trim'))
            ->add('city', new NotBlank(message: 'VIOLATION::CITY_IS_BLANK_ERROR', normalizer: 'trim'))
