...
class_exists(\Shopware\Core\Checkout\DocumentV2\Aggregate\DocumentBaseConfigSalesChannel\DocumentBaseConfigSalesChannelEntity::class);

if (!class_exists(DocumentBaseConfigSalesChannelEntity::class, false)) {
    /**
