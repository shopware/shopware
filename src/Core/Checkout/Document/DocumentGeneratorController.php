...
class DocumentGeneratorController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/order/document/{documentTypeName}/create', name: 'api.action.document.bulk.create', methods: ['POST'], defaults: [PlatformRequest::ATTRIBUTE_ACL => ['document:create']])]
    ...
    #[Route(path: '/api/_action/document/{documentId}/upload', name: 'api.action.document.upload', methods: ['POST'], defaults: [PlatformRequest::ATTRIBUTE_ACL => ['document:update']])]
