...
#[ExperimentalReplacement(
    ...
    description: 'Register a data provider for DocumentType::DELIVERY_NOTE. Enrich the order criteria via enrichOrderCriteria() and the render data via provideRenderingData().',
)]
