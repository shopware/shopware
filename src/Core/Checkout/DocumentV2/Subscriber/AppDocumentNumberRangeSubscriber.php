 ...
 * differently-owned) identifier continues its existing sequence instead of restarting.
 *
 * @internal
 */
#[Package('after-sales')]
class AppDocumentNumberRangeSubscriber implements EventSubscriberInterface
{
    ...
    /**
     * @param array{identifier: string, label: array<string, string>, formats: list<string>, config: array<string, scalar>} $documentType
     */
    private function createNumberRange(array $documentType, Context $context): void
    {
