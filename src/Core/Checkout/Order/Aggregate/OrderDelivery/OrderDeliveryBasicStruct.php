...
class OrderDeliveryBasicStruct extends Entity
{
    ...
    public function getShippingAddress(): \Shopware\Core\Checkout\Order\Aggregate\OrderAddress\OrderAddressBasicStruct
    {
        return $this->shippingAddress;
    }

    public function setShippingAddress(\Shopware\Core\Checkout\Order\Aggregate\OrderAddress\OrderAddressBasicStruct $shippingAddress): void
    {
        $this->shippingAddress = $shippingAddress;
    }

    public function getOrderState(): \Shopware\Core\Checkout\Order\Aggregate\OrderState\OrderStateBasicStruct
    {
        return $this->orderState;
    }

    public function setOrderState(\Shopware\Core\Checkout\Order\Aggregate\OrderState\OrderStateBasicStruct $orderState): void
    {
