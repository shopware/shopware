...
class OrderDeliveryPositionBasicStruct extends Entity
{
    ...
    public function getOrderLineItem(): \Shopware\Core\Checkout\Order\Aggregate\OrderLineItem\OrderLineItemBasicStruct
    {
        return $this->orderLineItem;
    }

    public function setOrderLineItem(
        \Shopware\Core\Checkout\Order\Aggregate\OrderLineItem\OrderLineItemBasicStruct $orderLineItem): void
    {
