...
use Shopware\Checkout\Order\Event\OrderDelivery\OrderDeliveryAggregationResultLoadedEvent;
use Shopware\Checkout\Order\Event\OrderDelivery\OrderDeliveryBasicLoadedEvent;
use Shopware\Checkout\Order\Event\OrderDelivery\OrderDeliveryDetailLoadedEvent;
use Shopware\Checkout\Order\Event\OrderDelivery\OrderDeliveryIdSearchResultLoadedEvent;
...
class OrderDeliveryRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): OrderDeliverySearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): OrderDeliveryBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): OrderDeliveryDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(OrderDeliveryDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(OrderDeliveryDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(OrderDeliveryDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(OrderDeliveryDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(OrderDeliveryDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
