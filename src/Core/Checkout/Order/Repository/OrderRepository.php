...
use Shopware\Checkout\Order\Event\Order\OrderAggregationResultLoadedEvent;
use Shopware\Checkout\Order\Event\Order\OrderBasicLoadedEvent;
use Shopware\Checkout\Order\Event\Order\OrderDetailLoadedEvent;
use Shopware\Checkout\Order\Event\Order\OrderIdSearchResultLoadedEvent;
use Shopware\Checkout\Order\Event\Order\OrderSearchResultLoadedEvent;
...
class OrderRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): OrderSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): OrderBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): OrderDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(OrderDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(OrderDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(OrderDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(OrderDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(OrderDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
