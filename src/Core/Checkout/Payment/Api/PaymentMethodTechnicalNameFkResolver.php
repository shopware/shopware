...
namespace Shopware\Core\Checkout\Payment\Api;
 ...
 */
#[Package('framework')]
class PaymentMethodTechnicalNameFkResolver extends AbstractFkResolver
{
    ...
    {
        return 'payment_method.technical_name';
    }
    ...
    public function resolve(array $map): array
    {
        ...
        $hash = $this->connection->fetchAllKeyValue(
            'SELECT technical_name, LOWER(HEX(id)) FROM payment_method WHERE technical_name IN (:names)',
            ['names' => $names],
