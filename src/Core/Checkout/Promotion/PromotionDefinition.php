...
class PromotionDefinition extends EntityDefinition
{
    ...
    protected static function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            new ManyToOneAssociationField('personaRule', 'persona_rule_id', RuleDefinition::class, true),
            new FkField('scope_rule_id', 'scopeRuleId', RuleDefinition::class),
            new ManyToOneAssociationField('scopeRule', 'scope_rule_id', RuleDefinition::class, true),
