...
use Shopware\Checkout\Shipping\Event\ShippingMethod\ShippingMethodAggregationResultLoadedEvent;
use Shopware\Checkout\Shipping\Event\ShippingMethod\ShippingMethodBasicLoadedEvent;
use Shopware\Checkout\Shipping\Event\ShippingMethod\ShippingMethodDetailLoadedEvent;
use Shopware\Checkout\Shipping\Event\ShippingMethod\ShippingMethodIdSearchResultLoadedEvent;
use Shopware\Checkout\Shipping\Event\ShippingMethod\ShippingMethodSearchResultLoadedEvent;
...
class ShippingMethodRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): ShippingMethodSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): ShippingMethodBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): ShippingMethodDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ShippingMethodDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ShippingMethodDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ShippingMethodDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ShippingMethodDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(ShippingMethodDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
