...
class ShippingMethodDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new ManyToOneAssociationField('deliveryTime', 'delivery_time_id', DeliveryTimeDefinition::class, 'id'))->addFlags((new ApiAware())->withDescription('Estimated delivery time information')),
            ...
            (new ManyToOneAssociationField('availabilityRule', 'availability_rule_id', RuleDefinition::class))->addFlags((new ApiAware())->withDescription('Rule defining when this shipping method is available')),
            (new OneToManyAssociationField('prices', ShippingMethodPriceDefinition::class, 'shipping_method_id', 'id'))->addFlags((new ApiAware())->withDescription('Shipping prices based on weight, volume, or cart value'), new CascadeDelete()),
            (new ManyToOneAssociationField('media', 'media_id', MediaDefinition::class))->addFlags((new ApiAware())->withDescription('Shipping method logo or carrier image')),
            (new ManyToManyAssociationField('tags', TagDefinition::class, ShippingMethodTagDefinition::class, 'shipping_method_id', 'tag_id'))->addFlags((new ApiAware())->withDescription('Tags for organizing shipping methods')),
            ...
            (new ManyToOneAssociationField('tax', 'tax_id', TaxDefinition::class))->addFlags((new ApiAware())->withDescription('Tax configuration for shipping costs')),
