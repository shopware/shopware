    ...
    public function netPrices(): array
    {
        ...
        return [
            [
                ...
                QuantityPriceDefinition::create(13.436974789916, $highTaxRules),
            ],
        ];
    }
