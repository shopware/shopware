...
class BillingStreetRuleTest extends TestCase
{
    ...
    public function testValidationWithMissingStreetName()
    {
        try {
            ...
            foreach ($stackException->getExceptions() as $exception) {
                ...
                static::assertStringStartsWith(BillingStreetRule::class, $exception->getViolations()->get(0)->getPropertyPath());
                static::assertStringEndsWith(' (streetName)', $exception->getViolations()->get(0)->getPropertyPath());
    ...
    public function testValidationWithEmptyStreetName()
    {
        try {
            $this->conditionRepository->create([
                [
