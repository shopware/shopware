...
namespace Shopware\Core\Content\CancellationRequest\Event;
...
final class CancellationRequestEvent extends Event implements SalesChannelAware, MailAware, ScalarValuesAware, FlowEventAware
{
    ...
    public static function getAvailableData(): EventDataCollection
    {
        return (new EventDataCollection())
            ->add(FlowMailVariables::CANCELLATION_REQUEST_FORM_DATA, new ObjectType());
    }
    ...
    {
        return [
            FlowMailVariables::CANCELLATION_REQUEST_FORM_DATA => $this->formData,
        ];
    }
