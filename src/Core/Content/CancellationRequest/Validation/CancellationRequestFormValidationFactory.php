...
namespace Shopware\Core\Content\CancellationRequest\Validation;
...
#[Package('after-sales')]
class CancellationRequestFormValidationFactory implements DataValidationFactoryInterface
{
    public const CREATE_VALIDATION_NAME = 'cancellation_request_form.create';
    public const UPDATE_VALIDATION_NAME = 'cancellation_request_form.update';
