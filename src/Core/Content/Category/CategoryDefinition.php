...
class CategoryDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new ChildrenAssociationField(self::class))->addFlags((new ApiAware())->withDescription('Child categories within this category for hierarchical navigation')),

            (new ManyToOneAssociationField('media', 'media_id', MediaDefinition::class, 'id', false))->addFlags((new ApiAware())->withDescription('Category image or banner')),
            ...
            (new ManyToManyAssociationField('tags', TagDefinition::class, CategoryTagDefinition::class, 'category_id', 'tag_id'))->addFlags((new ApiAware())->withDescription('Tags for organizing and filtering categories')),
            ...
            (new ManyToOneAssociationField('cmsPage', 'cms_page_id', CmsPageDefinition::class, 'id', false))->addFlags((new ApiAware())->withDescription('CMS page layout for the category')),
            ...
            (new OneToManyAssociationField('seoUrls', SeoUrlDefinition::class, 'foreign_key'))->addFlags((new ApiAware())->withDescription('SEO-friendly URLs for the category across different sales channels')),
        ]);
    }
}
