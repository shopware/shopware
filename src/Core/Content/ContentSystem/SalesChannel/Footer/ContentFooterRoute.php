...
#[Package('discovery')]
class ContentFooterRoute extends AbstractContentFooterRoute
{
    /**
     * @internal
     */
    ...
    {
        return 'footer-content-layout-' . $layoutId;
    }

    public function getDecorated(): AbstractContentFooterRoute
    {
    ...
    public function load(Request $request, SalesChannelContext $context): ContentFooterRouteResponse
    {
        ...
        return new ContentFooterRouteResponse($contentPage);
    }
}
