...
class CookieProvider
{
     ...
     * Listed visibly, because a visitor needs it to retrieve their own records. The
     * value is generated by the client, so the entry carries none.
     */
    private function getRequiredConsentIdEntry(): CookieEntry
    {
        ...
        $entryRequiredConsentId->expiration = 30;
