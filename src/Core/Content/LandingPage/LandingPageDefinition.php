...
class LandingPageDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        $collection = new FieldCollection([
            ...
            (new ManyToOneAssociationField('cmsPage', 'cms_page_id', CmsPageDefinition::class, 'id', false))->addFlags(new ApiAware(), new AssociationDescription('CMS page layout for the landing page')),
            ...
            (new OneToManyAssociationField('seoUrls', SeoUrlDefinition::class, 'foreign_key'))->addFlags(new ApiAware(), new AssociationDescription('SEO-friendly URLs for the landing page across different sales channels')),
        ]);
