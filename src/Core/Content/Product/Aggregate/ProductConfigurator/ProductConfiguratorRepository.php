...
class ProductConfiguratorRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, Context $context): ProductConfiguratorSearchResult
    {
    ...
    public function readDetail(array $ids, Context $context): ProductConfiguratorDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductConfiguratorDefinition::class, $data, WriteContext::createFromContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductConfiguratorDefinition::class, $data, WriteContext::createFromContext($context));
        $event = EntityWrittenContainerEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(EntityWrittenContainerEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductConfiguratorDefinition::class, $data, WriteContext::createFromContext($context));
        $event = EntityWrittenContainerEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(EntityWrittenContainerEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductConfiguratorDefinition::class, $ids, WriteContext::createFromContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductConfiguratorDefinition::class, $id, WriteContext::createFromContext($context), $name, $versionId);
    }
