...
namespace Shopware\Core\Content\Product\Aggregate\ProductFeature;
...
class ProductFeatureDefinition extends MappingEntityDefinition
{
    public const ENTITY_NAME = 'product_feature';
