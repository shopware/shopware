...
class ProductMediaBasicStruct extends Entity
{
    ...
    /**
     * @var \Shopware\Core\Content\Media\MediaBasicStruct
     */
    protected $media;
    ...
    public function getMedia(): \Shopware\Core\Content\Media\MediaBasicStruct
    {
        return $this->media;
    }

    public function setMedia(\Shopware\Core\Content\Media\MediaBasicStruct $media): void
    {
        $this->media = $media;
    }
}
