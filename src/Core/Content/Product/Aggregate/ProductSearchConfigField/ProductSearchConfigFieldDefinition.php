...
class ProductSearchConfigFieldDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new BoolField('use_exact_subfield', 'useExactSubfield'))->addFlags(new Required())->setDescription('To configure whether exact match queries should target the exact subfield, which is not processed by the language analyzer (no stemming, stop-word removal, or token splitting).'),
