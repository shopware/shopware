...
use Shopware\Content\Product\Event\ProductService\ProductServiceDeletedEvent;
use Shopware\Content\Product\Event\ProductService\ProductServiceWrittenEvent;
