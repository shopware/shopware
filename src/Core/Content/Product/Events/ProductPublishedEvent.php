...
/**
 * Fires when the `active` flag of an existing live product row flips to true — an
 ...
 */
#[Package('inventory')]
class ProductPublishedEvent extends Event implements ProductAware, ScalarValuesAware, FlowEventAware, MailAware
{
    final public const EVENT_NAME = 'product.published';
