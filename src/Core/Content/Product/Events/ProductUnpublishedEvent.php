...
/**
 * Fires when the `active` flag of an existing live product row flips to false — an
 * actual transition, not any write that happens to contain `active`. Row-level only:
 * variants inheriting `active` from their parent do not produce this event.
 */
#[Package('inventory')]
class ProductUnpublishedEvent extends Event implements ProductAware, ScalarValuesAware, FlowEventAware, MailAware
{
    final public const EVENT_NAME = 'product.unpublished';
    ...
    public static function getAvailableData(): EventDataCollection
    {
        return (new EventDataCollection())
            ...
            ->add('active', new ScalarValueType(ScalarValueType::TYPE_BOOL));
    }
