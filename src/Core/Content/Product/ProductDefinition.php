...
class ProductDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new OneToManyAssociationField('downloads', ProductDownloadDefinition::class, 'product_id'))->addFlags((new ApiAware())->withDescription('Downloadable files associated with the product (e.g., manuals, digital content)'), new CascadeDelete()),
            ...
            (new ChildrenAssociationField(self::class))->addFlags((new ApiAware())->withDescription('Product variants that inherit from this parent product')),

            (new ManyToOneAssociationField('deliveryTime', 'delivery_time_id', DeliveryTimeDefinition::class))->addFlags((new ApiAware())->withDescription('Estimated delivery time for the product'), new Inherited()),

            (new ManyToOneAssociationField('tax', 'tax_id', TaxDefinition::class, 'id'))->addFlags((new ApiAware())->withDescription('Tax configuration (rate and calculation rules)'), new Inherited()),

            (new ManyToOneAssociationField('manufacturer', 'product_manufacturer_id', ProductManufacturerDefinition::class, 'id'))->addFlags((new ApiAware())->withDescription('Product manufacturer or brand information'), new Inherited()),

            (new ManyToOneAssociationField('unit', 'unit_id', UnitDefinition::class, 'id'))->addFlags((new ApiAware())->withDescription('Product unit of measure (e.g., piece, liter, kg)'), new Inherited()),

            (new ManyToOneAssociationField('cover', 'product_media_id', ProductMediaDefinition::class, 'id'))->addFlags((new ApiAware())->withDescription('Main product image displayed in listings and detail pages'), new Inherited()),
            ...
            (new ManyToOneAssociationField('cmsPage', 'cms_page_id', CmsPageDefinition::class, 'id', false))->addFlags((new ApiAware())->withDescription('Custom CMS page layout for the product detail page'), new Inherited()),

            (new ManyToOneAssociationField('canonicalProduct', 'canonical_product_id', ProductDefinition::class, 'id'))->addFlags((new ApiAware())->withDescription('Canonical product reference for variant consolidation and SEO purposes'), new Inherited()),

            (new OneToManyAssociationField('prices', ProductPriceDefinition::class, 'product_id'))->addFlags(new CascadeDelete(), new Inherited()),

            (new OneToManyAssociationField('media', ProductMediaDefinition::class, 'product_id'))->addFlags((new ApiAware())->withDescription('Product images and media gallery'), new CascadeDelete(), new Inherited()),

            (new OneToManyAssociationField('crossSellings', ProductCrossSellingDefinition::class, 'product_id'))->addFlags((new ApiAware())->withDescription('Cross-selling configurations (related products, accessories, similar items)'), new CascadeDelete(), new Inherited()),
            ...
            (new OneToManyAssociationField('configuratorSettings', ProductConfiguratorSettingDefinition::class, 'product_id', 'id'))->addFlags((new ApiAware())->withDescription('Variant configurator settings defining available options for product variants'), new CascadeDelete()),
            ...
            (new OneToManyAssociationField('productReviews', ProductReviewDefinition::class, 'product_id'))->addFlags((new ApiAware())->withDescription('Customer reviews and ratings for the product'), new CascadeDelete(false)),

            (new OneToManyAssociationField('mainCategories', MainCategoryDefinition::class, 'product_id'))->addFlags((new ApiAware())->withDescription('Primary category assignments per sales channel for SEO and navigation'), new CascadeDelete()),

            (new OneToManyAssociationField('seoUrls', SeoUrlDefinition::class, 'foreign_key'))->addFlags((new ApiAware())->withDescription('SEO-friendly URLs for the product across different sales channels')),
            ...
            (new ManyToManyAssociationField('options', PropertyGroupOptionDefinition::class, ProductOptionDefinition::class, 'product_id', 'property_group_option_id'))->addFlags((new ApiAware())->withDescription('Product variant options (e.g., size, color) that define different variants'), new CascadeDelete()),

            (new ManyToManyAssociationField('properties', PropertyGroupOptionDefinition::class, ProductPropertyDefinition::class, 'product_id', 'property_group_option_id'))->addFlags((new ApiAware())->withDescription('Product properties and characteristics for filtering'), new CascadeDelete(), new Inherited()),

            (new ManyToManyAssociationField('categories', CategoryDefinition::class, ProductCategoryDefinition::class, 'product_id', 'category_id'))->addFlags((new ApiAware())->withDescription('Categories this product is assigned to'), new CascadeDelete(), new Inherited()),

            (new ManyToManyAssociationField('streams', ProductStreamDefinition::class, ProductStreamMappingDefinition::class, 'product_id', 'product_stream_id'))->addFlags((new ApiAware())->withDescription('Dynamic product streams this product belongs to based on defined filters'), new CascadeDelete()),

            (new ManyToManyAssociationField('categoriesRo', CategoryDefinition::class, ProductCategoryTreeDefinition::class, 'product_id', 'category_id'))->addFlags((new ApiAware())->withDescription('Read-only category tree including all parent categories for optimized queries'), new CascadeDelete(false), new WriteProtected()),

            (new ManyToManyAssociationField('tags', TagDefinition::class, ProductTagDefinition::class, 'product_id', 'tag_id'))->addFlags(new CascadeDelete(), new Inherited(), (new ApiAware())->withDescription('Tags for organizing and filtering products')),
