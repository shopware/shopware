...
use Shopware\Content\Product\Event\ProductConfigurator\ProductConfiguratorAggregationResultLoadedEvent;
use Shopware\Content\Product\Event\ProductConfigurator\ProductConfiguratorBasicLoadedEvent;
use Shopware\Content\Product\Event\ProductConfigurator\ProductConfiguratorDetailLoadedEvent;
use Shopware\Content\Product\Event\ProductConfigurator\ProductConfiguratorIdSearchResultLoadedEvent;
...
class ProductConfiguratorRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): ProductConfiguratorSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): ProductConfiguratorBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): ProductConfiguratorDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductConfiguratorDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductConfiguratorDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductConfiguratorDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductConfiguratorDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductConfiguratorDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
