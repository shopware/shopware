...
use Shopware\Content\Product\Event\ProductContextPrice\ProductContextPriceAggregationResultLoadedEvent;
use Shopware\Content\Product\Event\ProductContextPrice\ProductContextPriceBasicLoadedEvent;
...
class ProductContextPriceRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): ProductContextPriceSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): ProductContextPriceBasicCollection
    {
        /** @var ProductContextPriceBasicCollection $entities */
    ...
    public function readDetail(array $ids, ApplicationContext $context): ProductContextPriceDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductContextPriceDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductContextPriceDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductContextPriceDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductContextPriceDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductContextPriceDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
