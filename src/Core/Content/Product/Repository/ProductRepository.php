...
use Shopware\Content\Product\Event\Product\ProductAggregationResultLoadedEvent;
use Shopware\Content\Product\Event\Product\ProductBasicLoadedEvent;
use Shopware\Content\Product\Event\Product\ProductDetailLoadedEvent;
use Shopware\Content\Product\Event\Product\ProductIdSearchResultLoadedEvent;
use Shopware\Content\Product\Event\Product\ProductSearchResultLoadedEvent;
...
class ProductRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): ProductSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): ProductBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): ProductDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ProductDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ProductDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ProductDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ProductDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(ProductDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
