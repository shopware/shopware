...
use Shopware\Core\Content\Product\SalesChannel\Listing\Filter\AbstractFilterHandler;
...
#[Package('inventory')]
class AggregationProcessor extends AbstractListingProcessor
{
    /**
     * @internal
     *
     * @param iterable<AbstractFilterHandler> $factories
     */
