...
class ProductListingResult extends EntitySearchResult
{
    ...
    /**
     * @var array<string, int|float|string|bool|array<string, mixed>|null>
     */
    ...
    /**
     * @param int|float|string|bool|array<string, mixed>|null $value
     */
    ...
    /**
     * @return array<string, int|float|string|bool|array<string, mixed>|null>
     */
