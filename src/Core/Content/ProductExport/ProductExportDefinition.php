...
class ProductExportDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('feed_label', 'feedLabel', 20))->setDescription('Optional Google Merchant Center feed_label used to group products from one data source. Format: uppercase A-Z, 0-9, dashes, underscores. Max 20 chars.'),
