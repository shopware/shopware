...
use Shopware\Core\Content\Rule\Event\ContextRuleDeletedEvent;
use Shopware\Core\Content\Rule\Event\ContextRuleWrittenEvent;
...
class ContextRuleDefinition extends EntityDefinition
{
    ...
    public static function getFields(): FieldCollection
    {
        ...
        self::$fields = new FieldCollection([
            ...
            (new OneToManyAssociationField('contextCartModifers', DiscountSurchargeDefinition::class, 'context_rule_id', false, 'id'))->setFlags(new CascadeDelete(), new WriteOnly()),
        ]);
