...
class SeoActionController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/seo-url-template/context', name: 'api.seo-url-template.context', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['seo_url_template:read']], methods: [Request::METHOD_POST])]
    ...
    #[Route(path: '/api/_action/seo-url/canonical', name: 'api.seo-url.canonical', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['seo_url:update']], methods: [Request::METHOD_PATCH])]
    ...
    #[Route(path: '/api/_action/seo-url/create-custom-url', name: 'api.seo-url.create', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['seo_url:create']], methods: [Request::METHOD_POST])]
    ...
    #[Route(path: '/api/_action/seo-url-template/default/{routeName}', name: 'api.seo-url-template.default', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['seo_url_template:read']], methods: [Request::METHOD_GET])]
