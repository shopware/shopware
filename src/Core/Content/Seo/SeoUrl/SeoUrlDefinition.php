...
class SeoUrlDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('route_name', 'routeName', 255))->addFlags(new ApiAware(), new Required())->setDescription('A destination routeName that has been registered somewhere in the app\'s router. For example: \\\"frontend.detail.page\\\"'),
