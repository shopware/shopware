...
class CategoryUrlProvider extends AbstractUrlProvider
{
    ...
    public function getUrls(SalesChannelContext $context, int $limit, ?int $offset = null): UrlResult
    {
        ...
        $routeName = $this->entityRouteResolver->getRouteNameForEntityName(CategoryDefinition::ENTITY_NAME, $context->isHeadless());
        ...
        foreach ($availableCategories as $category) {
            ...
            if (isset($seoUrls[$category['id']])) {
                ...
                $newUrl->setLoc($this->entityRouteResolver->generateUrl(CategoryDefinition::ENTITY_NAME, $category['id'], $context->isHeadless()));
            }
