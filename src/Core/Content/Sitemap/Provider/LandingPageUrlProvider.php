...
class LandingPageUrlProvider extends AbstractUrlProvider
{
    ...
    public function getUrls(SalesChannelContext $context, int $limit, ?int $offset = null): UrlResult
    {
        ...
        $routeName = $this->entityRouteResolver->getRouteNameForEntityName(LandingPageDefinition::ENTITY_NAME, $context->isHeadless());
        ...
        foreach ($landingPages as $landingPage) {
            ...
            if (isset($seoUrls[$landingPage['id']])) {
                ...
                $url->setLoc($this->entityRouteResolver->generateUrl(LandingPageDefinition::ENTITY_NAME, $landingPage['id'], $context->isHeadless()));
            }
