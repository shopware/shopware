...
class ProductUrlProvider extends AbstractUrlProvider
{
    ...
    public function getUrls(SalesChannelContext $context, int $limit, ?int $offset = null): UrlResult
    {
        ...
        $routeName = $this->entityRouteResolver->getRouteNameForEntityName(ProductDefinition::ENTITY_NAME, $context->isHeadless());
        ...
        foreach ($products as $product) {
            ...
            if (isset($seoUrls[$product['id']])) {
                ...
                $newUrl->setLoc($this->entityRouteResolver->generateUrl(ProductDefinition::ENTITY_NAME, $product['id'], $context->isHeadless()));
            }
