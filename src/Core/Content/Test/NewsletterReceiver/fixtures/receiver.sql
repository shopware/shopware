...
INSERT INTO `newsletter_receiver`
    (`id`, `email`, `first_name`, `last_name`, `zip_code`, `city`, `street`, `status`, `hash`, `salutation_id`, `language_id`, `sales_channel_id`, `attributes`, `confirmed_at`, `created_at`, `updated_at`)
VALUES (
