...
class VariantGeneratorTest extends KernelTestCase
{
    ...
    public function testGenerateOneDimension()
    {
        ...
        $writtenEvent = $this->generator->generate($id, Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID));

        $productWritten = $writtenEvent->getEventByDefinition(ProductDefinition::class);

        $this->assertCount(2, $productWritten->getIds());

        $variants = $this->repository->readDetail($productWritten->getIds(), Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID));
    ...
    public function testMultiDimension()
    {
        ...
        $variants = $this->repository->readBasic($productWritten->getIds(), Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID));
        $this->assertCount(4, $variants);

        $parent = $this->repository->readBasic([$id], Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID))
            ->get($id);
    ...
    public function testPagination()
    {
        ...
        $writtenEvent = $this->generator->generate($id, Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID), 0, 1);
        $productWritten = $writtenEvent->getEventByDefinition(ProductDefinition::class);
        ...
        $writtenEvent = $this->generator->generate($id, Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID), 1, 1);
        $productWritten = $writtenEvent->getEventByDefinition(ProductDefinition::class);
        $this->assertCount(1, $productWritten->getIds());

        $criteria = new Criteria();
        $criteria->addFilter(new TermQuery('product.parentId', $id));
        $variants = $this->repository->search($criteria, Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID));
    ...
    public function testGenerateHighDimension()
    {
        ...
        $this->repository->create([$data], Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID));
        $event = $this->generator->generate($id, Context:: createDefaultContext(\Shopware\Defaults::TENANT_ID));
