...
| :--- | :--- | :--- | :--- |
|`after_sales.document.deleted` | Triggers when a document is deleted | - | {"documentId":"string","documentNumber":"string","deletedAt":"string","orderId":"string","orderVersionId":"string"}
