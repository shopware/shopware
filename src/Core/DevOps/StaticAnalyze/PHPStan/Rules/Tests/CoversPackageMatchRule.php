 ...
 *
 * Enabled per test namespace (`coversPackageMatchNamespaces` in common.neon): each
 * suite is aligned in its own pull request and added to the list there.
 *
 * @internal
 *
...
class CoversPackageMatchRule implements Rule
{
    ...
    public function __construct(
        ...
        $this->enabledNamespaces = $configuration->getCoversPackageMatchNamespaces();
    }
    ...
    public function processNode(Node $node, Scope $scope): array
    {
        ...
        if (!$this->isEnabledFor($classReflection->getName())) {
            return [];
        }
    ...
    private function isEnabledFor(string $className): bool
    {
