...
use Shopware\Core\DevOps\System\Exception\ShopConfigurationException;
...
class ShopConfigurator
{
    ...
    private function createNewLanguageEntry(string $iso): string
    {
        ...
        $name = $this->connection->fetchOne(
            ...
            FROM `locale_translation`
            WHERE LOWER(HEX(locale_id)) = :localeId
            AND LOWER(language_id) = :languageId',
        ...
        $this->connection->executeStatement(
            ...
            VALUES
            (:id,:name,UNHEX(:localeId),UNHEX(:localeId))',
