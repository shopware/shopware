...
class AnnotationTagTester
{
     ...
     */
    private const BC_CHANGE_ATTRIBUTES = 'ReturnTypeNarrowing|ReturnTypeWidening|ParameterTypeNarrowing|ParameterTypeWidening|ExceptionChange|NewOptionalParameter|ParameterNameChange|BecomesAbstract|BecomesInternal|BecomesFinal|ClassHierarchyChange|VisibilityChange';
