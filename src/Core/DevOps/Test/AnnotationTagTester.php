...
class AnnotationTagTester
{
     ...
     */
    private const BC_CHANGE_ATTRIBUTES = 'ReturnTypeNarrowing|ReturnTypeWidening|ParameterTypeNarrowing|ParameterTypeWidening|NewOptionalParameter|NewRequiredParameter|ParameterNameChange|ParameterRemoval|BecomesAbstract|BecomesInternal|BecomesFinal|ClassHierarchyChange|VisibilityChange';
