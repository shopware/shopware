...
class AnnotationTagTester
{
     ...
     */
    private const BC_CHANGE_ATTRIBUTES = 'ReturnTypeNarrowing|ReturnTypeWidening|ParameterTypeNarrowing|ParameterTypeWidening|NewOptionalParameter|ParameterNameChange|ParameterOrderChange|ParameterRemoval|BecomesAbstract|BecomesInternal|BecomesFinal|ClassHierarchyChange|VisibilityChange';
