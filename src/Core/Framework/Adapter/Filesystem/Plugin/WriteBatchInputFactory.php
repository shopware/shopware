 ...
 * @internal
 *
 * @codeCoverageIgnore Integration tested with \Shopware\Tests\Integration\Core\Framework\Adapter\Filesystem\Plugin\WriteBatchInputFactoryTest
 */
#[Package('core')]
class WriteBatchInputFactory
{
    /**
    ...
    public function fromDirectory(string $directory, string $target): array
    {
        ...
        return array_values(array_map(
            fn (SplFileInfo $file) => new WriteBatchInput(
                $file->getRealPath(),
