...
class Translator extends AbstractTranslator
{
    ...
    public function getSnippetSetId(?string $locale = null): ?string
    {
        ...
        if ($currentRequest !== null && $currentRequest->attributes->has(SalesChannelRequestAttribute::DOMAIN_SNIPPET_SET_ID->value)) {
            $snippetSetId = $currentRequest->attributes->get(SalesChannelRequestAttribute::DOMAIN_SNIPPET_SET_ID->value);
        }
