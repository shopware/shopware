    ...
    private function addHeaderParameters(OpenApi $openApi): void
    {
        $openApi->components->parameters = [
            ...
            new Parameter([
                ...
                'description' => 'Set to `session` to resolve the context from the storefront session cookie of a same-origin request instead of a context token. Mutually exclusive with `sw-context-token`.',
            ]),
        ];
    }
