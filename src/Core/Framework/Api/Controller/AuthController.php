...
class AuthController extends AbstractController
{
    ...
    /**
     * @Route("/api/oauth/authorize", name="api.oauth.authorize", defaults={"authentification_required"=false}, methods={"POST"})
     */
    ...
    /**
     * @Route("/api/oauth/token", name="api.oauth.token", defaults={"authentification_required"=false}, methods={"POST"})
     */
