...
class IntegrationController extends AbstractController
{
    ...
    #[Route(path: '/api/integration', name: 'api.integration.create', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['integration:create']], methods: ['POST'])]
    ...
    #[Route(path: '/api/integration/{integrationId}', name: 'api.integration.update', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['integration:update']], methods: ['PATCH'])]
