...
class RefreshTokenRepository implements RefreshTokenRepositoryInterface
{
        ...
        if ($userIdentifier) {
            $this->connection->createQueryBuilder()
                ...
                ->setParameters([
                    ...
                    'issuedAt' => \DateTime::createFromImmutable($this->clock->now())->format(Defaults::STORAGE_DATE_TIME_FORMAT),
    ...
    {
        $now = \DateTime::createFromImmutable($this->clock->now())->format(Defaults::STORAGE_DATE_TIME_FORMAT);
