...
{
    final public const ENTITY_NAME = 'app_mcp_resource';
    ...
    {
        return AppMcpResourceCollection::class;
    }
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('uri', 'uri', 2048))->addFlags(new Required()),
            ...
            (new TranslationsAssociationField(AppMcpResourceTranslationDefinition::class, 'app_mcp_resource_id'))->addFlags(new Required(), new CascadeDelete()),
        ]);
    }
}
