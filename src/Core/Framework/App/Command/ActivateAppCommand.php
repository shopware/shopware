...
class ActivateAppCommand extends Command
{
    /**
    ...
    public function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $io->success('App activated successfully.');
    ...
    {
        $this->setName('app:activate')
            ->setDescription('activate the app in the folder with the given name')
            ->addArgument(
                'name',
