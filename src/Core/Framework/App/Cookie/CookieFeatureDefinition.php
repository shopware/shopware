 ...
 *
 * @phpstan-type CookiePayload array{snippet_name: string, snippet_description?: string|null, cookie?: string|null, value?: string|null, expiration?: int|null, active_payment_methods?: list<string>, entries?: list<array<string, mixed>>}
 */
#[Package('framework')]
class CookieFeatureDefinition implements AppFeatureDefinition
{
    ...
    public function fromApp(Manifest $manifest, Filesystem $appFilesystem, string $defaultLocale): array
    {
        return array_map(
            static function (array $group): CookieConfig {
                /** @var list<string> $activePaymentMethods */
                $activePaymentMethods = $group['active_payment_methods'] ?? [];
    ...
    public function toPayload(AppFeatureConfig $declared, ?AppFeatureConfig $stored): array
    {
        return [
            ...
            'active_payment_methods' => $declared->activePaymentMethods,
    ...
    public function fromPayload(array $payload): CookieConfig
    {
        return new CookieConfig(
            ...
            $payload['active_payment_methods'] ?? [],
            $payload['entries'] ?? [],
        );
    }
}
