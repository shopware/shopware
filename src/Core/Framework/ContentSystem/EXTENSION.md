...
|------|----------------------------------------------------------------------------|-----------------------------------------------------------------|
| A    | `media: mediaId` (bare property-reference string)                          | Exactly one loader can produce the property's declared type     |
