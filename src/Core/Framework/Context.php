...
class Context extends Struct
{
    ...
    public function scope(string $scope, \Closure $callback)
    {
        ...
        if ($removeDalWriteEventState) {
            // Explicit system-scope callbacks should keep their elevated behavior, even when called from DAL write-event dispatch.
        ...
        try {
            ...
            if ($removeDalWriteEventState) {
                // Restore the marker for the surrounding DAL write-event dispatch.
