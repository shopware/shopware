...
class DataAbstractionLayerException extends HttpException
{
    ...
    public static function cascadeDeleteOnManyToOne(string $entity, string $property): self
    {
        return new self(
            ...
            'Association "{{ property }}" of entity "{{ entity }}" must not use OnDelete::CASCADE. On a many-to-one it '
            . 'makes the DAL resolve the referenced record as affected by the delete, which no foreign key ever does. '
