...
/**
 * @deprecated tag:v6.8.0 - reason:remove-exception - Will be removed, use {@see \Shopware\Core\Framework\DataAbstractionLayer\Exception\UnmappedFieldException} instead
 *
 * @codeCoverageIgnore
 */
#[Package('framework')]
