...
class RepositoryWriterFacade
{
     ...
     * @param array $payload The payload you want to upsert, as a list of associative arrays, where each associative array represents the payload for one entity.
     *
     ...
     * @param array $payload The primary keys of the entities you want to delete, as a list of associative arrays, associative array represents the primary keys for one entity.
     *
     ...
     *
     * @param array $payload All operations that should be executed.
     *
