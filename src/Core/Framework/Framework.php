...
class Framework extends Bundle
{
    ...
    public function build(ContainerBuilder $container): void
    {
        ...
        /** Normalizes entity name onto definition tags, validates tag consistency, runs after AttributeEntityCompilerPass */
        $container->addCompilerPass(new EntityDefinitionTagCompilerPass(), PassConfig::TYPE_BEFORE_OPTIMIZATION, 50);
