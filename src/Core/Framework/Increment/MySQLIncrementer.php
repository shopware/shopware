...
class MySQLIncrementer extends AbstractIncrementer
{
    ...
    public function decrement(string $cluster, string $key): void
    {
        $payload = [
            ...
            'cluster' => $cluster,
            'key' => $key,
            'updatedAt' => \DateTime::createFromImmutable($this->clock->now())->format(Defaults::STORAGE_DATE_TIME_FORMAT),
        ];
    ...
    public function reset(string $cluster, ?string $key = null): void
    {
        $query = $this->connection->createQueryBuilder()
            ...
            ->setParameter('updatedAt', \DateTime::createFromImmutable($this->clock->now())->format(Defaults::STORAGE_DATE_TIME_FORMAT))
