 ...
 * @internal
 *
 * @phpstan-type PackageString 'buyers-experience'|'services-settings'|'inventory'|'content'|'sales-channel'|'customer-order'|'checkout'|'merchant-services'|'storefront'|'core'|'administration'|'framework'|'data-services'|'innovation'|'discovery'|'b2b'|'fundamentals@discovery'|'after-sales'|'fundamentals@after-sales'
 */
