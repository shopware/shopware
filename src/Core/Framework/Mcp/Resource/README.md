...
- [Internal](../../../../../coding-guidelines/core/internal.md) for resource service markings.
- [Domain exceptions](../../../../../coding-guidelines/core/domain-exceptions.md) for not-found and validation exceptions.
- [Unit tests](../../../../../coding-guidelines/core/unit-tests.md) and [static analysis](../../../../../coding-guidelines/core/writing-code-for-static-analysis.md) for resource tests and PHPStan expectations.
