...
use Shopware\Core\Framework\ORM\Version\Collection\VersionCommitDataDetailCollection;
use Shopware\Core\Framework\ORM\Version\Definition\VersionCommitDataDefinition;
use Shopware\Core\Framework\ORM\Version\Event\VersionCommitData\VersionCommitDataAggregationResultLoadedEvent;
use Shopware\Core\Framework\ORM\Version\Event\VersionCommitData\VersionCommitDataBasicLoadedEvent;
use Shopware\Core\Framework\ORM\Version\Event\VersionCommitData\VersionCommitDataDetailLoadedEvent;
use Shopware\Core\Framework\ORM\Version\Event\VersionCommitData\VersionCommitDataIdSearchResultLoadedEvent;
use Shopware\Core\Framework\ORM\Version\Event\VersionCommitData\VersionCommitDataSearchResultLoadedEvent;
...
class VersionCommitDataRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, Context $context): VersionCommitDataSearchResult
    {
    ...
    public function readBasic(array $ids, Context $context): VersionCommitDataBasicCollection
    {
    ...
    public function readDetail(array $ids, Context $context): VersionCommitDataDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(VersionCommitDataDefinition::class, $data, WriteContext::createFromContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(VersionCommitDataDefinition::class, $data, WriteContext::createFromContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(VersionCommitDataDefinition::class, $data, WriteContext::createFromContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(VersionCommitDataDefinition::class, $ids, WriteContext::createFromContext($context));
    ...
    {
        return $this->versionManager->createVersion(VersionCommitDataDefinition::class, $id, WriteContext::createFromContext($context), $name, $versionId);
    }
