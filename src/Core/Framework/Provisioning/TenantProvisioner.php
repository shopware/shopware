...
class TenantProvisioner
{
    ...
    private function createCountry(): void
    {
        $this->importTable(
            'country',
            ['id', 'version_id', 'iso', 'position', 'shipping_free', 'tax_free', 'taxfree_for_vat_id', 'taxfree_vatid_checked', 'active', 'iso3', 'display_state_in_registration', 'force_state_in_registration', 'created_at', 'updated_at'],
            ['tenant_id'],
            [
                [hex2bin('ffe61e1c99154f9597014a310ab5482d'), $this->defaultId, 'GR', 10, 0, 0, 0, 0, 0, 'GRC', 0, 0, $this->now(), null],
                [hex2bin('6c72828ec5e240588a35114cf1d4d5ef'), $this->defaultId, 'GB', 10, 0, 0, 0, 0, 0, 'GBR', 0, 0, $this->now(), null],
                [hex2bin('584c3ff22f5644789705383bde891fc9'), $this->defaultId, 'IE', 10, 0, 0, 0, 0, 0, 'IRL', 0, 0, $this->now(), null],
                [hex2bin('b72b9b7cd26b4a40a36f2e76a1bf42c1'), $this->defaultId, 'IS', 10, 0, 0, 0, 0, 0, 'ISL', 0, 0, $this->now(), null],
                [hex2bin('92ca022e9d28492e9ea173f279fa6755'), $this->defaultId, 'IT', 10, 0, 0, 0, 0, 1, 'ITA', 0, 0, $this->now(), null],
                [hex2bin('e130d974fd6c438485972fe00b5cd609'), $this->defaultId, 'JP', 10, 0, 0, 0, 0, 0, 'JPN', 0, 0, $this->now(), null],
                [hex2bin('a453634acb414768b2542ae9a57639b5'), $this->defaultId, 'CA', 10, 0, 0, 0, 0, 0, 'CAN', 0, 0, $this->now(), null],
                [hex2bin('e5cbe4b2105843c3bdef2e9c03eccaae'), $this->defaultId, 'LU', 10, 0, 0, 0, 0, 0, 'LUX', 0, 0, $this->now(), null],
                [$this->defaultId, $this->defaultId, 'DE', 1, 0, 0, 0, 0, 1, 'DEU', 0, 0,  $this->now(), null],
                [hex2bin('9deee5660fd1474fbecdf6fc1809add3'), $this->defaultId, 'NA', 10, 0, 0, 0, 0, 0, 'NAM', 0, 0, $this->now(), null],
                [hex2bin('04ed51ccbb2341bc9b352d78e64213fb'), $this->defaultId, 'NL', 10, 0, 0, 0, 0, 1, 'NLD', 0, 0, $this->now(), null],
                [hex2bin('e216449bd67646cc9176a1d57a2f8094'), $this->defaultId, 'NO', 10, 0, 0, 0, 0, 0, 'NOR', 0, 0, $this->now(), null],
                [hex2bin('c650574d63d34834b836d8e7f0339ca8'), $this->defaultId, 'AT', 1, 0, 0, 0, 0, 1, 'AUT', 0, 0,  $this->now(), null],
                [hex2bin('a40ed5b07bca4b06995a0a56b1170155'), $this->defaultId, 'PT', 10, 0, 0, 0, 0, 0, 'PRT', 0, 0, $this->now(), null],
                [hex2bin('f7b0810e24234ae397c769b260a02474'), $this->defaultId, 'SE', 10, 0, 0, 0, 0, 0, 'SWE', 0, 0, $this->now(), null],
                [hex2bin('4f52e121f6724b968c00d05829f9a38d'), $this->defaultId, 'CH', 10, 0, 1, 0, 0, 1, 'CHE', 0, 0, $this->now(), null],
                [hex2bin('2aba3f2990e044c78bf53b87fb6c3af3'), $this->defaultId, 'ES', 10, 0, 0, 0, 0, 1, 'ESP', 0, 0, $this->now(), null],
                [hex2bin('bdcb207c87ab4648b5acde9138f48894'), $this->defaultId, 'US', 10, 0, 0, 0, 0, 0, 'USA', 0, 0, $this->now(), null],
                [hex2bin('e163778197a24b61bd2ae72d006a6d3c'), $this->defaultId, 'LI', 10, 0, 0, 0, 0, 0, 'LIE', 0, 0, $this->now(), null],
                [hex2bin('448744a58b9f44e58c40804fef6520f8'), $this->defaultId, 'AE', 10, 0, 0, 0, 0, 1, 'ARE', 0, 0, $this->now(), null],
                [hex2bin('259f7c2be0b44eb6a273a70ea6dd8029'), $this->defaultId, 'PL', 10, 0, 0, 0, 0, 0, 'POL', 0, 0, $this->now(), null],
                [hex2bin('d99834aefa4941b490dae37d0027f6bc'), $this->defaultId, 'HU', 10, 0, 0, 0, 0, 0, 'HUN', 0, 0, $this->now(), null],
                [hex2bin('11cf2cdd303c41d7bf66808bfe7769a5'), $this->defaultId, 'TR', 10, 0, 0, 0, 0, 0, 'TUR', 0, 0, $this->now(), null],
                [hex2bin('b240408078894b0491634af5963f0c04'), $this->defaultId, 'CZ', 10, 0, 0, 0, 0, 0, 'CZE', 0, 0, $this->now(), null],
                [hex2bin('8021ae3dd9ec4675920c16152473e5cc'), $this->defaultId, 'SK', 10, 0, 0, 0, 0, 0, 'SVK', 0, 0, $this->now(), null],
                [hex2bin('1d56b07f6a5e4ee0a4e23abc06ba9b1e'), $this->defaultId, 'RO', 10, 0, 0, 0, 0, 0, 'ROU', 0, 0, $this->now(), null],
                [hex2bin('68fea9f12c9c46748382b1f48a32014f'), $this->defaultId, 'BR', 10, 0, 0, 0, 0, 0, 'BRA', 0, 0, $this->now(), null],
                [hex2bin('1c91bf01a6a547a78497abf7b8e4e5db'), $this->defaultId, 'IL', 10, 0, 0, 0, 0, 0, 'ISR', 0, 0, $this->now(), null],
                [hex2bin('5a4aa22452e04acca23185d4d21bb3bf'), $this->defaultId, 'AU', 10, 0, 0, 0, 0, 1, 'AUS', 0, 0, $this->now(), null],
                [hex2bin('2e54611a053b4b19afccca547f50bf56'), $this->defaultId, 'BE', 10, 0, 0, 0, 0, 1, 'BEL', 0, 0, $this->now(), null],
                [hex2bin('1d7911d918714c3ea9f0d7339afd3d43'), $this->defaultId, 'DK', 10, 0, 0, 0, 0, 1, 'DNK', 0, 0, $this->now(), null],
                [hex2bin('9d8661d69c10416c858dbf408ec2500a'), $this->defaultId, 'FI', 10, 0, 0, 0, 0, 1, 'FIN', 0, 0, $this->now(), null],
                [hex2bin('e85c25e1cdfc4cd4af49d54c34aa3d25'), $this->defaultId, 'FR', 10, 0, 0, 0, 0, 0, 'FRA', 0, 0, $this->now(), null],
            ]
        );
