...
class MaintenanceModeResolver
{
    ...
    {
        $whitelist = $request->attributes->get(SalesChannelRequestAttribute::SALES_CHANNEL_MAINTENANCE_IP_ALLOW_LIST->value) ?? '';
    ...
    {
        return (bool) $request->attributes->get(SalesChannelRequestAttribute::SALES_CHANNEL_MAINTENANCE->value);
    }
}
