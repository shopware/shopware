...
EOF;
    ...
    public function testSearchForNullFields(): void
    {
        ...
        $this->getWriter()->insert(new JsonDefinition(), $data, $context);

        $criteria = new Criteria();
        $criteria->addFilter(new EqualsFilter('_test_nullable.data', null));
        $result = $this->getRepository()->search(new JsonDefinition(), $criteria, $context->getContext());
    ...
    public function testMissingProperty(): void
    {
        ...
        $ex = null;
        try {
            $this->getWriter()->insert(new ProductDefinition(), [$data], $context);
    ...
    public function testWithoutMappingShouldAcceptAnyKey(): void
    {
        ...
        $this->getWriter()->insert(new VersionCommitDataDefinition(), [$data], $context);
    ...
    public function testFieldNesting(): void
    {
        ...
        $ex = null;
        try {
            $this->getWriter()->insert(new NestedDefinition(), [$data], $context);
        } catch (WriteStackException $ex) {
        }
    ...
    public function testWriteUtf8(): void
    {
        ...
        $written = $this->getWriter()->insert(new JsonDefinition(), $data, $context);
    ...
    public function testSqlInjectionFails(): void
    {
        ...
        // invalid json path
        try {
            $result = $repo->search(new JsonDefinition(), $criteria, $context);
    ...
    public function testNestedJsonField(): void
    {
        ...
        $written = $this->getWriter()->insert(new JsonDefinition(), [$insert], $context);
        ...
        $written = $this->getWriter()->update(new JsonDefinition(), [$update], $context);
        static::assertCount(1, $written);
        static::assertCount(1, $written[JsonDefinition::class]);
