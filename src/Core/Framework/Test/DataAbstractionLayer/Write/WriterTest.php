...
class WriterTest extends TestCase
{
    ...
    public function testDeleteWithMultiplePrimaryColumns(): void
    {
        ...
        $context = $this->createWriteContext();
        $this->getWriter()->insert(new ProductDefinition(), [
            [
                'id' => $productId,
        ...
        $deleteResult = $this->getWriter()->delete(new ProductCategoryDefinition(), [
    ...
    public function testRequiresAllPrimaryKeyValuesForDelete(): void
    {
        ...
        $this->getWriter()->delete(new ProductCategoryDefinition(), [
            ['productId' => $productId],
