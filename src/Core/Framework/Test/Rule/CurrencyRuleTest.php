    ...
    public function testValidateWithMissingCurrencyIds()
    {
        try {
            ...
            foreach ($stackException->getExceptions() as $exception) {
                ...
                static::assertStringStartsWith(CurrencyRule::class, $exception->getViolations()->get(0)->getPropertyPath());
                static::assertStringEndsWith(' (currencyIds)', $exception->getViolations()->get(0)->getPropertyPath());
