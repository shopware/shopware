...
class UpdateController extends AbstractController
{
    ...
    #[Route(path: '/api/_action/update/check', name: 'api.custom.updateapi.check', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['system:core:update']], methods: ['GET'])]
    ...
    #[Route(path: '/api/_action/update/check-requirements', name: 'api.custom.update.check_requirements', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['system:core:update']], methods: ['GET'])]
    ...
    #[Route('/api/_action/update/extension-compatibility', name: 'api.custom.updateapi.extension_compatibility', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['system:core:update', 'system_config:read']], methods: ['GET'])]
    ...
    #[Route(path: '/api/_action/update/download-recovery', name: 'api.custom.updateapi.download-recovery', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['system:core:update', 'system_config:read']], methods: ['GET'])]
    ...
    #[Route(path: '/api/_action/update/deactivate-plugins', name: 'api.custom.updateapi.deactivate-plugins', defaults: [PlatformRequest::ATTRIBUTE_ACL => ['system:core:update', 'system_config:read']], methods: ['GET'])]
