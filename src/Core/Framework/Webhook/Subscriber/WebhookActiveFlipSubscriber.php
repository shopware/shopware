 ...
 * @codeCoverageIgnore
 *
 * @see \Shopware\Tests\Integration\Core\Framework\Webhook\Subscriber\WebhookActiveFlipSubscriberTest
 */
#[Package('framework')]
class WebhookActiveFlipSubscriber implements EventSubscriberInterface
{
    ...
    public function onWebhookWritten(EntityWrittenEvent $event): void
    {
        ...
        foreach ($event->getWriteResults() as $writeResult) {
            ...
            $this->healthService->disableByOperator($webhookId, fromAnyState: false);
        }
    }
}
