...
class Migration1536232800StateMachine extends MigrationStep
{
...
SQL;
        ...
        $sql = <<<SQL
            CREATE TABLE `state_machine_translation` (
              ...
              CONSTRAINT `json.state_machine_translation.attributes` CHECK (JSON_VALID(`attributes`))
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL;
...
SQL;
        ...
        $sql = <<<SQL
            CREATE TABLE `state_machine_state_translation` (
              ...
              CONSTRAINT `json.state_machine_state_translation.attributes` CHECK (JSON_VALID(`attributes`))
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL;
    ...
    private function createStateMachineTransitionTable(Connection $connection): void
    {
        $sql = <<<SQL
            CREATE TABLE `state_machine_transition` (
              ...
              CONSTRAINT `json.state_machine_transition.attributes` CHECK (JSON_VALID(`attributes`))
            ) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci
SQL;
        $connection->executeUpdate($sql);
    }
