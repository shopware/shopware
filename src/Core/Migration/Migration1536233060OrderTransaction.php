...
class Migration1536233060OrderTransaction extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        $connection->executeQuery('
            CREATE TABLE `order_transaction` (
              ...
              CONSTRAINT `json.order_transaction.details` CHECK (JSON_VALID (`details`)),
              CONSTRAINT `json.order_transaction.attributes` CHECK (JSON_VALID(`attributes`)),
