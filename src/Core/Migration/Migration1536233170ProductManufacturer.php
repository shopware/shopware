...
class Migration1536233170ProductManufacturer extends MigrationStep
{
    ...
    public function update(Connection $connection): void
    {
        ...
        $connection->executeQuery('
            CREATE TABLE `product_manufacturer_translation` (
              ...
              CONSTRAINT `json.product_manufacturer_translation.attributes` CHECK (JSON_VALID(`attributes`)),
