...
class Migration1536233420BasicData extends MigrationStep
{
    ...
    private function createOrderDeliveryStateMachine(Connection $connection): void
    {
        ...
        // from "shipped" to *
        // $connection->insert('state_machine_transition', ['id' => Uuid::uuid4()->getBytes(), 'state_machine_id' => $stateMachineId, 'action_name' => 'ship', 'from_state_id' => $shippedId, 'to_state_id' => $shippedId, 'created_at' => date(Defaults::DATE_FORMAT)]);$connection->insert('state_machine_transition', ['id' => Uuid::uuid4()->getBytes(), 'state_machine_id' => $stateMachineId, 'action_name' => 'retour', 'from_state_id' => $shippedId, 'to_state_id' => $returnedId, 'created_at' => date(Defaults::DATE_FORMAT)]);
