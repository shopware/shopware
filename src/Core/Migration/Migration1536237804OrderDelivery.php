    ...
    public function update(Connection $connection): void
    {
        $connection->executeQuery('
            CREATE TABLE `order_delivery` (
              ...
              CONSTRAINT `fk.order_delivery.order_state_id` FOREIGN KEY (`order_state_id`) REFERENCES `order_state` (`id`) ON DELETE RESTRICT ON UPDATE CASCADE,
              CONSTRAINT CHECK ( JSON_VALID(`shipping_costs`) )
