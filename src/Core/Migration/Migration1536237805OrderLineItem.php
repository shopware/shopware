    ...
    public function update(Connection $connection): void
    {
        $connection->executeQuery('
            CREATE TABLE `order_line_item` (
              ...
              `unit_price` double GENERATED ALWAYS AS (JSON_UNQUOTE(price->"$.unitPrice")) VIRTUAL,
              `total_price` double GENERATED ALWAYS AS (JSON_UNQUOTE(price->"$.totalPrice")) VIRTUAL,
