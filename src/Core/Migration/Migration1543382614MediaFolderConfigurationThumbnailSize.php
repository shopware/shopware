    ...
    public function update(Connection $connection): void
    {
        $connection->exec('
            CREATE TABLE `media_folder_configuration_thumbnail_size` (
              ...
              `thumbnail_size_id` BINARY(16),
              `created_at` DATETIME(3),
              PRIMARY KEY (`media_folder_configuration_id`, `media_folder_configuration_version_id`, `thumbnail_size_id`),
              ...
              CONSTRAINT `mfc_ts_fk_ts` FOREIGN KEY (`thumbnail_size_id`)
                REFERENCES `thumbnail_size` (`id`) ON DELETE CASCADE
            );
        ');
    }
