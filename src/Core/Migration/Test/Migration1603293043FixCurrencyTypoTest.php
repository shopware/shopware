...
class Migration1603293043FixCurrencyTypoTest extends TestCase
{
    ...
    protected function tearDown(): void
    {
        ...
        $this->setEnLanguageAvailability();
        $this->connection->update('currency_translation', ['short_name' => 'SEK'], ['short_name' => 'SEK_NA']);
        $this->connection->update('currency_translation', ['name' => 'Swedish krone'], ['short_name' => 'SEK', 'language_id' => $this->languageIdEnglish]);
        $this->connection->update('currency_translation', ['Updated_at' => null], ['short_name' => 'SEK', 'language_id' => $this->languageIdEnglish]);
    }
    ...
    {
        if (!$englishAvailable) {
            $this->setEnLanguageAvailability(false);
        } else {
            $this->setEnLanguageAvailability();
        }
        ...
        $this->connection->update('currency_translation', ['name' => 'Swedish krone'], ['short_name' => 'SEK', 'language_id' => $englishLanguageId]);
