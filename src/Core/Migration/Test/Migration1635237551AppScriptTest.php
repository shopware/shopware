...
class Migration1635237551AppScriptTest extends TestCase
{
    use IntegrationTestBehaviour;

    public function testTablesIsPresent(): void
    {
        $appScriptColumns = array_column($this->getContainer()->get(Connection::class)->fetchAllAssociative('SHOW COLUMNS FROM app_script'), 'Field');
