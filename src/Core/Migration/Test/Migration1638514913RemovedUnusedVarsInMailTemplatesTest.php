...
class Migration1638514913RemovedUnusedVarsInMailTemplatesTest extends TestCase
{
    ...
    private function getPasswordChangeTemplates(): array
    {
        return [
            'html' => [
                'en' => (string) file_get_contents(__DIR__ . '/../Fixtures/mails/password_change/en-html.html.twig'),
                'de' => (string) file_get_contents(__DIR__ . '/../Fixtures/mails/password_change/de-html.html.twig'),
            ],
            'plain' => [
                'en' => (string) file_get_contents(__DIR__ . '/../Fixtures/mails/password_change/en-plain.html.twig'),
                'de' => (string) file_get_contents(__DIR__ . '/../Fixtures/mails/password_change/de-plain.html.twig'),
            ],
        ];
    }
}
