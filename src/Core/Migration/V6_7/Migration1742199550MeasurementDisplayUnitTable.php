...
class Migration1742199550MeasurementDisplayUnitTable extends MigrationStep
{
    ...
    private function addDefaultMeasurementUnits(Connection $connection): void
    {
        ...
        $units = [
            ...
            ['id' => Uuid::fromHexToBytes(Uuid::fromStringToHex('metric-mm')), 'measurement_system_id' => $metricId, 'default' => 1, 'type' => 'length', 'short_name' => 'mm', 'factor' => 1, 'precision' => 2, 'name_en' => 'Millimeter', 'name_de' => 'Millimeter'],
            ['id' => Uuid::fromHexToBytes(Uuid::fromStringToHex('metric-kg')), 'measurement_system_id' => $metricId, 'default' => 1, 'type' => 'weight', 'short_name' => 'kg', 'factor' => 1, 'precision' => 2, 'name_en' => 'Kilogram', 'name_de' => 'Kilogramm'],
