...
class Migration1768545319RevocationRequestMailTemplate extends MigrationStep
{
    ...
    public const MAIL_TEMPLATE_TYPE_MERCHANT_TRANSLATIONS = [
        'en_name' => 'Revocation request received',
    ...
    public const MAIL_TEMPLATE_TYPE_CUSTOMER_TRANSLATIONS = [
        'en_name' => 'Revocation request requested',
    ...
    public const MAIL_TEMPLATE_TRANSLATIONS_MERCHANT = [
        'en_subject' => 'Revocation request received',
        'de_subject' => 'Widerrufsantrag erhalten',
        'en_description' => 'Received revocation request from customer',
    ...
    public const MAIL_TEMPLATE_TRANSLATIONS_CUSTOMER = [
        'en_subject' => 'Revocation request sent',
        'de_subject' => 'Widerrufsantrag gesendet',
        'en_description' => 'Confirmation receipt of customers revocation request',
    ...
    public function update(Connection $connection): void
    {
        ...
        $merchantMailStruct = $this->createMailStruct(self::MERCHANT_DIRECTORY, MailTemplateTypes::MAILTYPE_REVOCATION_REQUEST_MERCHANT);
        ...
        $customerMailStruct = $this->createMailStruct(self::CUSTOMER_DIRECTORY, MailTemplateTypes::MAILTYPE_REVOCATION_REQUEST_CUSTOMER);
        $this->createMailTemplate(
            $connection,
