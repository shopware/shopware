 ...
 */
#[Package('inventory')]
class Migration1783944700AddGaranLabelOrderConfirmationConfig extends MigrationStep
{
    ...
    {
        $this->insertConfig($connection, 'core.cart.showGaranLabelInOrderConfirmation');
    }
