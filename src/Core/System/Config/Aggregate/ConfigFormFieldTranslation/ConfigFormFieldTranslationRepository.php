...
use Shopware\Core\System\Config\Aggregate\ConfigFormFieldTranslation\Event\ConfigFormFieldTranslationAggregationResultLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormFieldTranslation\Event\ConfigFormFieldTranslationBasicLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormFieldTranslation\Event\ConfigFormFieldTranslationDetailLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormFieldTranslation\Event\ConfigFormFieldTranslationIdSearchResultLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormFieldTranslation\Event\ConfigFormFieldTranslationSearchResultLoadedEvent;
...
class ConfigFormFieldTranslationRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, Context $context): ConfigFormFieldTranslationSearchResult
    {
    ...
    public function readBasic(array $ids, Context $context): ConfigFormFieldTranslationBasicCollection
    {
    ...
    public function readDetail(array $ids, Context $context): ConfigFormFieldTranslationDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigFormFieldTranslationDefinition::class, $data, WriteContext::createFromContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigFormFieldTranslationDefinition::class, $data, WriteContext::createFromContext($context));
        $event = EntityWrittenContainerEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(EntityWrittenContainerEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigFormFieldTranslationDefinition::class, $data, WriteContext::createFromContext($context));
        $event = EntityWrittenContainerEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(EntityWrittenContainerEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigFormFieldTranslationDefinition::class, $ids, WriteContext::createFromContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigFormFieldTranslationDefinition::class, $id, WriteContext::createFromContext($context), $name, $versionId);
    }
