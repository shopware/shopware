...
use Shopware\Core\System\Config\Aggregate\ConfigFormTranslation\Event\ConfigFormTranslationAggregationResultLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormTranslation\Event\ConfigFormTranslationBasicLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormTranslation\Event\ConfigFormTranslationDetailLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormTranslation\Event\ConfigFormTranslationIdSearchResultLoadedEvent;
use Shopware\Core\System\Config\Aggregate\ConfigFormTranslation\Event\ConfigFormTranslationSearchResultLoadedEvent;
...
class ConfigFormTranslationRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, Context $context): ConfigFormTranslationSearchResult
    {
    ...
    public function readBasic(array $ids, Context $context): ConfigFormTranslationBasicCollection
    {
    ...
    public function readDetail(array $ids, Context $context): ConfigFormTranslationDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigFormTranslationDefinition::class, $data, WriteContext::createFromContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigFormTranslationDefinition::class, $data, WriteContext::createFromContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigFormTranslationDefinition::class, $data, WriteContext::createFromContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigFormTranslationDefinition::class, $ids, WriteContext::createFromContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigFormTranslationDefinition::class, $id, WriteContext::createFromContext($context), $name, $versionId);
    }
