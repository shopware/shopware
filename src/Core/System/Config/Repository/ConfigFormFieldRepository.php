...
use Shopware\System\Config\Event\ConfigFormField\ConfigFormFieldAggregationResultLoadedEvent;
use Shopware\System\Config\Event\ConfigFormField\ConfigFormFieldBasicLoadedEvent;
use Shopware\System\Config\Event\ConfigFormField\ConfigFormFieldDetailLoadedEvent;
use Shopware\System\Config\Event\ConfigFormField\ConfigFormFieldIdSearchResultLoadedEvent;
use Shopware\System\Config\Event\ConfigFormField\ConfigFormFieldSearchResultLoadedEvent;
...
class ConfigFormFieldRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): ConfigFormFieldSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): ConfigFormFieldBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): ConfigFormFieldDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigFormFieldDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigFormFieldDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigFormFieldDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigFormFieldDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigFormFieldDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
