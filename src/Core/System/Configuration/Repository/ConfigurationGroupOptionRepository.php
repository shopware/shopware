...
namespace Shopware\System\Configuration\Repository;
...
use Shopware\System\Configuration\Event\ConfigurationGroupOption\ConfigurationGroupOptionAggregationResultLoadedEvent;
use Shopware\System\Configuration\Event\ConfigurationGroupOption\ConfigurationGroupOptionBasicLoadedEvent;
use Shopware\System\Configuration\Event\ConfigurationGroupOption\ConfigurationGroupOptionDetailLoadedEvent;
use Shopware\System\Configuration\Event\ConfigurationGroupOption\ConfigurationGroupOptionIdSearchResultLoadedEvent;
use Shopware\System\Configuration\Event\ConfigurationGroupOption\ConfigurationGroupOptionSearchResultLoadedEvent;
...
class ConfigurationGroupOptionRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): ConfigurationGroupOptionSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): ConfigurationGroupOptionBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): ConfigurationGroupOptionDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ConfigurationGroupOptionDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ConfigurationGroupOptionDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ConfigurationGroupOptionDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ConfigurationGroupOptionDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(ConfigurationGroupOptionDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
