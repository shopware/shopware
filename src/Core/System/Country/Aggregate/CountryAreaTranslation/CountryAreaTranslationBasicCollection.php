...
use Shopware\Core\System\Country\Aggregate\CountryAreaTranslation\CountryAreaTranslationBasicStruct;

class CountryAreaTranslationBasicCollection extends EntityCollection
{
    /**
     * @var \Shopware\Core\System\Country\Aggregate\CountryAreaTranslation\CountryAreaTranslationBasicStruct[]
     */
    protected $elements = [];
