...
use Shopware\System\Country\Aggregate\CountryTranslation\Event\CountryTranslationAggregationResultLoadedEvent;
use Shopware\System\Country\Aggregate\CountryTranslation\Event\CountryTranslationBasicLoadedEvent;
use Shopware\System\Country\Aggregate\CountryTranslation\Event\CountryTranslationDetailLoadedEvent;
use Shopware\System\Country\Aggregate\CountryTranslation\Event\CountryTranslationIdSearchResultLoadedEvent;
use Shopware\System\Country\Aggregate\CountryTranslation\Event\CountryTranslationSearchResultLoadedEvent;
...
class CountryTranslationRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): CountryTranslationSearchResult
    {
        ...
        $result = CountryTranslationSearchResult::createFromResults($ids, $entities, $aggregations);
    ...
    public function searchIds(Criteria $criteria, ApplicationContext $context): IdSearchResult
    {
        ...
        $event = new CountryTranslationIdSearchResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);

        return $result;
    }

    public function readBasic(array $ids, ApplicationContext $context): CountryTranslationBasicCollection
    {
        /** @var CountryTranslationBasicCollection $entities */
        $entities = $this->reader->readBasic(CountryTranslationDefinition::class, $ids, $context);
    ...
    public function readDetail(array $ids, ApplicationContext $context): CountryTranslationDetailCollection
    {
        /** @var \Shopware\System\Country\Aggregate\CountryTranslation\Collection\CountryTranslationDetailCollection $entities */
        $entities = $this->reader->readDetail(CountryTranslationDefinition::class, $ids, $context);
    ...
    {
        $affected = $this->versionManager->update(CountryTranslationDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(CountryTranslationDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(CountryTranslationDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(CountryTranslationDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(CountryTranslationDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
