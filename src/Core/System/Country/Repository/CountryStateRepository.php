...
use Shopware\System\Country\Event\CountryState\CountryStateAggregationResultLoadedEvent;
use Shopware\System\Country\Event\CountryState\CountryStateBasicLoadedEvent;
use Shopware\System\Country\Event\CountryState\CountryStateDetailLoadedEvent;
use Shopware\System\Country\Event\CountryState\CountryStateIdSearchResultLoadedEvent;
use Shopware\System\Country\Event\CountryState\CountryStateSearchResultLoadedEvent;
...
class CountryStateRepository implements RepositoryInterface
{
    /**
    ...
    public function search(Criteria $criteria, ApplicationContext $context): CountryStateSearchResult
    {
    ...
    {
        $result = $this->aggregator->aggregate(CountryStateDefinition::class, $criteria, $context);

        $event = new CountryStateAggregationResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);
    ...
    public function readBasic(array $ids, ApplicationContext $context): CountryStateBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): CountryStateDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(CountryStateDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(CountryStateDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(CountryStateDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(CountryStateDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(CountryStateDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
