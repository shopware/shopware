...
class IntegrationRoleDefinition extends MappingEntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('acl_role_id', 'roleId', AclRoleDefinition::class))->addFlags(new PrimaryKey(), new Required()),

            new ManyToOneAssociationField('integration', 'integration_id', IntegrationDefinition::class, 'id', false),
            new ManyToOneAssociationField('role', 'role_id', AclRoleDefinition::class, 'id', false),
        ]);
    }
}
