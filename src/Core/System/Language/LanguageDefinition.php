...
class LanguageDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        $fields = new FieldCollection([
            ...
            (new BoolField('translation_auto_update', 'translationAutoUpdate'))->addFlags(new ApiAware())->setDescription('Whether the scheduled task keeps the community translations of this language up to date. Enabled by default; only applied to linked languages.'),
        ...
        if (!Feature::isActive('v6.8.0.0')) {
            $fields->add((new OneToManyAssociationField('importExportProfileTranslations', ImportExportProfileTranslationDefinition::class, 'language_id'))->addFlags(new CascadeDelete()));
        }
