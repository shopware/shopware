...
class ListingFacetRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, Context $context): ListingFacetSearchResult
    {
    ...
    public function readBasic(array $ids, Context $context): ListingFacetBasicCollection
    {
    ...
    public function readDetail(array $ids, Context $context): ListingFacetDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(ListingFacetDefinition::class, $data, WriteContext::createFromContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(ListingFacetDefinition::class, $data, WriteContext::createFromContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(ListingFacetDefinition::class, $data, WriteContext::createFromContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(ListingFacetDefinition::class, $ids, WriteContext::createFromContext($context));
    ...
    {
        return $this->versionManager->createVersion(ListingFacetDefinition::class, $id, WriteContext::createFromContext($context), $name, $versionId);
    }
