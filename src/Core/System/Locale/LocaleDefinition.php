...
class LocaleDefinition extends EntityDefinition
{
    ...
    protected static function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new StringField('code', 'code'))->setFlags(new Required(), new SearchRanking(SearchRanking::MIDDLE_SEARCH_RANKING)),
            ...
            (new TranslationsAssociationField(LocaleTranslationDefinition::class, 'locale_id'))->setFlags(new Required(), new CascadeDelete()),
