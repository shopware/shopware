...
use Shopware\System\Mail\Event\MailAttachment\MailAttachmentAggregationResultLoadedEvent;
use Shopware\System\Mail\Event\MailAttachment\MailAttachmentBasicLoadedEvent;
use Shopware\System\Mail\Event\MailAttachment\MailAttachmentDetailLoadedEvent;
use Shopware\System\Mail\Event\MailAttachment\MailAttachmentIdSearchResultLoadedEvent;
use Shopware\System\Mail\Event\MailAttachment\MailAttachmentSearchResultLoadedEvent;
...
class MailAttachmentRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): MailAttachmentSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): MailAttachmentBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): MailAttachmentDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(MailAttachmentDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(MailAttachmentDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(MailAttachmentDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(MailAttachmentDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(MailAttachmentDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
