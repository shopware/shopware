...
class SalesChannelDomainDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('measurement_system_id', 'measurementSystemId', 'measurement_system.definition'))->addFlags(new ApiAware()),
            (new FkField('weight_unit_id', 'weightUnitId', 'measurement_display_unit.definition'))->addFlags(new ApiAware()),
            (new FkField('length_unit_id', 'lengthUnitId', 'measurement_display_unit.definition'))->addFlags(new ApiAware()),
