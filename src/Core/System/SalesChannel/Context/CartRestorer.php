...
class CartRestorer
{
    ...
    private function updateRequestState(SalesChannelContext $context): void
    {
        ...
        /** @phpstan-ignore shopware.unsafeRequestHasSession (Danger: this guard allows getSession() to initialize the lazy session and take the PHP session lock; cart restoration intentionally synchronizes request session state.) */
