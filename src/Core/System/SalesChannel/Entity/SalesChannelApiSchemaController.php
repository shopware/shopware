...
class SalesChannelApiSchemaController extends AbstractController
{
    ...
    /**
     * @Route("/sales-channel-api/v{version}/_info/entity-schema.json", name="sales-channel-api.info.entity-schema", methods={"GET"})
     */
    public function entitySchema(): JsonResponse
    {
        $data = $this->definitionService->getSchema(EntitySchemaGenerator::FORMAT, DefinitionService::SALES_CHANNEL_API);
