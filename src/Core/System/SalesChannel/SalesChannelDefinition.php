...
class SalesChannelDefinition extends EntityDefinition
{
    ...
    protected function defineFields(): FieldCollection
    {
        return new FieldCollection([
            ...
            (new FkField('default_measurement_system_id', 'measurementSystemId', 'measurement_system.definition'))->addFlags(new ApiAware()),
            (new FkField('default_mass_unit_id', 'massUnitId', 'measurement_display_unit.definition'))->addFlags(new ApiAware()),
            (new FkField('default_length_unit_id', 'lengthUnitId', 'measurement_display_unit.definition'))->addFlags(new ApiAware()),
            ...
            new ManyToOneAssociationField('measurementSystem', 'default_measurement_system_id', 'measurement_system.definition', 'id', false),
            new ManyToOneAssociationField('massUnit', 'default_mass_unit_id', 'measurement_display_unit.definition', 'id', false),
            new ManyToOneAssociationField('lengthUnit', 'default_length_unit_id', 'measurement_display_unit.definition', 'id', false),
        ]);
    }
}
