...
namespace Shopware\System\Tax\Repository;
...
use Shopware\System\Tax\Event\TaxAreaRuleTranslation\TaxAreaRuleTranslationAggregationResultLoadedEvent;
use Shopware\System\Tax\Event\TaxAreaRuleTranslation\TaxAreaRuleTranslationBasicLoadedEvent;
use Shopware\System\Tax\Event\TaxAreaRuleTranslation\TaxAreaRuleTranslationDetailLoadedEvent;
use Shopware\System\Tax\Event\TaxAreaRuleTranslation\TaxAreaRuleTranslationIdSearchResultLoadedEvent;
use Shopware\System\Tax\Event\TaxAreaRuleTranslation\TaxAreaRuleTranslationSearchResultLoadedEvent;
...
class TaxAreaRuleTranslationRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, ApplicationContext $context): TaxAreaRuleTranslationSearchResult
    {
    ...
    public function readBasic(array $ids, ApplicationContext $context): TaxAreaRuleTranslationBasicCollection
    {
    ...
    public function readDetail(array $ids, ApplicationContext $context): TaxAreaRuleTranslationDetailCollection
    {
    ...
    {
        $affected = $this->versionManager->update(TaxAreaRuleTranslationDefinition::class, $data, WriteContext::createFromApplicationContext($context));
    ...
    {
        $affected = $this->versionManager->upsert(TaxAreaRuleTranslationDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->insert(TaxAreaRuleTranslationDefinition::class, $data, WriteContext::createFromApplicationContext($context));
        $event = GenericWrittenEvent::createWithWrittenEvents($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->versionManager->delete(TaxAreaRuleTranslationDefinition::class, $ids, WriteContext::createFromApplicationContext($context));
    ...
    {
        return $this->versionManager->createVersion(TaxAreaRuleTranslationDefinition::class, $id, WriteContext::createFromApplicationContext($context), $name, $versionId);
    }
