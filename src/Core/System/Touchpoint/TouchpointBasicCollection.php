...
class TouchpointBasicCollection extends EntityCollection
{
    ...
    public function getLanguages(): \Shopware\Core\System\Language\LanguageBasicCollection
    {
        return new \Shopware\Core\System\Language\LanguageBasicCollection(
    ...
    {
        return new \Shopware\Core\System\Currency\CurrencyBasicCollection(
            $this->fmap(function (TouchpointBasicStruct $touchpoint) {
