...
class UserRecoveryController extends AbstractController
{
    ...
    /**
     * @Route("/api/v{version}/_action/user/user-recovery", defaults={"authentification_required"=false}, name="api.action.user.user-recovery", methods={"POST"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/user/user-recovery/hash", defaults={"authentification_required"=false}, name="api.action.user.user-recovery.hash", methods={"GET"})
     */
    ...
    /**
     * @Route("/api/v{version}/_action/user/user-recovery/password", defaults={"authentification_required"=false}, name="api.action.user.user-recovery.password", methods={"PATCH"})
     */
