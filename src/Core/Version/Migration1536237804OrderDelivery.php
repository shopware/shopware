    ...
    public function update(Connection $connection): void
    {
        $connection->executeQuery('
            CREATE TABLE `order_delivery` (
              ...
              CONSTRAINT `fk_order_delivery.shipping_order_address_id` FOREIGN KEY (`shipping_order_address_id`, `shipping_order_address_version_id`, `shipping_order_address_tenant_id`) REFERENCES `order_address` (`id`, `version_id`, `tenant_id`) ON DELETE RESTRICT ON UPDATE CASCADE,
