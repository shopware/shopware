...
use Shopware\Country\Event\CountryArea\CountryAreaAggregationResultLoadedEvent;
use Shopware\Country\Event\CountryArea\CountryAreaBasicLoadedEvent;
use Shopware\Country\Event\CountryArea\CountryAreaDetailLoadedEvent;
use Shopware\Country\Event\CountryArea\CountryAreaSearchResultLoadedEvent;
use Shopware\Country\Event\CountryArea\CountryAreaUuidSearchResultLoadedEvent;
...
class CountryAreaRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, TranslationContext $context): CountryAreaSearchResult
    {
        ...
        $result = CountryAreaSearchResult::createFromResults($uuids, $entities, $aggregations);
    ...
    public function searchUuids(Criteria $criteria, TranslationContext $context): UuidSearchResult
    {
        ...
        $event = new CountryAreaUuidSearchResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);

        return $result;
    }

    public function readBasic(array $uuids, TranslationContext $context): CountryAreaBasicCollection
    {
        /** @var CountryAreaBasicCollection $entities */
        $entities = $this->reader->readBasic(CountryAreaDefinition::class, $uuids, $context);
    ...
    public function readDetail(array $uuids, TranslationContext $context): CountryAreaDetailCollection
    {
        /** @var CountryAreaDetailCollection $entities */
        $entities = $this->reader->readDetail(CountryAreaDefinition::class, $uuids, $context);
