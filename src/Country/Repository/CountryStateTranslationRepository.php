...
use Shopware\Country\Event\CountryStateTranslation\CountryStateTranslationAggregationResultLoadedEvent;
use Shopware\Country\Event\CountryStateTranslation\CountryStateTranslationBasicLoadedEvent;
use Shopware\Country\Event\CountryStateTranslation\CountryStateTranslationDetailLoadedEvent;
use Shopware\Country\Event\CountryStateTranslation\CountryStateTranslationSearchResultLoadedEvent;
use Shopware\Country\Event\CountryStateTranslation\CountryStateTranslationUuidSearchResultLoadedEvent;
use Shopware\Country\Struct\CountryStateTranslationSearchResult;
...
class CountryStateTranslationRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(CountryStateTranslationDefinition::class, $data, WriteContext::createFromTranslationContext($context));
    ...
    {
        $affected = $this->writer->upsert(CountryStateTranslationDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(CountryStateTranslationDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
