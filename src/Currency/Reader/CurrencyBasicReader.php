...
class CurrencyBasicReader
{
    ...
    public function __construct(Connection $connection, CurrencyBasicHydrator $hydrator)
    {
    ...
    {
        $query = new CurrencyBasicQuery($this->connection, $context);

        $query->andWhere('currency.uuid IN (:uuids)');
