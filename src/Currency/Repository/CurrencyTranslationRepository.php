...
use Shopware\Currency\Event\CurrencyTranslation\CurrencyTranslationAggregationResultLoadedEvent;
use Shopware\Currency\Event\CurrencyTranslation\CurrencyTranslationBasicLoadedEvent;
use Shopware\Currency\Event\CurrencyTranslation\CurrencyTranslationDetailLoadedEvent;
use Shopware\Currency\Event\CurrencyTranslation\CurrencyTranslationSearchResultLoadedEvent;
use Shopware\Currency\Event\CurrencyTranslation\CurrencyTranslationUuidSearchResultLoadedEvent;
...
class CurrencyTranslationRepository implements RepositoryInterface
{
    ...
    {
        $affected = $this->writer->update(CurrencyTranslationDefinition::class, $data, WriteContext::createFromTranslationContext($context));
    ...
    {
        $affected = $this->writer->upsert(CurrencyTranslationDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(CurrencyTranslationDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
