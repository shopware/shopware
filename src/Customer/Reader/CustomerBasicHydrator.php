...
class CustomerBasicHydrator extends Hydrator
{
    ...
    public function hydrate(array $data): CustomerBasicStruct
    {
        ...
        $customer->setPriceGroupId(
            isset($data['__customer_price_group_id']) ? (int)$data['__customer_price_group_id'] : null
        );
        $customer->setPriceGroupUuid(
            isset($data['__customer_price_group_uuid']) ? (string)$data['__customer_price_group_uuid'] : null
        );
        ...
        $customer->setLockedUntil(
            isset($data['__customer_locked_until']) ? new \DateTime($data['__customer_locked_until']) : null
        );
        $customer->setDefaultBillingAddressId(
            isset($data['__customer_default_billing_address_id']) ? (int)$data['__customer_default_billing_address_id'] : null
        );
        $customer->setDefaultBillingAddressUuid(
            isset($data['__customer_default_billing_address_uuid']) ? (string)$data['__customer_default_billing_address_uuid'] : null
        );
        $customer->setDefaultShippingAddressId(
            isset($data['__customer_default_shipping_address_id']) ? (int)$data['__customer_default_shipping_address_id'] : null
        );
        $customer->setDefaultShippingAddressUuid(
            isset($data['__customer_default_shipping_address_uuid']) ? (string)$data['__customer_default_shipping_address_uuid'] : null
        );
        ...
        $customer->setBirthday(
            isset($data['__customer_birthday']) ? new \DateTime($data['__customer_birthday']) : null
        );
        $customer->setNumber(
            isset($data['__customer_customer_number']) ? (string)$data['__customer_customer_number'] : null
        );
