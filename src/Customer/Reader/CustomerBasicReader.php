...
use Shopware\Customer\Reader\Query\CustomerBasicQuery;
use Shopware\Customer\Struct\CustomerBasicCollection;
use Shopware\Framework\Struct\SortArrayByKeysTrait;

class CustomerBasicReader
{
    ...
    public function __construct(Connection $connection, CustomerBasicHydrator $hydrator)
    {
    ...
    {
        $query = new CustomerBasicQuery($this->connection, $context);
