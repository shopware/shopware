...
namespace Shopware\Customer\Writer;
...
class CustomerResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['lastPaymentMethod'] = new ReferenceField('lastPaymentMethodUuid', 'uuid', \Shopware\PaymentMethod\Writer\PaymentMethodResource::class);
        $this->fields['lastPaymentMethodUuid'] = (new FkField('last_payment_method_uuid', \Shopware\PaymentMethod\Writer\PaymentMethodResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['group'] = new ReferenceField('groupUuid', 'uuid', \Shopware\CustomerGroup\Writer\CustomerGroupResource::class);
        $this->fields['groupUuid'] = (new FkField('customer_group_uuid', \Shopware\CustomerGroup\Writer\CustomerGroupResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['defaultPaymentMethod'] = new ReferenceField('defaultPaymentMethodUuid', 'uuid', \Shopware\PaymentMethod\Writer\PaymentMethodResource::class);
        $this->fields['defaultPaymentMethodUuid'] = (new FkField('default_payment_method_uuid', \Shopware\PaymentMethod\Writer\PaymentMethodResource::class, 'uuid'))->setFlags(new Required());
        ...
        $this->fields['mainShop'] = new ReferenceField('mainShopUuid', 'uuid', \Shopware\Shop\Writer\ShopResource::class);
        $this->fields['mainShopUuid'] = (new FkField('main_shop_uuid', \Shopware\Shop\Writer\ShopResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['priceGroup'] = new ReferenceField('priceGroupUuid', 'uuid', \Shopware\PriceGroup\Writer\PriceGroupResource::class);
        $this->fields['priceGroupUuid'] = (new FkField('price_group_uuid', \Shopware\PriceGroup\Writer\PriceGroupResource::class, 'uuid'));
        $this->fields['defaultBillingAddress'] = new ReferenceField('defaultBillingAddressUuid', 'uuid', \Shopware\CustomerAddress\Writer\CustomerAddressResource::class);
        $this->fields['defaultBillingAddressUuid'] = (new FkField('default_billing_address_uuid', \Shopware\CustomerAddress\Writer\CustomerAddressResource::class, 'uuid'));
        $this->fields['defaultShippingAddress'] = new ReferenceField('defaultShippingAddressUuid', 'uuid', \Shopware\CustomerAddress\Writer\CustomerAddressResource::class);
        $this->fields['defaultShippingAddressUuid'] = (new FkField('default_shipping_address_uuid', \Shopware\CustomerAddress\Writer\CustomerAddressResource::class, 'uuid'));
        $this->fields['addresss'] = new SubresourceField(\Shopware\CustomerAddress\Writer\CustomerAddressResource::class);
