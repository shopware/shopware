...
use Shopware\Search\Facet\CustomerUuidFacet;
use Shopware\Search\FacetResult\ArrayFacetResult;
use Shopware\Search\HandlerInterface;
use Shopware\Search\Sorting\CustomerUuidSorting;

class CustomerUuidHandler implements HandlerInterface, AggregatorInterface
{
    ...
    public function handle(
        ...
        if ($criteriaPart instanceof CustomerUuidSorting) {
            $builder->addOrderBy('customerAddress.customer_uuid', $criteriaPart->getDirection());
    ...
    public function aggregate(
        ...
        $builder->select(['DISTINCT customerAddress.customer_uuid']);
