...
use Shopware\CustomerGroupDiscount\Writer\Resource\CustomerGroupDiscountResource;
...
class CustomerGroupDiscountWriter
{
    ...
    public function update(array $data, TranslationContext $context): CustomerGroupDiscountWrittenEvent
    {
        ...
        foreach ($data as $customerGroupDiscount) {
            try {
                $updated[] = $this->writer->update(
                    CustomerGroupDiscountResource::class,
        ...
        return CustomerGroupDiscountResource::createWrittenEvent($updated, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): CustomerGroupDiscountWrittenEvent
    {
        ...
        return CustomerGroupDiscountResource::createWrittenEvent($created, $errors);
    }
    ...
    private function getExtender(): FieldExtenderCollection
    {
        ...
        $event = $this->eventDispatcher->dispatch(
            CustomerGroupDiscountWriteExtenderEvent::NAME,
            new CustomerGroupDiscountWriteExtenderEvent($extenderCollection)
        );
