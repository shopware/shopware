...
<p class="alert is--warning" Recent information about technical updates and news regarding <a href="https://github.com/shopware/platform">shopware platform</a>
    are now located in the changelog and upgrade file of the respective version in the github repository. For example <a href="https://github.com/shopware/platform/blob/6.1/CHANGELOG-6.0.md">CHANGELOG-6.0.md</a> and 
    <a href="https://github.com/shopware/platform/blob/6.1/UPGRADE-6.1.md">UPGRADE-6.1.md</a>
</p>
