...
return [
    ...
    Shopware\Core\Checkout\Customer\Aggregate\CustomerGroupDiscount\CustomerGroupDiscountDefinition::class => 'Customer group discount',
    ...
    Shopware\Storefront\Framework\Seo\SeoUrlDefinition::class => 'SEO urls',
