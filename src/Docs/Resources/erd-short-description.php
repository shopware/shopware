...
return [
    ...
    Shopware\Core\Framework\Language\LanguageDefinition::class => 'Language',
    ...
    Shopware\Core\Content\DeliveryTime\DeliveryTimeDefinition::class => 'Delivery time',
    ...
    Shopware\Core\Content\DeliveryTime\Aggregate\DeliveryTimeTranslation\DeliveryTimeTranslationDefinition::class => 'Translations',
    ...
    Shopware\Core\Framework\Logging\LogEntryDefinition::class => '__EMPTY__',
    Shopware\Core\Framework\Acl\Resource\AclResourceDefinition::class => '__EMPTY__',
    Shopware\Core\Framework\Acl\Role\AclRoleDefinition::class => '__EMPTY__',
    Shopware\Core\Framework\Acl\Role\AclUserRoleDefinition::class => 'M:N Mapping',
    ...
    Shopware\Core\Framework\Seo\SeoUrl\SeoUrlDefinition::class => '__EMPTY__',
    Shopware\Core\Framework\Seo\SeoUrlTemplate\SeoUrlTemplateDefinition::class => '__EMPTY__',
    Shopware\Core\Framework\Seo\MainCategory\MainCategoryDefinition::class => '__EMPTY__',
