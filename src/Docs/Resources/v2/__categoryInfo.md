            ...
            <div class="row justify--center align--center is--reverse-l">
                ...
                <div class="col col-12 col-l-6">
                    <div class="col-inner"><h3 class="h5 is--uppercase is--subhead">getting started</h3>
                        ...
                        <p>
                            Click <a href="/en/shopware-platform-dev-en/system-guide/requirements">here</a> to learn how to set it up for the first time or take a deep dive into our
        ...
        <div class="section--inner">
            <div class="row justify--center">
                <div class="col col-12 col-l-4">
                    ...
                    <p>
                        Learn about creating shopware 6 plugins.
                    </p>
                ...
                <div class="col col-12 col-l-4">
                    <h2 class="no--margin-top">API guide</h2>
                    <p>
                        Connect your software to Shopware 6.
                    </p>
                    <a href="/en/shopware-platform-dev-en/api-guide" class="btn is--primary is--transparent is--box ct-button">Learn more<i class="icon--arrow-right"></i></a>
                </div>
            </div>
        </div>
    </section>
