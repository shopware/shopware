...
[wikiUrl]: <>(../how-to/reading-entities-via-dal?category=platform-en/how-to)
...
to use the methods from our [data abstraction layer](./data-abstraction-layer.md), in short `DAL`.
...
[Read here](./dal-filter.md) for more information about the DAL filter types and how to use them.
