...
class CampaignsArticlesResource extends ApiResource
{
    public function __construct()
    {
        ...
        $this->fields['articleordernumber'] = new StringField('articleordernumber');
    ...
    {
        return [
            \Shopware\Framework\Api2\Resource\CampaignsArticlesResource::class
        ];
    }
}
