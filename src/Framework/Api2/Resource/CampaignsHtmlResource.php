...
class CampaignsHtmlResource extends ApiResource
{
    public function __construct()
    {
        ...
        $this->fields['alignment'] = (new StringField('alignment'))->setFlags(new Required());
    }
    
    public function getWriteOrder(): array
    {
        return [
            \Shopware\Framework\Api2\Resource\CampaignsHtmlResource::class
        ];
    }
}
