...
class CoreConfigElementsResource extends ApiResource
{
    public function __construct()
    {
        parent::__construct('s_core_config_elements');
        
        $this->fields['formId'] = (new IntField('form_id'))->setFlags(new Required());
        $this->fields['name'] = (new StringField('name'))->setFlags(new Required());
        $this->fields['value'] = new LongTextField('value');
        ...
        $this->fields['scope'] = (new IntField('scope'))->setFlags(new Required());
    }
    
    public function getWriteOrder(): array
    {
        return [
            \Shopware\Framework\Api2\Resource\CoreConfigElementsResource::class
        ];
    }
}
