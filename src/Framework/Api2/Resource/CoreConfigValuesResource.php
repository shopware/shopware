...
class CoreConfigValuesResource extends ApiResource
{
    public function __construct()
    {
        parent::__construct('s_core_config_values');
    ...
    {
        return [
            \Shopware\Framework\Api2\Resource\CoreConfigValuesResource::class
        ];
    }
}
