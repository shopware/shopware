...
class CoreRewriteUrlsResource extends ApiResource
{
    public function __construct()
    {
        parent::__construct('s_core_rewrite_urls');
        
        $this->fields['orgPath'] = (new StringField('org_path'))->setFlags(new Required());
    ...
    {
        return [
            \Shopware\Framework\Api2\Resource\CoreRewriteUrlsResource::class
        ];
    }
}
