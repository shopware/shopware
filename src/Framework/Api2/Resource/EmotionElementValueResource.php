...
class EmotionElementValueResource extends ApiResource
{
    public function __construct()
    {
        ...
        $this->fields['fieldID'] = (new IntField('fieldID'))->setFlags(new Required());
    ...
    {
        return [
            \Shopware\Framework\Api2\Resource\EmotionElementValueResource::class
        ];
    }
}
