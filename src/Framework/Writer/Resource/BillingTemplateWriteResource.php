...
class BillingTemplateWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\BillingTemplateWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\BillingTemplateWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\BillingTemplateWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\BillingTemplateWriteResource::createWrittenEvent($updates, $context));
        }
