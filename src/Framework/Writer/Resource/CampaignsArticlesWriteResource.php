...
class CampaignsArticlesWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): CampaignsArticlesWrittenEvent
    {
        $event = new CampaignsArticlesWrittenEvent($updates[self::class] ?? [], $context, $errors);
