...
class CampaignsContainersWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): CampaignsContainersWrittenEvent
    {
        $event = new CampaignsContainersWrittenEvent($updates[self::class] ?? [], $context, $errors);
