...
class CampaignsLinksWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): CampaignsLinksWrittenEvent
    {
        $event = new CampaignsLinksWrittenEvent($updates[self::class] ?? [], $context, $errors);
