...
class CampaignsLinksWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\CampaignsLinksWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\CampaignsLinksWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\CampaignsLinksWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\CampaignsLinksWriteResource::createWrittenEvent($updates, $context));
        }
