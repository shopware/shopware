...
class CampaignsLogsWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\CampaignsLogsWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\CampaignsLogsWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\CampaignsLogsWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\CampaignsLogsWriteResource::createWrittenEvent($updates, $context));
        }
