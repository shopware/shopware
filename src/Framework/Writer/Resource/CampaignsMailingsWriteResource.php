...
class CampaignsMailingsWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): CampaignsMailingsWrittenEvent
    {
        $event = new CampaignsMailingsWrittenEvent($updates[self::class] ?? [], $context, $errors);
