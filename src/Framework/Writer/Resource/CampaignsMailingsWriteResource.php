...
class CampaignsMailingsWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\CampaignsMailingsWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\CampaignsMailingsWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\CampaignsMailingsWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\CampaignsMailingsWriteResource::createWrittenEvent($updates, $context));
        }
