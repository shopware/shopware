...
class CoreDocumentsWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\CoreDocumentsWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\CoreDocumentsWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\CoreDocumentsWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\CoreDocumentsWriteResource::createWrittenEvent($updates, $context));
        }
