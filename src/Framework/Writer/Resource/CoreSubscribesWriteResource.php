...
class CoreSubscribesWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): CoreSubscribesWrittenEvent
    {
        $event = new CoreSubscribesWrittenEvent($updates[self::class] ?? [], $context, $errors);
