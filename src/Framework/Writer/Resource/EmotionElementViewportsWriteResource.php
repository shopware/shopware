...
class EmotionElementViewportsWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\EmotionElementViewportsWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\EmotionElementViewportsWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\EmotionElementViewportsWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\EmotionElementViewportsWriteResource::createWrittenEvent($updates, $context));
        }
