...
class EmotionTemplatesWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\EmotionTemplatesWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\EmotionTemplatesWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\EmotionTemplatesWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\EmotionTemplatesWriteResource::createWrittenEvent($updates, $context));
        }
