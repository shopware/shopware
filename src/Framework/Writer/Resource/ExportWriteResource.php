...
class ExportWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $rawData = [], array $errors = []): ExportWrittenEvent
    {
        $event = new ExportWrittenEvent($updates[self::class] ?? [], $context, $rawData, $errors);
