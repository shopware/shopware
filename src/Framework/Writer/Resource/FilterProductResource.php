...
class FilterProductResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\Framework\Event\FilterProductWrittenEvent
    {
        $event = new \Shopware\Framework\Event\FilterProductWrittenEvent($updates[self::class] ?? [], $errors);
