...
class ListingFacetResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\Framework\Event\ListingFacetWrittenEvent
    {
        $event = new \Shopware\Framework\Event\ListingFacetWrittenEvent($updates[self::class] ?? [], $errors);
