...
class OrderStateResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['translations'] = (new SubresourceField(\Shopware\Framework\Write\Resource\OrderStateTranslationResource::class, 'languageUuid'))->setFlags(new Required());
    }
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\Framework\Event\OrderStateWrittenEvent
    {
        $event = new \Shopware\Framework\Event\OrderStateWrittenEvent($updates[self::class] ?? [], $errors);
