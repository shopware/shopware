...
class SnippetWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): SnippetWrittenEvent
    {
        $event = new SnippetWrittenEvent($updates[self::class] ?? [], $context, $errors);
