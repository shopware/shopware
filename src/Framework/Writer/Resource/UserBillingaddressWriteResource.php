...
class UserBillingaddressWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\UserBillingaddressWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\UserBillingaddressWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\UserBillingaddressWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\UserBillingaddressWriteResource::createWrittenEvent($updates, $context));
        }
