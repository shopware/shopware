...
class UserShippingaddressWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): UserShippingaddressWrittenEvent
    {
        $event = new UserShippingaddressWrittenEvent($updates[self::class] ?? [], $context, $errors);
