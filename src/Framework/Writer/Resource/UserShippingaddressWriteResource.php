...
class UserShippingaddressWriteResource extends WriteResource
{
    ...
    {
        return [
            \Shopware\Framework\Write\Resource\UserShippingaddressWriteResource::class,
        ];
    }
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\Framework\Event\UserShippingaddressWrittenEvent
    {
        ...
        if (!empty($updates[\Shopware\Framework\Write\Resource\UserShippingaddressWriteResource::class])) {
            $event->addEvent(\Shopware\Framework\Write\Resource\UserShippingaddressWriteResource::createWrittenEvent($updates, $context));
        }
