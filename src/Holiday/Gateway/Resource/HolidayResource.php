...
namespace Shopware\Holiday\Gateway\Resource;
...
class HolidayResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['shippingMethodHolidays'] = new SubresourceField(\Shopware\ShippingMethod\Gateway\Resource\ShippingMethodHolidayResource::class);
    }
    
    public function getWriteOrder(): array
    {
        return [
            \Shopware\Holiday\Gateway\Resource\HolidayResource::class,
