...
use Shopware\Holiday\Reader\Query\HolidayBasicQuery;
...
class HolidayBasicReader
{
    ...
    /**
     * @var HolidayBasicHydrator
     */
    private $hydrator;

    public function __construct(Connection $connection, HolidayBasicHydrator $hydrator)
    {
    ...
    {
        $query = new HolidayBasicQuery($this->connection, $context);

        $query->andWhere('holiday.uuid IN (:uuids)');
