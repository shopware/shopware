...
namespace Shopware\Locale\Definition;
...
use Shopware\Locale\Event\LocaleTranslation\LocaleTranslationWrittenEvent;
use Shopware\Locale\Repository\LocaleTranslationRepository;
use Shopware\Locale\Struct\LocaleTranslationBasicStruct;
...
class LocaleTranslationDefinition extends EntityDefinition
{
    ...
    public static function getFields(): FieldCollection
    {
        ...
        self::$fields = new FieldCollection([
            (new FkField('locale_uuid', 'localeUuid', LocaleDefinition::class))->setFlags(new PrimaryKey(), new Required()),
