...
namespace Shopware\Media\Gateway\Resource;
...
class MediaResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['album'] = new ReferenceField('albumUuid', 'uuid', \Shopware\Album\Gateway\Resource\AlbumResource::class);
        $this->fields['albumUuid'] = (new FkField('album_uuid', \Shopware\Album\Gateway\Resource\AlbumResource::class, 'uuid'))->setFlags(new Required());
