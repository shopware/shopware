...
use Shopware\Media\Reader\Query\MediaBasicQuery;
...
class MediaBasicReader
{
    ...
    /**
     * @var MediaBasicHydrator
     */
    private $hydrator;

    public function __construct(Connection $connection, MediaBasicHydrator $hydrator)
    {
    ...
    {
        $query = new MediaBasicQuery($this->connection, $context);

        $query->andWhere('media.uuid IN (:uuids)');
