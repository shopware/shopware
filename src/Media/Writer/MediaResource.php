...
class MediaResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['categorys'] = new SubresourceField(\Shopware\Category\Writer\CategoryResource::class);
        ...
        $this->fields['album'] = new ReferenceField('albumUuid', 'uuid', \Shopware\Album\Writer\AlbumResource::class);
        $this->fields['albumUuid'] = (new FkField('album_uuid', \Shopware\Album\Writer\AlbumResource::class, 'uuid'))->setFlags(new Required());
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\Album\Writer\AlbumResource::class,
