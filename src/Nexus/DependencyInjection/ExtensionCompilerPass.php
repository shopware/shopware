...
namespace Shopware\Nexus\DependencyInjection;
...
class ExtensionCompilerPass implements CompilerPassInterface
{
    ...
    {
        $this->replaceArgumentWithTaggedServices($container, 'shopware.nexus.extension.registry', 'shopware.nexus.extension', 0);

        $services = $container->findTaggedServiceIds('shopware.nexus.extension');
