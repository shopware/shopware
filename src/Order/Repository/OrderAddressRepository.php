...
use Shopware\Order\Event\OrderAddress\OrderAddressAggregationResultLoadedEvent;
use Shopware\Order\Event\OrderAddress\OrderAddressBasicLoadedEvent;
use Shopware\Order\Event\OrderAddress\OrderAddressDetailLoadedEvent;
use Shopware\Order\Event\OrderAddress\OrderAddressSearchResultLoadedEvent;
use Shopware\Order\Event\OrderAddress\OrderAddressUuidSearchResultLoadedEvent;
...
class OrderAddressRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, TranslationContext $context): OrderAddressSearchResult
    {
        ...
        $result = OrderAddressSearchResult::createFromResults($uuids, $entities, $aggregations);
    ...
    public function searchUuids(Criteria $criteria, TranslationContext $context): UuidSearchResult
    {
        ...
        $event = new OrderAddressUuidSearchResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);
    ...
    public function readBasic(array $uuids, TranslationContext $context): OrderAddressBasicCollection
    {
        ...
        $entities = $this->reader->readBasic(OrderAddressDefinition::class, $uuids, $context);
    ...
    public function readDetail(array $uuids, TranslationContext $context): OrderAddressDetailCollection
    {
        /** @var OrderAddressDetailCollection $entities */
        $entities = $this->reader->readDetail(OrderAddressDefinition::class, $uuids, $context);
