...
class OrderWriter implements WriterInterface
{
    ...
    public function update(array $data, TranslationContext $context): OrderWrittenEvent
    {
        ...
        return OrderWriteResource::createWrittenEvent($updated, $context, $data, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): OrderWrittenEvent
    {
        ...
        return OrderWriteResource::createWrittenEvent($created, $context, $data, $errors);
    }
    ...
    private function getExtender(): FieldExtenderCollection
    {
        ...
        $event = new OrderWriteExtenderEvent($extenderCollection);
        $this->eventDispatcher->dispatch(OrderWriteExtenderEvent::NAME, $event);
