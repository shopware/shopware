...
namespace Shopware\OrderDeliveryPosition\Writer;
...
use Shopware\OrderDeliveryPosition\Event\OrderDeliveryPositionWriteExtenderEvent;
...
class OrderDeliveryPositionWriter implements WriterInterface
{
    /**
     * @var DefaultExtender
     */
    ...
    public function update(array $data, TranslationContext $context): OrderDeliveryPositionWrittenEvent
    {
        ...
        foreach ($data as $orderDeliveryPosition) {
            try {
        ...
        return OrderDeliveryPositionWriteResource::createWrittenEvent($updated, $context, $data, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): OrderDeliveryPositionWrittenEvent
    {
        ...
        return OrderDeliveryPositionWriteResource::createWrittenEvent($created, $context, $data, $errors);
    }
