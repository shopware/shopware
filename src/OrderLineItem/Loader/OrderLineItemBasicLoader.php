...
namespace Shopware\OrderLineItem\Loader;
...
class OrderLineItemBasicLoader
{
    ...
    public function load(array $uuids, TranslationContext $context): OrderLineItemBasicCollection
    {
        if (empty($uuids)) {
