...
class OrderLineItemWriter implements WriterInterface
{
    /**
     * @var DefaultExtender
     */
    ...
    public function update(array $data, TranslationContext $context): OrderLineItemWrittenEvent
    {
        ...
        return OrderLineItemWriteResource::createWrittenEvent($updated, $context, $data, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): OrderLineItemWrittenEvent
    {
        ...
        return OrderLineItemWriteResource::createWrittenEvent($created, $context, $data, $errors);
    }
