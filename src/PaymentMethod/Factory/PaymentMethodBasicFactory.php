...
class PaymentMethodBasicFactory extends Factory
{
    ...
    public function hydrate(
        ...
        $paymentMethod->setPercentageSurcharge(isset($data[$selection->getField('percentageSurcharge')]) ? (float) $data[$selection->getField('percentageSurcharge')] : null);
        $paymentMethod->setAbsoluteSurcharge(isset($data[$selection->getField('absoluteSurcharge')]) ? (float) $data[$selection->getField('absoluteSurcharge')] : null);
        $paymentMethod->setSurchargeString(isset($data[$selection->getField('surchargeString')]) ? (string) $data[$selection->getField('surchargeString')] : null);
        ...
        $paymentMethod->setUsedIframe(isset($data[$selection->getField('usedIframe')]) ? (string) $data[$selection->getField('usedIframe')] : null);
        ...
        $paymentMethod->setPluginUuid(isset($data[$selection->getField('pluginUuid')]) ? (string) $data[$selection->getField('pluginUuid')] : null);
        ...
        $paymentMethod->setRiskRules(isset($data[$selection->getField('riskRules')]) ? (string) $data[$selection->getField('riskRules')] : null);
        $paymentMethod->setCreatedAt(isset($data[$selection->getField('createdAt')]) ? new \DateTime($data[$selection->getField('createdAt')]) : null);
        $paymentMethod->setUpdatedAt(isset($data[$selection->getField('updatedAt')]) ? new \DateTime($data[$selection->getField('updatedAt')]) : null);
