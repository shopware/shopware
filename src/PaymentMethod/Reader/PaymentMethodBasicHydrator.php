...
class PaymentMethodBasicHydrator extends Hydrator
{
    ...
    public function hydrate(array $data): PaymentMethodBasicStruct
    {
        ...
        $paymentMethod->setAction(isset($data['__paymentMethod_action']) ? (string) $data['__paymentMethod_action'] : null);
        $paymentMethod->setPluginId(isset($data['__paymentMethod_plugin_id']) ? (int) $data['__paymentMethod_plugin_id'] : null);
        $paymentMethod->setPluginUuid(isset($data['__paymentMethod_plugin_uuid']) ? (string) $data['__paymentMethod_plugin_uuid'] : null);
        ...
        $paymentMethod->setRiskRules(isset($data['__paymentMethod_risk_rules']) ? (string) $data['__paymentMethod_risk_rules'] : null);
