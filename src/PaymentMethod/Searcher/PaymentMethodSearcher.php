...
class PaymentMethodSearcher extends Search
{
    /**
    ...
    public function __construct(Connection $connection, array $handlers, PaymentMethodBasicHydrator $hydrator)
    {
    ...
    {
        return new PaymentMethodBasicQuery($this->connection, $context);
    }
    ...
    protected function createResult(array $rows, int $total, TranslationContext $context): SearchResultInterface
    {
        ...
        return new PaymentMethodSearchResult($structs, $total);
    }
}
