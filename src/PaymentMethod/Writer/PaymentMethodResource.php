...
class PaymentMethodResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['countrys'] = new SubresourceField(\Shopware\PaymentMethod\Writer\PaymentMethodCountryResource::class);
        $this->fields['shops'] = new SubresourceField(\Shopware\PaymentMethod\Writer\PaymentMethodShopResource::class);
        $this->fields['shippingMethodPaymentMethods'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodPaymentMethodResource::class);
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\ShippingMethod\Writer\ShippingMethodPaymentMethodResource::class,
