...
class PriceGroupBasicReader
{
    ...
    public function __construct(Connection $connection, PriceGroupBasicHydrator $hydrator)
    {
    ...
    {
        $query = new PriceGroupBasicQuery($this->connection, $context);

        $query->andWhere('priceGroup.uuid IN (:uuids)');
