...
class PriceGroupWriteResource extends WriteResource
{
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): PriceGroupWrittenEvent
    {
        $event = new PriceGroupWrittenEvent($updates[self::class] ?? [], $context, $errors);
