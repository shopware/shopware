...
use Shopware\PriceGroupDiscount\Reader\PriceGroupDiscountBasicHydrator;
...
class PriceGroupDiscountSearcher extends Search
{
    /**
    ...
    public function __construct(Connection $connection, array $handlers, PriceGroupDiscountBasicHydrator $hydrator)
    {
    ...
    {
        return new PriceGroupDiscountBasicQuery($this->connection, $context);
    }
    ...
    protected function createResult(array $rows, int $total, TranslationContext $context): SearchResultInterface
    {
        ...
        return new PriceGroupDiscountSearchResult($structs, $total);
    }
}
