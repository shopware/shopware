...
class PriceGroupDiscountResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['priceGroup'] = new ReferenceField('priceGroupUuid', 'uuid', \Shopware\PriceGroup\Writer\PriceGroupResource::class);
        $this->fields['priceGroupUuid'] = (new FkField('price_group_uuid', \Shopware\PriceGroup\Writer\PriceGroupResource::class, 'uuid'))->setFlags(new Required());
    ...
    {
        return [
            \Shopware\PriceGroup\Writer\PriceGroupResource::class,
