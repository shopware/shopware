...
class ExtensionCompilerPass implements CompilerPassInterface
{
    ...
    {
        $this->replaceArgumentWithTaggedServices($container, 'shopware.product.factory', 'shopware.product.extension', 1);

        $services = $container->findTaggedServiceIds('shopware.product.extension');
