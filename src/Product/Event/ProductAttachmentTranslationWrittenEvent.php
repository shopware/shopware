...
class ProductAttachmentTranslationWrittenEvent extends NestedEvent
{
     ...
     * @var string[]
     */
    protected $productAttachmentTranslationUuids;
    ...
    public function __construct(array $productAttachmentTranslationUuids, TranslationContext $context, array $errors = [])
    {
