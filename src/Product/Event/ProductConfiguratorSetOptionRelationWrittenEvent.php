...
class ProductConfiguratorSetOptionRelationWrittenEvent extends NestedEvent
{
     ...
     * @var string[]
     */
    protected $productConfiguratorSetOptionRelationUuids;
    ...
    public function __construct(array $productConfiguratorSetOptionRelationUuids, TranslationContext $context, array $errors = [])
    {
