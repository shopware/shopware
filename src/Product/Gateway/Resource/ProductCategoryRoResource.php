...
class ProductCategoryRoResource extends ApiResource
{
    public function __construct()
    {
        parent::__construct('product_category_ro');
        ...
        $this->fields['parentCategoryId'] = (new IntField('parent_category_id'))->setFlags(new Required());
        ...
        $this->fields['parentCategory'] = new ReferenceField('parentCategoryUuid', 'uuid', \Shopware\Category\Gateway\Resource\CategoryResource::class);
        $this->fields['parentCategoryUuid'] = (new FkField('parent_category_uuid', \Shopware\Category\Gateway\Resource\CategoryResource::class, 'uuid'))->setFlags(new Required());
    }
