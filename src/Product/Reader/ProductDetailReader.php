...
use Shopware\Product\Reader\Query\ProductDetailQuery;
...
class ProductDetailReader
{
    ...
    /**
     * @var ProductDetailHydrator
     */
    private $hydrator;

    public function __construct(Connection $connection, ProductDetailHydrator $hydrator)
    {
        $this->connection = $connection;
        $this->hydrator = $hydrator;
    }

    public function read(array $uuids, TranslationContext $context): ProductDetailCollection
    {
        $query = new ProductDetailQuery($this->connection, $context);
