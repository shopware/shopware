...
class ProductEsdSerialResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['productEsd'] = new ReferenceField('productEsdUuid', 'uuid', \Shopware\Product\Writer\ProductEsdResource::class);
        $this->fields['productEsdUuid'] = (new FkField('product_esd_uuid', \Shopware\Product\Writer\ProductEsdResource::class, 'uuid'))->setFlags(new Required());
    }
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\Product\Writer\ProductEsdSerialResource::class
        ];
    }
}
