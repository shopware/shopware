...
class ProductMediaResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['productDetailUuid'] = (new FkField('product_detail_uuid', \Shopware\ProductDetail\Writer\ProductDetailResource::class, 'uuid'));
        $this->fields['mappings'] = new SubresourceField(\Shopware\Product\Writer\ProductMediaMappingResource::class);
    }
