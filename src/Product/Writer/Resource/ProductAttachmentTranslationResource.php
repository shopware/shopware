...
class ProductAttachmentTranslationResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\Product\Event\ProductAttachmentTranslationWrittenEvent
    {
        $event = new \Shopware\Product\Event\ProductAttachmentTranslationWrittenEvent($updates[self::class] ?? [], $errors);
