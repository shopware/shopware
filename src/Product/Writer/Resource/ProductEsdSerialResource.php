...
class ProductEsdSerialResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\Product\Event\ProductEsdSerialWrittenEvent
    {
        $event = new \Shopware\Product\Event\ProductEsdSerialWrittenEvent($updates[self::class] ?? [], $errors);
