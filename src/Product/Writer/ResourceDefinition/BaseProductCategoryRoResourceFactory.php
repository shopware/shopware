...
class BaseProductCategoryRoResourceFactory extends ApiFieldFactory
{
    ...
    {
        return 'product_category_ro';    
    }
    
    public function getResourceName(): string
    {
        return 'ProductCategoryRo';    
    }
    ...
    protected function build(FieldBuilder $builder): FieldBuilder
    {
        ...
        ->add('parentCategoryId')
            ->setWritable('parent_category_id')
            ->fromTemplate(IntType::class)
            ->setRequired()
        ->add('parentCategoryUuid')
            ->setWritable('parent_category_uuid')
            ->fromTemplate(TextType::class)
            ->setRequired()
            ->setForeignKey('Category.uuid')
        ->add('category')
        ...
        ->add('parentCategory')
            ->setVirtual('parentCategoryUuid', 'Category')
        ->add('product')
