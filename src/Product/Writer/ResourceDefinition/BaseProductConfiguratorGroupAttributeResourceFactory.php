...
class BaseProductConfiguratorGroupAttributeResourceFactory extends ApiFieldFactory
{
    ...
    {
        return 'product_configurator_group_attribute';    
    }
    
    public function getResourceName(): string
    {
        return 'ProductConfiguratorGroupAttribute';    
    }
    ...
    protected function build(FieldBuilder $builder): FieldBuilder
    {
        ...
        ->add('groupId')
            ...
            ->setRequired()
            ->setForeignKey('ProductConfiguratorGroup.id')
        ->add('gro')
            ->setVirtual('groUuid', 'ProductConfiguratorGroup');
    }
}
