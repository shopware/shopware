...
class BaseProductConfiguratorOptionAttributeResourceFactory extends ApiFieldFactory
{
    ...
    {
        return 'product_configurator_option_attribute';    
    }
    
    public function getResourceName(): string
    {
        return 'ProductConfiguratorOptionAttribute';    
    }
    ...
    protected function build(FieldBuilder $builder): FieldBuilder
    {
        return $builder
            ...
            ->setRequired()
        ->add('optionID')
            ->setWritable('optionID')
            ->fromTemplate(IntType::class)
            ->setRequired()
            ->setForeignKey('ProductConfiguratorOption.id')
        ->add('opt')
            ->setVirtual('optUuid', 'ProductConfiguratorOption');
    }
}
