...
class BaseProductConfiguratorTemplatePriceAttributeResourceFactory extends ApiFieldFactory
{
    ...
    {
        return 'product_configurator_template_price_attribute';    
    }
    
    public function getResourceName(): string
    {
        return 'ProductConfiguratorTemplatePriceAttribute';    
    }
    ...
    protected function build(FieldBuilder $builder): FieldBuilder
    {
        return $builder
            ...
            ->setRequired()
        ->add('templatePriceId')
            ->setWritable('template_price_id')
            ->fromTemplate(IntType::class)
            ->setForeignKey('ProductConfiguratorTemplatePrice.id')
        ->add('templatePri')
            ->setVirtual('templatePriUuid', 'ProductConfiguratorTemplatePrice');
    }
}
