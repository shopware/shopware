...
namespace Shopware\ProductDetailPrice\Loader;
...
class ProductDetailPriceBasicLoader
{
    ...
    public function load(array $uuids, TranslationContext $context): ProductDetailPriceBasicCollection
    {
        if (empty($uuids)) {
