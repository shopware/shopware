...
class ProductManufacturerBasicReader
{
    ...
    public function __construct(Connection $connection, ProductManufacturerBasicHydrator $hydrator)
    {
    ...
    {
        $query = new ProductManufacturerBasicQuery($this->connection, $context);

        $query->andWhere('productManufacturer.uuid IN (:uuids)');
