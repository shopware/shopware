...
class ProductManufacturerResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\ProductManufacturer\Event\ProductManufacturerWrittenEvent
    {
        $event = new \Shopware\ProductManufacturer\Event\ProductManufacturerWrittenEvent($updates[self::class] ?? [], $errors);
