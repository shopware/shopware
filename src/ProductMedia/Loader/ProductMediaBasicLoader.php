...
namespace Shopware\ProductMedia\Loader;
...
class ProductMediaBasicLoader
{
    ...
    public function load(array $uuids, TranslationContext $context): ProductMediaBasicCollection
    {
        if (empty($uuids)) {
