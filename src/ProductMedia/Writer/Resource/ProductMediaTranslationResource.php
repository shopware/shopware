...
class ProductMediaTranslationResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->primaryKeyFields['productMediaUuid'] = (new FkField('product_media_uuid', \Shopware\ProductMedia\Writer\Resource\ProductMediaResource::class, 'uuid'))->setFlags(new Required());
    ...
    public static function createWrittenEvent(array $updates, TranslationContext $context, array $errors = []): \Shopware\ProductMedia\Event\ProductMediaTranslationWrittenEvent
    {
        $event = new \Shopware\ProductMedia\Event\ProductMediaTranslationWrittenEvent($updates[self::class] ?? [], $context, $errors);
