...
namespace Shopware\ProductPrice\Gateway\Resource;
...
class ProductPriceResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['productDetailUuid'] = (new FkField('product_detail_uuid', \Shopware\ProductDetail\Gateway\Resource\ProductDetailResource::class, 'uuid'))->setFlags(new Required());
    }
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\ProductPrice\Gateway\Resource\ProductPriceResource::class
        ];
    }
}
