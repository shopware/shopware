...
class ProductPriceBasicReader
{
    ...
    public function __construct(Connection $connection, ProductPriceBasicHydrator $hydrator)
    {
    ...
    {
        $query = new ProductPriceBasicQuery($this->connection, $context);

        $query->andWhere('productPrice.uuid IN (:uuids)');
