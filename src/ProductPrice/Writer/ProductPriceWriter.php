...
use Shopware\ProductPrice\Writer\Resource\ProductPriceResource;
...
class ProductPriceWriter
{
    ...
    public function update(array $data, TranslationContext $context): ProductPriceWrittenEvent
    {
        ...
        return ProductPriceResource::createWrittenEvent($updated, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): ProductPriceWrittenEvent
    {
        ...
        return ProductPriceResource::createWrittenEvent($created, $errors);
    }
    ...
    private function getExtender(): FieldExtenderCollection
    {
        ...
        $event = $this->eventDispatcher->dispatch(
            ProductPriceWriteExtenderEvent::NAME,
            new ProductPriceWriteExtenderEvent($extenderCollection)
        );
