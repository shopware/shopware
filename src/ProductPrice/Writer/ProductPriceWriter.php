...
use Shopware\ProductPrice\Event\ProductPriceWriteExtenderEvent;
...
class ProductPriceWriter implements WriterInterface
{
    /**
     * @var DefaultExtender
     */
    ...
    public function update(array $data, TranslationContext $context): ProductPriceWrittenEvent
    {
        ...
        return ProductPriceWriteResource::createWrittenEvent($updated, $context, $data, $errors);
    }
    ...
    public function upsert(array $data, TranslationContext $context): ProductPriceWrittenEvent
    {
        ...
        return ProductPriceWriteResource::createWrittenEvent($created, $context, $data, $errors);
    }
    ...
    private function getExtender(): FieldExtenderCollection
    {
        ...
        $event = new ProductPriceWriteExtenderEvent($extenderCollection);
        $this->eventDispatcher->dispatch(ProductPriceWriteExtenderEvent::NAME, $event);
