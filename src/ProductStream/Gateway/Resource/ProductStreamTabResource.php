...
class ProductStreamTabResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['productStream'] = new ReferenceField('productStreamUuid', 'uuid', \Shopware\ProductStream\Gateway\Resource\ProductStreamResource::class);
        $this->fields['productStreamUuid'] = (new FkField('product_stream_uuid', \Shopware\ProductStream\Gateway\Resource\ProductStreamResource::class, 'uuid'))->setFlags(new Required());
