...
use Shopware\ProductStream\Reader\Query\ProductStreamBasicQuery;
use Shopware\ProductStream\Struct\ProductStreamBasicCollection;

class ProductStreamBasicReader
{
    ...
    /**
     * @var ProductStreamBasicHydrator
     */
    private $hydrator;

    public function __construct(Connection $connection, ProductStreamBasicHydrator $hydrator)
    {
    ...
    {
        $query = new ProductStreamBasicQuery($this->connection, $context);

        $query->andWhere('productStream.uuid IN (:uuids)');
