...
class ProductStreamAssignmentResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\ProductStream\Event\ProductStreamAssignmentWrittenEvent
    {
        $event = new \Shopware\ProductStream\Event\ProductStreamAssignmentWrittenEvent($updates[self::class] ?? [], $errors);
