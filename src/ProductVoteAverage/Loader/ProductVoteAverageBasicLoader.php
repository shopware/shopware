...
namespace Shopware\ProductVoteAverage\Loader;
...
class ProductVoteAverageBasicLoader
{
    ...
    public function load(array $uuids, TranslationContext $context): ProductVoteAverageBasicCollection
    {
        if (empty($uuids)) {
