...
$album = new \Shopware\Api\Media\Struct\MediaAlbumBasicStruct();
$album->setId($albumId);
...
$media1 = new \Shopware\Api\Media\Struct\MediaBasicStruct();
...
$media1->addExtension('thumbnails', $thumbnailCollection);
...
$thumbnail = new \Shopware\Media\Struct\ThumbnailStruct();
$thumbnail->setUrl('http://shopware.next/media/63/4d/5a/Jasmine-Lotus-Cover_original.jpg');
$thumbnail->setFileName('Jasmine-Lotus-Cover_original.jpg');
$thumbnail->setHeight(800);
$thumbnail->setWidth(600);
$thumbnail->setHighDpi(true);

$thumbnailCollection = new \Shopware\Framework\Struct\StructCollection([$thumbnail]);
$media2->addExtension('thumbnails', $thumbnailCollection);
