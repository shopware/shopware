...
class SeoUrlBasicReader
{
    ...
    public function __construct(Connection $connection, SeoUrlBasicHydrator $hydrator)
    {
    ...
    {
        $query = new SeoUrlBasicQuery($this->connection, $context);

        $query->andWhere('seoUrl.uuid IN (:uuids)');
