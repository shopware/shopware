...
class SeoUrlSearcher extends Search
{
    ...
    public function __construct(Connection $connection, array $handlers, SeoUrlBasicHydrator $hydrator)
    {
    ...
    {
        return new SeoUrlBasicQuery($this->connection, $context);
    }
    ...
    protected function createResult(array $rows, int $total, TranslationContext $context): SearchResultInterface
    {
        ...
        return new SeoUrlSearchResult($structs, $total);
    }
}
