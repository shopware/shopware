...
use Shopware\Shipping\Event\ShippingMethod\ShippingMethodAggregationResultLoadedEvent;
use Shopware\Shipping\Event\ShippingMethod\ShippingMethodBasicLoadedEvent;
use Shopware\Shipping\Event\ShippingMethod\ShippingMethodDetailLoadedEvent;
use Shopware\Shipping\Event\ShippingMethod\ShippingMethodSearchResultLoadedEvent;
use Shopware\Shipping\Event\ShippingMethod\ShippingMethodUuidSearchResultLoadedEvent;
...
class ShippingMethodRepository implements RepositoryInterface
{
    ...
    public function search(Criteria $criteria, TranslationContext $context): ShippingMethodSearchResult
    {
        ...
        $result = ShippingMethodSearchResult::createFromResults($uuids, $entities, $aggregations);
    ...
    public function searchUuids(Criteria $criteria, TranslationContext $context): UuidSearchResult
    {
        ...
        $event = new ShippingMethodUuidSearchResultLoadedEvent($result);
        $this->eventDispatcher->dispatch($event->getName(), $event);
    ...
    public function readBasic(array $uuids, TranslationContext $context): ShippingMethodBasicCollection
    {
        ...
        $entities = $this->reader->readBasic(ShippingMethodDefinition::class, $uuids, $context);
    ...
    public function readDetail(array $uuids, TranslationContext $context): ShippingMethodDetailCollection
    {
        ...
        $entities = $this->reader->readDetail(ShippingMethodDefinition::class, $uuids, $context);
    ...
    {
        $affected = $this->writer->update(ShippingMethodDefinition::class, $data, WriteContext::createFromTranslationContext($context));
    ...
    {
        $affected = $this->writer->upsert(ShippingMethodDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
    ...
    {
        $affected = $this->writer->insert(ShippingMethodDefinition::class, $data, WriteContext::createFromTranslationContext($context));
        $event = GenericWrittenEvent::createFromWriterResult($affected, $context, []);
        $this->eventDispatcher->dispatch(GenericWrittenEvent::NAME, $event);
