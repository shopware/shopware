...
class ShippingMethodHolidayResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['holiday'] = new ReferenceField('holidayUuid', 'uuid', \Shopware\Holiday\Gateway\Resource\HolidayResource::class);
        $this->fields['holidayUuid'] = (new FkField('holiday_uuid', \Shopware\Holiday\Gateway\Resource\HolidayResource::class, 'uuid'))->setFlags(new Required());
    }
