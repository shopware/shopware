...
class ShippingMethodSearcher extends Search
{
    /**
    ...
    public function __construct(Connection $connection, array $handlers, ShippingMethodBasicHydrator $hydrator)
    {
    ...
    {
        return new ShippingMethodBasicQuery($this->connection, $context);
    }
    ...
    protected function createResult(array $rows, int $total, TranslationContext $context): SearchResultInterface
    {
        ...
        return new ShippingMethodSearchResult($structs, $total);
    }
}
