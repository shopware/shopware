...
class ShippingMethodResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['customerGroupUuid'] = (new FkField('customer_group_uuid', \Shopware\CustomerGroup\Writer\CustomerGroupResource::class, 'uuid'));
        $this->fields['categorys'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodCategoryResource::class);
        $this->fields['countrys'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodCountryResource::class);
        $this->fields['holidays'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodHolidayResource::class);
        $this->fields['paymentMethods'] = new SubresourceField(\Shopware\ShippingMethod\Writer\ShippingMethodPaymentMethodResource::class);
        $this->fields['prices'] = new SubresourceField(\Shopware\ShippingMethodPrice\Writer\ShippingMethodPriceResource::class);
