...
class ShippingMethodPriceBasicReader
{
    ...
    public function __construct(Connection $connection, ShippingMethodPriceBasicHydrator $hydrator)
    {
    ...
    {
        $query = new ShippingMethodPriceBasicQuery($this->connection, $context);

        $query->andWhere('shippingMethodPrice.uuid IN (:uuids)');
