...
class ShopPageGroupMappingResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['shopPageGroup'] = new ReferenceField('shopPageGroupUuid', 'uuid', \Shopware\Shop\Gateway\Resource\ShopPageGroupResource::class);
        $this->fields['shopPageGroupUuid'] = (new FkField('shop_page_group_uuid', \Shopware\Shop\Gateway\Resource\ShopPageGroupResource::class, 'uuid'))->setFlags(new Required());
    }
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\Shop\Gateway\Resource\ShopPageGroupResource::class,
            \Shopware\Shop\Gateway\Resource\ShopPageGroupMappingResource::class
        ];
    }
}
