...
class ShopPageResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['parent'] = new ReferenceField('parentUuid', 'uuid', \Shopware\Shop\Gateway\Resource\ShopPageResource::class);
        $this->fields['parentUuid'] = (new FkField('parent_uuid', \Shopware\Shop\Gateway\Resource\ShopPageResource::class, 'uuid'));
        $this->fields['s'] = new SubresourceField(\Shopware\Shop\Gateway\Resource\ShopPageResource::class);
    }
    
    public function getWriteOrder(): array
    {
        return [
            \Shopware\Shop\Gateway\Resource\ShopPageResource::class
        ];
    }
}
