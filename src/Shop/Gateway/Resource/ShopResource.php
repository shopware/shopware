...
class ShopResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['paymentMethodShops'] = new SubresourceField(\Shopware\PaymentMethod\Gateway\Resource\PaymentMethodShopResource::class);
        ...
        $this->fields['productVotes'] = new SubresourceField(\Shopware\Product\Gateway\Resource\ProductVoteResource::class);
        $this->fields['shippingMethods'] = new SubresourceField(\Shopware\ShippingMethod\Gateway\Resource\ShippingMethodResource::class);
        $this->fields['parent'] = new ReferenceField('parentUuid', 'uuid', \Shopware\Shop\Gateway\Resource\ShopResource::class);
        $this->fields['parentUuid'] = (new FkField('parent_uuid', \Shopware\Shop\Gateway\Resource\ShopResource::class, 'uuid'));
        $this->fields['template'] = new ReferenceField('templateUuid', 'uuid', \Shopware\ShopTemplate\Gateway\Resource\ShopTemplateResource::class);
        $this->fields['templateUuid'] = (new FkField('shop_template_uuid', \Shopware\ShopTemplate\Gateway\Resource\ShopTemplateResource::class, 'uuid'));
        $this->fields['documentTemplate'] = new ReferenceField('documentTemplateUuid', 'uuid', \Shopware\ShopTemplate\Gateway\Resource\ShopTemplateResource::class);
        $this->fields['documentTemplateUuid'] = (new FkField('document_template_uuid', \Shopware\ShopTemplate\Gateway\Resource\ShopTemplateResource::class, 'uuid'));
        ...
        $this->fields['currency'] = new ReferenceField('currencyUuid', 'uuid', \Shopware\Currency\Gateway\Resource\CurrencyResource::class);
        $this->fields['currencyUuid'] = (new FkField('currency_uuid', \Shopware\Currency\Gateway\Resource\CurrencyResource::class, 'uuid'))->setFlags(new Required());
        ...
        $this->fields['fallbackLocale'] = new ReferenceField('fallbackLocaleUuid', 'uuid', \Shopware\Locale\Gateway\Resource\LocaleResource::class);
        $this->fields['fallbackLocaleUuid'] = (new FkField('fallback_locale_uuid', \Shopware\Locale\Gateway\Resource\LocaleResource::class, 'uuid'));
        ...
        $this->fields['s'] = new SubresourceField(\Shopware\Shop\Gateway\Resource\ShopResource::class);
        $this->fields['currencys'] = new SubresourceField(\Shopware\Shop\Gateway\Resource\ShopCurrencyResource::class);
        $this->fields['pageGroupMappings'] = new SubresourceField(\Shopware\Shop\Gateway\Resource\ShopPageGroupMappingResource::class);
        $this->fields['templateConfigFormFieldValues'] = new SubresourceField(\Shopware\ShopTemplate\Gateway\Resource\ShopTemplateConfigFormFieldValueResource::class);
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\Currency\Gateway\Resource\CurrencyResource::class,
            ...
            \Shopware\Shop\Gateway\Resource\ShopCurrencyResource::class,
