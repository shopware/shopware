...
use Shopware\Shop\Reader\ShopBasicHydrator;
...
class ShopSearcher extends Search
{
    ...
    public function __construct(Connection $connection, array $handlers, ShopBasicHydrator $hydrator)
    {
    ...
    {
        return new ShopBasicQuery($this->connection, $context);
    }
