...
class ShopFormResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields[self::EMAIL_TEMPLATE_FIELD] = new TranslatedField('emailTemplate', \Shopware\Shop\Writer\Resource\ShopResource::class, 'uuid');
        $this->fields[self::EMAIL_SUBJECT_FIELD] = new TranslatedField('emailSubject', \Shopware\Shop\Writer\Resource\ShopResource::class, 'uuid');
        $this->fields[self::TEXT2_FIELD] = new TranslatedField('text2', \Shopware\Shop\Writer\Resource\ShopResource::class, 'uuid');
        ...
        $this->fields['translations'] = (new SubresourceField(\Shopware\Shop\Writer\Resource\ShopFormTranslationResource::class, 'languageUuid'))->setFlags(new Required());
        $this->fields['fields'] = new SubresourceField(\Shopware\Shop\Writer\Resource\ShopFormFieldResource::class);
    }
