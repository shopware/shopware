...
class ShopResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['productVotes'] = new SubresourceField(\Shopware\Product\Writer\Resource\ProductVoteResource::class);
        ...
        $this->fields['templateUuid'] = (new FkField('shop_template_uuid', \Shopware\ShopTemplate\Writer\Resource\ShopTemplateResource::class, 'uuid'));
        ...
        $this->fields['documentTemplateUuid'] = (new FkField('document_template_uuid', \Shopware\ShopTemplate\Writer\Resource\ShopTemplateResource::class, 'uuid'));
