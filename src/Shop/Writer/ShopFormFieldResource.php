...
class ShopFormFieldResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['shopForm'] = new ReferenceField('shopFormUuid', 'uuid', \Shopware\Shop\Writer\ShopFormResource::class);
        $this->fields['shopFormUuid'] = (new FkField('shop_form_uuid', \Shopware\Shop\Writer\ShopFormResource::class, 'uuid'))->setFlags(new Required());
    }
