...
class ShopPageResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['parent'] = new ReferenceField('parentUuid', 'uuid', \Shopware\Shop\Writer\ShopPageResource::class);
        $this->fields['parentUuid'] = (new FkField('parent_uuid', \Shopware\Shop\Writer\ShopPageResource::class, 'uuid'));
        $this->fields['s'] = new SubresourceField(\Shopware\Shop\Writer\ShopPageResource::class);
    }
    
    public function getWriteOrder(): array
    {
        return [
            \Shopware\Shop\Writer\ShopPageResource::class
        ];
    }
}
