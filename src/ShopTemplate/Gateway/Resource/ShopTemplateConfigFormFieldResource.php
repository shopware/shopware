...
class ShopTemplateConfigFormFieldResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['shopTemplateConfigForm'] = new ReferenceField('shopTemplateConfigFormUuid', 'uuid', \Shopware\ShopTemplate\Gateway\Resource\ShopTemplateConfigFormResource::class);
        $this->fields['shopTemplateConfigFormUuid'] = (new FkField('shop_template_config_form_uuid', \Shopware\ShopTemplate\Gateway\Resource\ShopTemplateConfigFormResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['values'] = new SubresourceField(\Shopware\ShopTemplate\Gateway\Resource\ShopTemplateConfigFormFieldValueResource::class);
    }
