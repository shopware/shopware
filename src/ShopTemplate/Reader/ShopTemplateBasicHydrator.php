...
class ShopTemplateBasicHydrator extends Hydrator
{
    ...
    public function hydrate(array $data): ShopTemplateBasicStruct
    {
        ...
        $shopTemplate->setDescription(isset($data['__shopTemplate_description']) ? (string) $data['__shopTemplate_description'] : null);
        $shopTemplate->setAuthor(isset($data['__shopTemplate_author']) ? (string) $data['__shopTemplate_author'] : null);
        $shopTemplate->setLicense(isset($data['__shopTemplate_license']) ? (string) $data['__shopTemplate_license'] : null);
        ...
        $shopTemplate->setPluginId(isset($data['__shopTemplate_plugin_id']) ? (int) $data['__shopTemplate_plugin_id'] : null);
        $shopTemplate->setPluginUuid(isset($data['__shopTemplate_plugin_uuid']) ? (string) $data['__shopTemplate_plugin_uuid'] : null);
        $shopTemplate->setParentId(isset($data['__shopTemplate_parent_id']) ? (int) $data['__shopTemplate_parent_id'] : null);
        $shopTemplate->setParentUuid(isset($data['__shopTemplate_parent_uuid']) ? (string) $data['__shopTemplate_parent_uuid'] : null);
