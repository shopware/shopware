...
class ShopTemplateBasicReader
{
    ...
    public function __construct(Connection $connection, ShopTemplateBasicHydrator $hydrator)
    {
    ...
    {
        $query = new ShopTemplateBasicQuery($this->connection, $context);

        $query->andWhere('shopTemplate.uuid IN (:uuids)');
