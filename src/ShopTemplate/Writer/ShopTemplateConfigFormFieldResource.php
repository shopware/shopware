...
class ShopTemplateConfigFormFieldResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['shopTemplate'] = new ReferenceField('shopTemplateUuid', 'uuid', \Shopware\ShopTemplate\Writer\ShopTemplateResource::class);
        $this->fields['shopTemplateUuid'] = (new FkField('shop_template_uuid', \Shopware\ShopTemplate\Writer\ShopTemplateResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['shopTemplateConfigForm'] = new ReferenceField('shopTemplateConfigFormUuid', 'uuid', \Shopware\ShopTemplate\Writer\ShopTemplateConfigFormResource::class);
        $this->fields['shopTemplateConfigFormUuid'] = (new FkField('shop_template_config_form_uuid', \Shopware\ShopTemplate\Writer\ShopTemplateConfigFormResource::class, 'uuid'))->setFlags(new Required());
        $this->fields['values'] = new SubresourceField(\Shopware\ShopTemplate\Writer\ShopTemplateConfigFormFieldValueResource::class);
    }
    ...
    public function getWriteOrder(): array
    {
        return [
            ...
            \Shopware\ShopTemplate\Writer\ShopTemplateConfigFormResource::class,
