...
class ShopTemplateResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['parent'] = new ReferenceField('parentUuid', 'uuid', \Shopware\ShopTemplate\Writer\ShopTemplateResource::class);
        $this->fields['parentUuid'] = (new FkField('parent_uuid', \Shopware\ShopTemplate\Writer\ShopTemplateResource::class, 'uuid'));
        $this->fields['s'] = new SubresourceField(\Shopware\ShopTemplate\Writer\ShopTemplateResource::class);
        $this->fields['configForms'] = new SubresourceField(\Shopware\ShopTemplate\Writer\ShopTemplateConfigFormResource::class);
        $this->fields['configFormFields'] = new SubresourceField(\Shopware\ShopTemplate\Writer\ShopTemplateConfigFormFieldResource::class);
        $this->fields['configPresets'] = new SubresourceField(\Shopware\ShopTemplate\Writer\ShopTemplateConfigPresetResource::class);
    }
