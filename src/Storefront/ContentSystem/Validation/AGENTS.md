...
- `SKIP_VALIDATION_STATE` suppresses assignment validation on both sections; set by migrations and trusted bulk importers; the Storefront validator checks the flag identically to the Core `ContentLayoutAssignmentWriteValidator`
