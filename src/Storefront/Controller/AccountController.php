...
class AccountController extends StorefrontController
{
     ...
     */
    public function checkLogin(AccountLoginRequest $loginRequest, Request $request, CheckoutContext $context): RedirectResponse
    {
        try {
     ...
     */
    public function register(AccountRegistrationRequest $registrationRequest, CheckoutContext $context): Response
    {
        try {
     ...
     * @throws CustomerNotLoggedInException
     */
    public function updateProfile(AccountProfileSaveRequest $profileSaveRequest, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     * @throws CustomerNotLoggedInException
     */
    public function updatePassword(AccountPasswordSaveRequest $passwordSaveRequest, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     * @throws CustomerNotLoggedInException
     */
    public function updateEmail(AccountEmailSaveRequest $emailSaveRequest, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     */
    public function upsertAddress(AccountAddressSaveRequest $request, Request $httpRequest, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     * @throws AddressNotFoundException
     */
    public function deleteAddress($addressId, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     * @throws AddressNotFoundException
     */
    public function setDefaultBillingAddress(string $addressId, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     * @throws AddressNotFoundException
     */
    public function setDefaultShippingAddress(string $addressId, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
     ...
     * @throws \Exception
     */
    public function addressAjaxSave(AccountAddressSaveRequest $request, CheckoutContext $context): Response
    {
        $this->denyAccessUnlessLoggedIn();
