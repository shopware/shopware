...
class ContextController extends StorefrontController
{
    ...
    public function setCurrency(Request $request, CheckoutContext $context): RedirectResponse
    {
        ...
        if (!empty($payload)) {
            $this->contextPersister->save($context->getToken(), $payload);
            $this->checkoutContextService->refresh($context->getContext()->getSourceContext()->getSalesChannelId(), $context->getToken());
        }
