...
class DocumentController extends StorefrontController
{
    ...
    #[Route(path: '/account/order/document/{documentId}/{deepLinkCode}/{fileType}', name: 'frontend.account.order.single.document.a11y', defaults: [PlatformRequest::ATTRIBUTE_NO_STORE => true], methods: ['GET', 'POST'])]
