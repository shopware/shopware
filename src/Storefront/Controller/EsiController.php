...
class EsiController extends StorefrontController
{
    ...
    public function header(Request $request, SalesChannelContext $context): Response
    {
        ...
        return $this->renderStorefront('@Storefront/storefront/esi/header.html.twig', ['header' => $header]);
    }
    ...
    {
        $header = $this->footerLoader->load($request, $context);

        return $this->renderStorefront('@Storefront/storefront/esi/footer.html.twig', ['footer' => $header]);
    }
}
