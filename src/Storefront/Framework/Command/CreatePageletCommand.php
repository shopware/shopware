...
class CreatePageletCommand extends Command
{
    ...
    protected function createFiles(string $name, OutputInterface $output, string $directory, string $namespace): void
    {
        ...
        $files = [
            'LoadedEvent' => '/' . $namespace . $name . 'PageletLoadedEvent.php',
...
class %%namespace%%%%name%%PageletLoadedEvent extends NestedEvent
{
    public const NAME = '%%namespaceLower%%-%%nameLower%%.pagelet.loaded';
    ...
    public function __construct(
        %%namespace%%%%name%%PageletStruct $pagelet,
        CheckoutContext $context,
        %%namespace%%%%name%%PageletRequest $request
    ) {
    ...
    public function getPagelet(): %%namespace%%%%name%%PageletStruct
    {
        return $this->pagelet;
    }

    public function getRequest(): %%namespace%%%%name%%PageletRequest
    {
        return $this->request;
    }
}
...
class %%namespace%%%%name%%PageletLoader
{
     ...
     */
    public function load(%%namespace%%%%name%%PageletRequest $request, CheckoutContext $context): %%namespace%%%%name%%PageletStruct
    {
...
class %%namespace%%%%name%%PageletSubscriber implements EventSubscriberInterface
{
    ...
    {
        return [
            %%namespace%%Events::%%namespaceUPPER%%%%nameUPPER%%_PAGELET_REQUEST => 'transformRequest',
        ];
    }

    public function transformRequest(%%namespace%%%%name%%PageletRequestEvent $event): void
    {
