...
readonly class SalesChannelDomainUtil
{
    ...
    public function runAsSalesChannelRequest(callable $callback): Result
    {
        ...
        $hasSalesChannelRequest = $mainRequest->attributes->get(SalesChannelRequestAttribute::IS_SALES_CHANNEL_REQUEST->value);
        $mainRequest->attributes->set(SalesChannelRequestAttribute::IS_SALES_CHANNEL_REQUEST->value, true);

        try {
            return $callback();
        } finally {
            $mainRequest->attributes->set(SalesChannelRequestAttribute::IS_SALES_CHANNEL_REQUEST->value, $hasSalesChannelRequest);
        }
    }
