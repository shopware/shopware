...
class AccountOverviewPageLoader
{
    ...
    /**
     * @var CountryAddressFormattingService
     */
    private $countryAddressFormattingService;
    ...
    public function load(Request $request, SalesChannelContext $salesChannelContext, CustomerEntity $customer): AccountOverviewPage
    {
        ...
        $page->setFormattingCustomerAddresses($this->renderCustomerAddressFormatting($page->getCustomer(), $salesChannelContext->getContext()));
    ...
    private function renderCustomerAddressFormatting(CustomerEntity $customer, Context $context): array
    {
        $formattingCustomerAddresses = [];
        $customerAddressCollection = new CustomerAddressCollection([$customer->getDefaultBillingAddress(), $customer->getDefaultShippingAddress()]);
