...
{
    public const NAME = 'newsletter-recipient.confirm-subscribe-page.loaded';
    ...
    public function __construct(NewsletterConfirmSubscribePage $page, SalesChannelContext $context, Request $request)
    {
        $this->page = $page;
