 ...
 *                         directories to search in priority order.  Multiple
 *                         paths are useful when component sources and their
 *                         dependencies live in different locations (e.g. an
 *                         extension's own node_modules plus the core
 *                         Storefront's shared node_modules).
 */
