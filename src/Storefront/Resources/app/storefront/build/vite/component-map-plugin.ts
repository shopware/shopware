 ...
 *    reads at theme:compile time to store vendor resolution data in the runtime
 *    config:
 *
 *    { "@shopware-ag/dive/quickview": "vendor/quickview-abc123.js" }
 *
 *    This is the only piece of build output that PHP cannot derive on its own:
 *    the content-hashed chunk filename is opaque without this map.
 *
 * Design notes
 * ------------
 *
