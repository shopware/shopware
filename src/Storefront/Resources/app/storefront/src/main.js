...
PluginManager.register('CheckoutCustomerCommentReset', () => import('src/plugin/checkout/checkout-customer-comment-reset.plugin'), '[data-checkout-customer-comment-reset]');
