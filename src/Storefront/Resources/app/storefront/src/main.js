...
PluginManager.register('CheckoutCustomerCommentStorage', () => import('src/plugin/checkout/checkout-customer-comment-storage.plugin'), '[data-checkout-customer-comment-storage]');
