...
* The `<twig:Slot>` component is used to declare slots for extending the component.
...
* A slot can have a default content that is nested inside the `<twig:Slot>`.
...
* The nested components must live under the same namespace.
...
```twig
<twig:Sw:ProductCard:ProductCard>
    <twig:Sw:ProductCard:Actions />
</twig:Sw:ProductCard:ProductCard>
```
