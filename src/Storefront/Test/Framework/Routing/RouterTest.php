    ...
    public function urlCases()
    {
        ...
        return [
            ...
            'test-home-page-with-de-relative' => [
                new UrlCase(UrlGeneratorInterface::RELATIVE_PATH, '', '/de', 'frontend.home.page'),
            ],
            ...
            'test-navigation-page-with-de-relative' => [
                new UrlCase(UrlGeneratorInterface::RELATIVE_PATH, "navigation/{$id}", '/de', 'frontend.navigation.page', ['navigationId' => $id]),
            ],
