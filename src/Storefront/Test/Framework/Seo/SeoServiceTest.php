...
class SeoServiceTest extends TestCase
{
    ...
    public function testResolveSeoPathPassthrough(): void
    {
        ...
        $resolved = SeoService::resolveSeoPath($connection, $salesChannel->getId(), '/foo/bar');
    ...
    public function testResolveSeoPath(): void
    {
        ...
        $resolved = SeoService::resolveSeoPath($connection, $salesChannel->getId(), 'detail/1234');
        ...
        $resolved = SeoService::resolveSeoPath($connection, $salesChannel->getId(), 'awesome-product');
        static::assertEquals('/detail/1234', $resolved['pathInfo']);
        static::assertEquals(0, $resolved['isCanonical']);
        static::assertEquals('/awesome-product-v2', $resolved['canonicalPathInfo']);
        $resolved = SeoService::resolveSeoPath($connection, $salesChannel->getId(), '/awesome-product');
        ...
        $resolved = SeoService::resolveSeoPath($connection, $salesChannel->getId(), 'awesome-product-v2');
        static::assertEquals('/detail/1234', $resolved['pathInfo']);
