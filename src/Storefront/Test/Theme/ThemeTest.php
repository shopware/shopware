...
class ThemeTest extends TestCase
{
    ...
    public function testThemeServiceUpdate(): void
    {
        ...
        try {
            ...
            if ($e->getMessage() !== 'Unable to compile the theme "Storefront". Unable to load file "src/Storefront/Resources/app/storefront/dist/js/vendor-node.js". Did you forget to build the theme? Try running ./bin/build-storefront.sh') {
                throw $e;
            }
        }
