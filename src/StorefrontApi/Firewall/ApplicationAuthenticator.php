...
class ApplicationAuthenticator extends AbstractGuardAuthenticator
{
    ...
    public function createToken(Request $request, $providerKey)
    {
        ...
        $tokenData = new ApplicationToken($apiKey, $contextKey);
    ...
    {
        if (!$userProvider instanceof ContextUserProvider) {
            throw new \InvalidArgumentException(
                sprintf(
                    'The user provider must be an instance of ContextUserProvider (%s was given).',
                    \get_class($userProvider)
                )
            );
        }

        $tokenData = $token->getCredentials();
        $contextUser = $userProvider->loadUserByUsername($tokenData);

        return new PreAuthenticatedToken(
            $contextUser,
            $token,
            $providerKey,
            $contextUser->getRoles()
        );
    }
     ...
     *
     * @param ApplicationToken $credentials
    ...
    {
        return $credentials instanceof ApplicationToken;
    }
