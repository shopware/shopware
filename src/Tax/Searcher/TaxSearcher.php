...
class TaxSearcher extends Search
{
    ...
    public function __construct(Connection $connection, array $handlers, TaxBasicHydrator $hydrator)
    {
    ...
    {
        return new TaxBasicQuery($this->connection, $context);
    }
    ...
    protected function createResult(array $rows, int $total, TranslationContext $context): SearchResultInterface
    {
        ...
        return new TaxSearchResult($structs, $total);
    }
}
