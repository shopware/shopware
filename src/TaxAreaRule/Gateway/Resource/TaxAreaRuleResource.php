...
namespace Shopware\TaxAreaRule\Gateway\Resource;
...
class TaxAreaRuleResource extends Resource
{
    ...
    public function __construct()
    {
        ...
        $this->fields['areaUuid'] = (new FkField('area_uuid', \Shopware\Area\Gateway\Resource\AreaResource::class, 'uuid'));
        ...
        $this->fields['areaCountryState'] = new ReferenceField('areaCountryStateUuid', 'uuid', \Shopware\AreaCountryState\Gateway\Resource\AreaCountryStateResource::class);
        $this->fields['areaCountryStateUuid'] = (new FkField('area_country_state_uuid', \Shopware\AreaCountryState\Gateway\Resource\AreaCountryStateResource::class, 'uuid'));
