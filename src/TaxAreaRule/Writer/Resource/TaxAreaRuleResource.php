...
class TaxAreaRuleResource extends Resource
{
    ...
    public static function createWrittenEvent(array $updates, array $errors = []): \Shopware\TaxAreaRule\Event\TaxAreaRuleWrittenEvent
    {
        $event = new \Shopware\TaxAreaRule\Event\TaxAreaRuleWrittenEvent($updates[self::class] ?? [], $errors);
