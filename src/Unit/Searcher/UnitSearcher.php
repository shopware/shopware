...
class UnitSearcher extends Search
{
    /**
    ...
    public function __construct(Connection $connection, array $handlers, UnitBasicHydrator $hydrator)
    {
    ...
    {
        return new UnitBasicQuery($this->connection, $context);
    }
    ...
    protected function createResult(array $rows, int $total, TranslationContext $context): SearchResultInterface
    {
        ...
        return new UnitSearchResult($structs, $total);
    }
}
