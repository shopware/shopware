...
class AmountCalculatorTest extends TestCase
{
     ...
     * @param PriceCollection $prices
     */
    public function testCalculateAmountForNetDeliveries(CartPrice $expected, \Shopware\Cart\Price\Struct\PriceCollection $prices): void
    {
        $detector = $this->createMock(TaxDetector::class);
        $detector->method('useGross')->will($this->returnValue(false));
        ...
        return [
            ...
            [
                ...
                new PriceCollection([
                    ...
                    new \Shopware\Cart\Price\Struct\Price(2.00, 2.00, new CalculatedTaxCollection([new CalculatedTax(0.38, 19, 2.00)]), new TaxRuleCollection([new TaxRule(19)])),
