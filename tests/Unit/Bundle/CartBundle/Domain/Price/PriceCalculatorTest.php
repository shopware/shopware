...
class PriceCalculatorTest extends TestCase
{
    ...
    public function testPriceCalculationWithGrossPrices(
        ...
        Price $expected,
        \Shopware\Cart\Price\Struct\PriceDefinition $priceDefinition
    ): void {
    ...
    public function priceCalculationWithGrossPricesProvider(): array
    {
        ...
        return [
            [
                new PriceRounding(2),
                new \Shopware\Cart\Price\Struct\Price(15.99, 15.99, new CalculatedTaxCollection([new CalculatedTax(2.55, 19, 15.99)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(13.436974789916, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(21.32, 21.32, new CalculatedTaxCollection([new CalculatedTax(3.40, 19, 21.32)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(17.9159663865546, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(50, 50, new CalculatedTaxCollection([new CalculatedTax(7.98, 19, 50)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(42.0168067226891, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(-5.88, -5.88, new CalculatedTaxCollection([new CalculatedTax(-0.94, 19, -5.88)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(-4.94117647058824, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(95799.97, 95799.97, new CalculatedTaxCollection([new CalculatedTax(15295.79, 19, 95799.97)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(80504.1764705882, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(0.05, 0.05, new CalculatedTaxCollection([new CalculatedTax(0.01, 19, 0.05)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.0420168067226891, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(0.01, 0.01, new CalculatedTaxCollection([new CalculatedTax(0.00, 19, 0.01)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.00840336134453782, $highTaxRules),
            ], [
                new PriceRounding(2),
                ...
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.092436974789916, $highTaxRules),
            ], [
                new PriceRounding(2),
                new Price(0.11, 0.11, new CalculatedTaxCollection([new CalculatedTax(0.01, 7, 0.11)]), $lowTaxRuleCollection),
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.102803738317757, $lowTaxRuleCollection),
            ], [
                new PriceRounding(2),
                new Price(15.99, 15.99, new CalculatedTaxCollection([new CalculatedTax(1.05, 7, 15.99)]), $lowTaxRuleCollection),
                new \Shopware\Cart\Price\Struct\PriceDefinition(14.9439252336449, $lowTaxRuleCollection),
            ], [
                new PriceRounding(2),
                new \Shopware\Cart\Price\Struct\Price(21.32, 21.32, new CalculatedTaxCollection([new CalculatedTax(1.39, 7, 21.32)]), $lowTaxRuleCollection),
                new \Shopware\Cart\Price\Struct\PriceDefinition(19.9252336448598, $lowTaxRuleCollection),
            ], [
                new PriceRounding(2),
                new \Shopware\Cart\Price\Struct\Price(50.00, 50.00, new CalculatedTaxCollection([new CalculatedTax(3.27, 7, 50.00)]), $lowTaxRuleCollection),
                new \Shopware\Cart\Price\Struct\PriceDefinition(46.7289719626168, $lowTaxRuleCollection),
            ], [
                new PriceRounding(2),
                new Price(95799.97, 95799.97, new CalculatedTaxCollection([new CalculatedTax(6267.29, 7, 95799.97)]), $lowTaxRuleCollection),
                new \Shopware\Cart\Price\Struct\PriceDefinition(89532.6822429906, $lowTaxRuleCollection),
            ], [
                new PriceRounding(2),
                ...
                new PriceRounding(2),
                new \Shopware\Cart\Price\Struct\Price(0.01, 0.01, new CalculatedTaxCollection([new CalculatedTax(0.00, 7, 0.01)]), $lowTaxRuleCollection),
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.00934579439252336, $lowTaxRuleCollection),
            ], [
                new PriceRounding(2),
                ...
                new \Shopware\Cart\Price\Struct\PriceDefinition(-5.49532710280374, $lowTaxRuleCollection),
            ], [
                new PriceRounding(3),
                new Price(15.999, 15.999, new CalculatedTaxCollection([new CalculatedTax(2.554, 19, 15.999)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(13.4445378151261, $highTaxRules),
            ], [
                new PriceRounding(3),
                ...
                new \Shopware\Cart\Price\Struct\PriceDefinition(42.01680672268908, $highTaxRules),
            ], [
                new PriceRounding(3),
                new Price(95799.974, 95799.974, new CalculatedTaxCollection([new CalculatedTax(15295.794, 19, 95799.974)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(80504.1798319328, $highTaxRules),
            ], [
                new PriceRounding(3),
                new Price(0.005, 0.005, new CalculatedTaxCollection([new CalculatedTax(0.001, 19, 0.005)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.00420168067226891, $highTaxRules),
            ], [
                new PriceRounding(3),
                ...
                new \Shopware\Cart\Price\Struct\PriceDefinition(0.00672268907563025, $highTaxRules),
            ], [
                new PriceRounding(3),
                new Price(-5.988, -5.988, new CalculatedTaxCollection([new CalculatedTax(-0.956, 19, -5.988)]), $highTaxRules),
                new \Shopware\Cart\Price\Struct\PriceDefinition(-5.03193277310924, $highTaxRules),
            ],
        ];
    }
}
