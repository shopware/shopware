...
class TaxCalculatorTest extends TestCase
{
     ...
     * @param \Shopware\Cart\Tax\Struct\TaxRuleInterface|Tax $taxRule
     * @param float                $net
     */
    public function testCalculateGrossPriceOfNetPrice($expected, PriceRounding $rounding, \Shopware\Cart\Tax\Struct\TaxRuleInterface $taxRule, $net): void
    {
        ...
        $rules = new \Shopware\Cart\Tax\Struct\TaxRuleCollection([$taxRule]);
    ...
    public function testNotSupportedRule(): void
    {
        ...
        $rule = new TaxRule(19);
        $rules = new \Shopware\Cart\Tax\Struct\TaxRuleCollection([$rule]);
    ...
    public function netPricesToGross(): array
    {
        return [
            ...
            [5.00,         new PriceRounding(2), new \Shopware\Cart\Tax\Struct\TaxRule(7),  4.67289719626168],
            [299999.99,    new PriceRounding(2), new TaxRule(7),  280373.822429907],
            [13.76,        new PriceRounding(2), new TaxRule(7),  12.8598130841121],
            [0.001,        new PriceRounding(3), new \Shopware\Cart\Tax\Struct\TaxRule(7),  0.000934579439252336],
            [0.008,        new PriceRounding(3), new \Shopware\Cart\Tax\Struct\TaxRule(7),  0.00747663551401869],
            [5.00,         new PriceRounding(3), new TaxRule(7),  4.67289719626168],
            [299999.999,   new PriceRounding(3), new TaxRule(7),  280373.830841121],
            [13.767,       new PriceRounding(3), new \Shopware\Cart\Tax\Struct\TaxRule(7),  12.8663551401869],
            [0.0001,       new PriceRounding(4), new TaxRule(7),  0.0000934579439252336],
            [0.0008,       new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(7),  0.000747663551401869],
            [5.00,         new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(7),  4.67289719626168],
            ...
            [0.08,         new PriceRounding(2), new \Shopware\Cart\Tax\Struct\TaxRule(19), 0.0672268907563025],
            ...
            [0.008,        new PriceRounding(3), new \Shopware\Cart\Tax\Struct\TaxRule(19), 0.00672268907563025],
            [5.00,         new PriceRounding(3), new \Shopware\Cart\Tax\Struct\TaxRule(19), 4.20168067226891],
            [299999.999,   new PriceRounding(3), new \Shopware\Cart\Tax\Struct\TaxRule(19), 252100.839495798],
            ...
            [0.0008,       new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(19), 0.000672268907563025],
            [5.00,         new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(19), 4.20168067226891],
            [299999.9999,  new PriceRounding(4), new \Shopware\Cart\Tax\Struct\TaxRule(19), 252100.840252101],
