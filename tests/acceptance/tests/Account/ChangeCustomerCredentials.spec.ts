  ...
  tag: '@Account',
    ...
    test('As a customer, I must be able to change my email via account.', async ({
        ...
        await test.step('Attempt to change email to an invalid address', async () => {
            ...
            await ShopCustomer.presses(StorefrontAccountProfile.changeEmailButton, 'Enter');
            ...
            await ShopCustomer.presses(StorefrontAccountProfile.saveEmailAddressButton, 'Enter');
        ...
        await test.step('Verify login with old email fails', async () => {
            await ShopCustomer.presses(StorefrontAccountLogin.logoutLink, 'Enter');
    ...
    test('As a customer, I must be able to change my password via account.', async ({
        ...
        await test.step('Attempt to change password to an invalid (short) password', async () => {
            await ShopCustomer.goesTo(StorefrontAccountProfile.url());
            await ShopCustomer.presses(StorefrontAccountProfile.changePasswordButton, 'Enter');
            ...
            await ShopCustomer.presses(StorefrontAccountProfile.saveNewPasswordButton, 'Enter');
