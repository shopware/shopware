...
test(
    'Shop administrator should be able to create a landing page.',
    { tag: '@Categories' },
    async ({ ShopAdmin, IdProvider, TestDataService, AdminCategories, CreateLandingPage, AdminLandingPageDetail }) => {
