...
test(
    ...
    async ({ ShopCustomer, StorefrontHome, TestDataService }) => {
        ...
        await test.step('Verify if folder category has a sub category and the folder category in breadcrumb is a div element. ' + 'Blocked by https://github.com/shopware/shopware/issues/7670', async () => {
