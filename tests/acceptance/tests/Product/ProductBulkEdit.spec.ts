...
test(
    'As a merchant, I want to perform bulk edits on products information.',
    { tag: '@Product' },
    async ({
        TestDataService,
        ShopAdmin,
        ...
        const changedProduct1 = await TestDataService.createBasicProduct({
            stock: originalStock,
        ...
        const changedProduct2 = await TestDataService.createBasicProduct({
            stock: originalStock,
            restockTime: originalRestockTime,
            tags: [{ id: originalTag.id }],
            visibilities: [{ salesChannelId: DefaultSalesChannel.salesChannel.id, visibility: 30 }],
        });
        const unchangedProduct = await TestDataService.createBasicProduct({
            stock: originalStock,
            restockTime: originalRestockTime,
            tags: [{ id: originalTag.id }],
            visibilities: [{ salesChannelId: DefaultSalesChannel.salesChannel.id, visibility: 30 }],
