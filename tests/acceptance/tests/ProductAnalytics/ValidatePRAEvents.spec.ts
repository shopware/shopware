...
test.describe('Product Analytics - Validate events.', { tag: '@ProductAnalytics' }, () => {
    test(
        'As a merchant, I want to make sure admin events are sent correctly.',
