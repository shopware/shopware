...
test(
    ...
    async ({ TestDataService, ShopAdmin, AdminCustomerGroupListing, AdminCustomerGroupDetail, DefaultSalesChannel }) => {
        ...
        await test.step('Verify the created customer group in the admin', async () => {
            ...
            await ShopAdmin.expects(AdminCustomerGroupDetail.page.locator('.sw-settings-customer-group-detail__price-display-mode .sw-single-select__selection-text')).toHaveText('Gross prices');
...
test(
    ...
    { tag: '@Registration @CustomerGroups' },
    async ({
        TestDataService,
        ShopAdmin,
        ShopCustomer,
...
test(
    'As a commercial customer, I can register under a customer group in the Storefront.',
    { tag: '@Registration @CustomerGroups' },
    async ({
        TestDataService,
        ShopAdmin,
        ...
        const commercialCustomerGroup = await TestDataService.createCustomerGroup({
