...
test('Visual: Product Detail Page', { tag: '@Visual' }, async ({
    ...
    await test.step('Creates a screenshot of the product detail page General tab.', async () => {
        ...
        await VisualTestHelpers.setViewport(AdminProductDetail.page, {
            requestURL: 'api/search/category',
        });
        await VisualTestHelpers.replaceElements(AdminProductDetail.page, [
            AdminProductDetail.productHeadline,
        ]);
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-General-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page Specifications tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-Specifications-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page Advanced Pricing tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-Advanced-Pricing-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page Variants tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-Variants-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page Layout tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-Layout-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page SEO tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-SEO-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page Cross Selling tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-Cross-Selling-Tab.png');
    });
    ...
    await test.step('Creates a screenshot of the product detail page Reviews tab.', async () => {
        ...
        await ShopAdmin.expects(AdminProductDetail.contentView).toHaveScreenshot('Product-Detail-Reviews-Tab.png');
    });
});
