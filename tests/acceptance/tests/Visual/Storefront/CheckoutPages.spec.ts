...
test(
    ...
    async ({
        ...
        await test.step('Create screenshot of checkout/register page in storefront.', async () => {
            ...
            await hideElements(StorefrontCheckoutRegister.page, ['.cookie-permission-container']);
        ...
        await test.step('Create screenshot of checkout/confirm page in storefront.', async () => {
            ...
            await hideElements(StorefrontCheckoutConfirm.page, ['.cookie-permission-container']);
        ...
        await test.step('Create screenshot of checkout/finish page in storefront.', async () => {
            ...
            await hideElements(StorefrontCheckoutFinish.page, ['.cookie-permission-container']);
