...
test('Registered shop customer buys a product.', { tag: '@Checkout' }, async ({
    ...
    for(let i = 0; i < 10; i++)
        await StorefrontProductDetail.page.keyboard.press('Tab');
    ...
    //could actually skip SelectInvoicePaymentOption and SelectStandardShippingOption bc they are selected by default
