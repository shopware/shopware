...
describe('Checkout: Visual tests', () => {
    ...
    it('@visual: check appearance of basic checkout workflow', { tags: ['pa-checkout'] }, () => {
        ...
        cy.contains('.line-item-price', '49.98').should('be.visible');
        ...
        cy.contains('.line-item-details-container .line-item-label', product.name);
        cy.contains('.line-item-total-price', product.price[0].gross);
        cy.contains('.line-item-total-price', product.price[0].gross);
