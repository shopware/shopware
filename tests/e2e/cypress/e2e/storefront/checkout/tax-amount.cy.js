        ...
        context(`Checkout with ${additionalProduct.name} (${contextDescription})`, () => {
            ...
            it('@base @checkout @package: Run checkout', { tags: ['pa-checkout'] }, () => {
                ...
                cy.window().then((win) => {
                    ...
                    cy.get(`${lineItemSelector}-details-container ${lineItemSelector}-label`)
                    ...
                    if (additionalProduct.name === '7% Product') {
                        ...
                        cy.get(`:nth-child(2) > :nth-child(1) > ${lineItemSelector}-tax-price`)
                            .contains(`${taxSum * 2}`);
                        cy.get(`:nth-child(2) > :nth-child(1) > ${lineItemSelector}-total-price`)
                        ...
                        cy.get(`:nth-child(3) > :nth-child(1) > ${lineItemSelector}-tax-price`)
                            .contains(additionalTaxSum);
                        cy.get(`:nth-child(3) > :nth-child(1) > ${lineItemSelector}-total-price`)
