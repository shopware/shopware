...
#[Group('rules')]
class CartWeightRuleTest extends \Shopware\Core\Framework\Test\TestCaseBase\IntegrationTestCase
{
    ...
    /**
     * @return iterable<string, array{0: string, 1: int, 2: int, 3: int, 4: bool, 5?: bool, 6?: bool}>
     */
    public static function getMatchingRuleTestData(): iterable
    {
        // OPERATOR_EQ
