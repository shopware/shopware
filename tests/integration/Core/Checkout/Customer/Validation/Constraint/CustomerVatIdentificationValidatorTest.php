 ...
 * @internal
 *
 * @covers \Shopware\Core\Checkout\Customer\Validation\Constraint\CustomerVatIdentificationValidator
 */
class CustomerVatIdentificationValidatorTest extends TestCase
{
    ...
    public static function dataProviderValidatesVatIdsCorrectly(): \Generator
    {
    ...
    public static function dataProviderValidatesVatIdsInCorrectly(): \Generator
    {
