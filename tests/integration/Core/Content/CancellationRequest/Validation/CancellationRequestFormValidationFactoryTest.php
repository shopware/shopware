...
namespace Shopware\Tests\Integration\Core\Content\CancellationRequest\Validation;

use PHPUnit\Framework\Attributes\CoversClass;
use PHPUnit\Framework\Attributes\DataProvider;
use PHPUnit\Framework\MockObject\MockObject;
use PHPUnit\Framework\TestCase;
use Shopware\Core\Content\CancellationRequest\Validation\CancellationRequestFormValidationFactory;
 ...
 */
#[Package('after-sales')]
#[CoversClass(CancellationRequestFormValidationFactory::class)]
class CancellationRequestFormValidationFactoryTest extends TestCase
{
    ...
    {
        $factory = new CancellationRequestFormValidationFactory(
