...
namespace Shopware\Tests\Integration\Core\Content\Media\Path\Infrastructure\Domain;
 ...
 * @internal
 *
 * @covers \Shopware\Core\Content\Media\Path\Domain\Service\MediaPathUpdater
 */
