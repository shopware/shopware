...
class ApiControllerSearchTest extends TestCase
{
    ...
    public function testSearchNonTokenizeTerm(): void
    {
        ...
        $this->getBrowser()->request('POST', '/api/search/customer', content: json_encode($data, \JSON_THROW_ON_ERROR));
        $response = $this->getBrowser()->getResponse();
        $content = json_decode((string) $response->getContent(), true, 512, \JSON_THROW_ON_ERROR);
    ...
    public function testSearch(): void
    {
        ...
        $this->getBrowser()->request('POST', '/api/search/product', content: json_encode($data, \JSON_THROW_ON_ERROR));
        $response = $this->getBrowser()->getResponse();
        $content = json_decode((string) $response->getContent(), true, 512, \JSON_THROW_ON_ERROR);
    ...
    public function testAggregation(): void
    {
        ...
        $this->getBrowser()->request('POST', '/api/product', content: json_encode($data, \JSON_THROW_ON_ERROR));
