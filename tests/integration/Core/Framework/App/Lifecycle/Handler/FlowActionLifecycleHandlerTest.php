...
class FlowActionLifecycleHandlerTest extends TestCase
{
    ...
    private FlowActionLifecycleHandler $persister;
    ...
    {
        $this->persister = static::getContainer()->get(FlowActionLifecycleHandler::class);
    ...
    public function testPersistUpdatesExistingFlowActions(): void
    {
        ...
        $this->persister->update($contextV2);
    ...
    public function testPersistDeletesRemovedFlowActions(): void
    {
        ...
        $this->persister->update($contextV3);
