 ...
 * @internal
 */
class CustomFieldPersisterTest extends TestCase
{
    ...
    private CustomFieldPersister $persister;
    ...
    {
        $this->persister = static::getContainer()->get(CustomFieldPersister::class);
    ...
    public function testPersistRecreatesDuplicateExistingCustomFieldSets(): void
    {
        ...
        $this->persister->persist($this->appFixture->createUpdateContext($app, $manifest));
