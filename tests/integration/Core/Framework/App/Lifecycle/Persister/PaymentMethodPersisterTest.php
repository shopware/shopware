...
class PaymentMethodPersisterTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->persister = static::getContainer()->get(PaymentMethodPersister::class);
    ...
    public function testUpdateReusesExistingIconMediaWhenOriginalMediaLinkIsMissing(): void
    {
        ...
        $this->persister->persist($this->appFixture->createInstallContext($app, $manifest, $appFilesystem));
        ...
        $this->persister->persist($this->appFixture->createUpdateContext($app, $manifest, $appFilesystem));
