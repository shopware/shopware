...
class WebhookHealthControllerTest extends TestCase
{
    ...
    public function testHealthStatusReportsACompletedTransportPollAsFresh(): void
    {
        ...
        static::assertNotNull($content['lastTickAt'], 'a completed poll persists the heartbeat it just wrote');
        static::assertFalse($content['stale']);
    }
