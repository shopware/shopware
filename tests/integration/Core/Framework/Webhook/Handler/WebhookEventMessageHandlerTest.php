...
class WebhookEventMessageHandlerTest extends TestCase
{
    ...
    public function testFlagOffHandlerDoesNotAckRunningNewShapeRedelivery(): void
    {
        ...
        Feature::withFeatureDisabled('WEBHOOKS_REWORK', function () use ($webhookEventMessage): void {
            ...
            static::assertSame(0, $this->getRequestCount(), 'RUNNING duplicate redelivery must skip without sending another HTTP request');
        });
    }
    ...
    public function testFlagOffHandlerDoesNotAckNonTerminalNewShapeRedeliveryWithoutDeliveryRow(): void
    {
        ...
        Feature::withFeatureDisabled('WEBHOOKS_REWORK', function () use ($webhookEventMessage): void {
            ...
            static::assertSame(0, $this->getRequestCount(), 'non-terminal duplicate redelivery must skip without sending another HTTP request');
        });
    }
