...
class WebhookHealthBestEffortEventsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $this->outboxStore = new WebhookOutboxStore($this->connection, $this->clock);
    ...
    public function testAThrowingDisabledListenerDoesNotBlockTheOperatorKillOrTheBacklogDrop(): void
    {
        ...
        $killed = $this->service->disableByOperator($this->ids->get('wh'), fromAnyState: true);

        static::assertTrue($killed);
