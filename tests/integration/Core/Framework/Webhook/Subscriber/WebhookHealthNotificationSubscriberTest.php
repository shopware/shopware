...
class WebhookHealthNotificationSubscriberTest extends TestCase
{
    ...
    public function testTwoEpisodesWithinTheSameSecondNotifySeparately(): void
    {
        Feature::withFeatureEnabled('WEBHOOKS_REWORK', function (): void {
            $this->dispatcher->dispatch($this->suspendedEvent(new \DateTimeImmutable('2026-06-01 12:00:00.100')));
            $this->dispatcher->dispatch($this->suspendedEvent(new \DateTimeImmutable('2026-06-01 12:00:00.700')));
        });

        static::assertSame(2, $this->notificationCount(), 'the episode anchor is stored with millisecond precision');
    }
