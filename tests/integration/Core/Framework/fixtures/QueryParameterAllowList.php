...
class QueryParameterAllowList
{
    ...
    public static function getQueryParameterAllowList(): array
    {
        ...
        return [
            ...
            'allowedList' => [
                '/store-api/product-listing/{categoryId}' => ['@product-listing', '@product-listing-flags'],
                '/store-api/search' => ['@product-listing', '@product-listing-flags'],
                '/store-api/search-suggest' => ['@product-listing', '@product-listing-flags'],
                '/store-api/cms/{id}' => ['@product-listing'],
                '/store-api/category' => ['@criteria'],
                '/store-api/category/{navigationId}' => ['@product-listing', 'slots', 'skipBreadcrumb'],
                ...
                '/store-api/product/{productId}' => ['skipConfigurator', 'skipCmsPage', 'skipBreadcrumb', '@criteria'],
