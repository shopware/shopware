...
class RequestTransformerTest extends TestCase
{
    ...
    public function testDomainResolving(array $salesChannels, array $requests): void
    {
        ...
        foreach ($requests as $expectedRequest) {
            ...
            static::assertSame($expectedRequest->domainId, $resolved->attributes->get(SalesChannelRequestAttribute::DOMAIN_ID->value));
            static::assertSame($expectedRequest->isStorefrontRequest, $resolved->attributes->get(SalesChannelRequestAttribute::IS_SALES_CHANNEL_REQUEST->value));
            static::assertSame($expectedRequest->locale, $resolved->attributes->get(SalesChannelRequestAttribute::DOMAIN_LOCALE->value));
            static::assertSame($expectedRequest->currency, $resolved->attributes->get(SalesChannelRequestAttribute::DOMAIN_CURRENCY_ID->value));
            static::assertSame($expectedSnippetSetId, $resolved->attributes->get(SalesChannelRequestAttribute::DOMAIN_SNIPPET_SET_ID->value));
    ...
    public function testRedirectLinksUsesSalesChannelPath(string $baseUrl, string $virtualUrl, string $resolvedUrl): void
    {
        ...
        static::assertSame('http://base.test' . $resolvedUrl, $resolved->attributes->get(SalesChannelRequestAttribute::CANONICAL_LINK->value));
    }
