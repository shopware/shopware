...
use Shopware\Core\Migration\V6_3\Migration1607500561UpdateSignUpMailTemplateTranslation;
...
class Migration1607500561UpdateSignUpMailTemplateTranslationTest extends TestCase
{
    public function testEnSignupMailTemplateIsUpdated(): void
    {
        ...
        $signUpTemplateTranslation = $connection->fetchAssociative($sqlString, [
            'langId' => $enLangId,
        ...
        $signUpTemplateDeTranslation = $connection->fetchAssociative($sqlString, [
            'langId' => $deLangId,
            'templateId' => $signUpTemplateId,
        ]);
        ...
        $signUpConfirmationTemplateTranslation = $connection->fetchAssociative($sqlString, [
            'enLangId' => $enLangId,
