...
use Shopware\Core\Migration\V6_4\Migration1618476427ElasticsearchStreamFieldManufacturerRevert;
use Shopware\Tests\Migration\MigrationTestTrait;

/**
 * @internal
 *
 * @covers \Shopware\Core\Migration\V6_4\Migration1618476427ElasticsearchStreamFieldManufacturerRevert
 */
class Migration1618476427ElasticsearchStreamFieldManufacturerRevertTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $connection->executeStatement('
            ...
            VALUES
                ...
                (UNHEX(\'6382E03A768F444E9C2A809C63102BD4\'), UNHEX(\'137B079935714281BA80B40F83F8D7EB\'), UNHEX(\'BB87D86524FB4E7EA01EE548DD43A5AC\'), \'range\', \'manufacturerId\', NULL, NULL, \'{"gte":182}\', 2, NULL, \'2019-08-16 08:43:57.485\', NULL),
    ...
    public function testFieldGetChanged(): void
    {
        ...
        $m = new Migration1618476427ElasticsearchStreamFieldManufacturerRevert();
        $m->update($connection);
