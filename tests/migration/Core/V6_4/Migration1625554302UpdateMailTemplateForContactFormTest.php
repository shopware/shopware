...
use Shopware\Core\Migration\V6_4\Migration1625554302UpdateMailTemplateForContactForm;
...
class Migration1625554302UpdateMailTemplateForContactFormTest extends TestCase
{
    public function testEnContactFormTemplateIsUpdated(): void
    {
        ...
        $contactFormTemplateTranslation = $connection->fetchAssociative($sqlString, [
            'langId' => $enLangId,
        ...
        $contactFormTemplateDeTranslation = $connection->fetchAssociative($sqlString, [
            'langId' => $deLangId,
            'templateId' => $contactFormTemplateId,
        ]);
