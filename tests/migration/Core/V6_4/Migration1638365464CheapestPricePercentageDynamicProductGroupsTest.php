...
use Shopware\Core\Migration\V6_4\Migration1638365464CheapestPricePercentageDynamicProductGroups;
use Shopware\Tests\Migration\MigrationTestTrait;

/**
 * @internal
 *
 * @covers \Shopware\Core\Migration\V6_4\Migration1638365464CheapestPricePercentageDynamicProductGroups
 */
class Migration1638365464CheapestPricePercentageDynamicProductGroupsTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $connection->executeStatement('
            ...
            VALUES
                ...
                (UNHEX(\'56C5DF0B41954334A7B0CDFEDFE1D7E9\'), UNHEX(\'137B079935714281BA80B40F83F8D7EB\'), UNHEX(\'272B4392E7B34EF2ABB4827A33630C1D\'), \'range\', \'price.percentage\', NULL, NULL, \'{"lte":932,"gte":221}\', 1, NULL, \'2019-08-16 08:43:57.488\', NULL),
    ...
    public function testFieldGetChanged(): void
    {
        ...
        $m = new Migration1638365464CheapestPricePercentageDynamicProductGroups();
        $m->update($connection);
        ...
        static::assertContains('cheapestPrice.percentage', $fields);
