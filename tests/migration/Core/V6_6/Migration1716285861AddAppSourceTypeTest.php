...
class Migration1716285861AddAppSourceTypeTest extends TestCase
{
    ...
    {
        static::assertFalse(DbTableHelper::columnExists($this->connection, 'app', 'source_type'));

        $migration = new Migration1716285861AddAppSourceType();
        $migration->update($this->connection);
        $migration->update($this->connection);

        static::assertTrue(DbTableHelper::columnExists($this->connection, 'app', 'source_type'));
    }
}
