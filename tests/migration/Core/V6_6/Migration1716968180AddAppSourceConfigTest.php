...
class Migration1716968180AddAppSourceConfigTest extends TestCase
{
    ...
    {
        static::assertFalse(DbTableHelper::columnExists($this->connection, 'app', 'source_config'));

        $migration = new Migration1716968180AddAppSourceConfig();
        $migration->update($this->connection);
        $migration->update($this->connection);

        static::assertTrue(DbTableHelper::columnExists($this->connection, 'app', 'source_config'));
    }
}
