...
class Migration1720094362AddStateForeignKeyToOrderDeliveryTest extends TestCase
{
    ...
    private function hasForeignKey(): bool
    {
        ...
        return (bool) \array_filter($columns, static fn (ForeignKeyConstraint $column) => $column->getReferencedTableName()->toString() === 'state_machine_state' && $column->getReferencingColumnNames() === ['state_id'] && $column->getReferencedColumnNames() === ['id']);
    }
}
