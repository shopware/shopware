...
class Migration1736866790AddDocumentA11yMediaFileIdForDocumentTableTest extends TestCase
{
    ...
    private function hasForeignKey(): bool
    {
        ...
        return (bool) \array_filter($columns, static fn (ForeignKeyConstraint $column) => $column->getReferencedTableName()->toString() === 'media' && $column->getReferencingColumnNames() === ['document_a11y_media_file_id'] && $column->getReferencedColumnNames() === ['id']);
    }
}
