...
use Shopware\Core\Migration\V6_6\Migration1788531955MakeProductGuaranteeConfirmedInheritable;
...
class Migration1788531955MakeProductGuaranteeConfirmedInheritableTest extends TestCase
{
    ...
    public function testMigrationMakesGuaranteeConfirmedNullable(): void
    {
        ...
        $column = $this->fetchGuaranteeConfirmedColumn();
        static::assertNotNull($column);
        static::assertSame('NO', $column['Null']);
    ...
    {
        if ($this->fetchGuaranteeConfirmedColumn() !== null) {
