...
class Migration1746176773AddIntegrationIdStateHistoryTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        $foreignKey = DbTableHelper::getForeignKeyOfTable($connection, 'state_machine_history', 'fk.state_machine_history.integration_id');
    ...
    {
        if (DbTableHelper::indexExists($connection, 'state_machine_history', 'integration_id')) {
