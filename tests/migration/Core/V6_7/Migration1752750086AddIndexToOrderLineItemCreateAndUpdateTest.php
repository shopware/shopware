...
class Migration1752750086AddIndexToOrderLineItemCreateAndUpdateTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        static::assertTrue(DbTableHelper::indexExists($this->connection, 'order_line_item', 'idx.order_line_item_created_updated'));
    }

    private function rollback(): void
    {
        if (DbTableHelper::indexExists($this->connection, 'order_line_item', 'idx.order_line_item_created_updated')) {
