...
class Migration1752750171AddIndexToOrderAddressCreateAndUpdateTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        static::assertTrue(DbTableHelper::indexExists($this->connection, 'order_address', 'idx.order_address_created_updated'));
    }

    private function rollback(): void
    {
        if (DbTableHelper::indexExists($this->connection, 'order_address', 'idx.order_address_created_updated')) {
