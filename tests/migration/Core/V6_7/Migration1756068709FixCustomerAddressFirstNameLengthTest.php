...
class Migration1756068709FixCustomerAddressFirstNameLengthTest extends TestCase
{
    ...
    public function testMigrationChangesColumnLengthAndIsIdempotent(): void
    {
        ...
        $firstNameColumn = DbTableHelper::getColumnOfTable($this->connection, 'customer_address', 'first_name');
        static::assertSame(Type::lookupName(Type::getType(Types::STRING)), $firstNameColumn->type);
