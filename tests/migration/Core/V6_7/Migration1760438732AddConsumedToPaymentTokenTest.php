...
class Migration1760438732AddConsumedToPaymentTokenTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        static::assertTrue(DbTableHelper::columnExists($this->connection, 'payment_token', 'consumed'));
    }

    private function rollback(): void
    {
        if (DbTableHelper::columnExists($this->connection, 'payment_token', 'consumed')) {
