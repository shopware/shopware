...
use Shopware\Core\Migration\V6_7\Migration1764939915CancellationRequestMerchantMailTemplate;

/**
 * @internal
 */
#[Package('after-sales')]
#[CoversClass(Migration1764939915CancellationRequestMerchantMailTemplate::class)]
class Migration1764939915CancellationRequestMerchantMailTemplateTest extends TestCase
{
    ...
    public function testUpdate(): void
    {
        ...
        $migration = new Migration1764939915CancellationRequestMerchantMailTemplate();
