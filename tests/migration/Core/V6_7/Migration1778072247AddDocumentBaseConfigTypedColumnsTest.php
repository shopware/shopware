...
class Migration1778072247AddDocumentBaseConfigTypedColumnsTest extends TestCase
{
    ...
    public function testMigration(): void
    {
        ...
        // Mixed invalid: JSON null string, non-integer items-per-page, all-false booleans.
        $this->connection->update('document_base_config', [
            'config' => json_encode([
                'pageSize' => null,
                'itemsPerPage' => '25',
        ...
        // All keys absent: backfill must leave string/int columns NULL; booleans get NULL too
