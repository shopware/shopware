...
class Migration1780645634AddProductDescriptionTeaserTest extends TestCase
{
    ...
    public function testUpdateAddsVirtualGeneratedColumn(): void
    {
        ...
        static::assertSame('VIRTUAL GENERATED', $column['EXTRA']);
        static::assertStringContainsStringIgnoringCase('left', (string) $column['GENERATION_EXPRESSION']);
        static::assertStringContainsStringIgnoringCase('regexp_replace', (string) $column['GENERATION_EXPRESSION']);
    }
