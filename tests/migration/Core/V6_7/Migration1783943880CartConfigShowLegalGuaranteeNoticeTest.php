...
use Shopware\Core\Migration\V6_7\Migration1783943880CartConfigShowLegalGuaranteeNotice;

/**
 * @internal
 */
#[Package('inventory')]
#[CoversClass(Migration1783943880CartConfigShowLegalGuaranteeNotice::class)]
class Migration1783943880CartConfigShowLegalGuaranteeNoticeTest extends TestCase
{
    use KernelTestBehaviour;

    public const SYSTEM_KEY = 'core.cart.showLegalGuaranteeNotice';

    public function testGetCreationTimestamp(): void
    {
        static::assertSame(1783943880, (new Migration1783943880CartConfigShowLegalGuaranteeNotice())->getCreationTimestamp());
    }
    ...
    public function testMigration(): void
    {
        ...
        $migration = new Migration1783943880CartConfigShowLegalGuaranteeNotice();
