...
use Shopware\Core\Migration\V6_7\Migration1785230611AddSeoUrlUpdateAclPrivilege;
 ...
 */
#[Package('framework')]
#[CoversClass(Migration1785230611AddSeoUrlUpdateAclPrivilege::class)]
class Migration1785230611AddSeoUrlUpdateAclPrivilegeTest extends TestCase
{
    use MigrationTestTrait;

    private Connection $connection;

    private Migration1785230611AddSeoUrlUpdateAclPrivilege $migration;
    ...
    protected function setUp(): void
    {
        ...
        $this->migration = new Migration1785230611AddSeoUrlUpdateAclPrivilege();
    }

    public function testGetCreationTimestamp(): void
    {
        static::assertSame(1785230611, $this->migration->getCreationTimestamp());
    }

    #[DataProvider('providerEditorRoles')]
     ...
     */
    public static function providerEditorRoles(): array
    {
        return [
            ['product.editor'],
            ['category.editor'],
