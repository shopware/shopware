 ...
 * @internal
 *
 * @covers \Shopware\Core\Checkout\Promotion\Cart\PromotionDeliveryCalculator
 */
class PromotionDeliveryCalculatorTest extends TestCase
{
    ...
    {
        $lineItems = new LineItem(Uuid::randomHex(), LineItem::PRODUCT_LINE_ITEM_TYPE);
        ...
        static::assertEquals('Promotion second-promotion not eligible for cart!', $error->getMessage());
    }
