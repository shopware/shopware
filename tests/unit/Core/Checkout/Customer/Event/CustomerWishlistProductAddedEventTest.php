 ...
 */
#[Package('checkout')]
#[CoversClass(CustomerWishlistProductAddedEvent::class)]
class CustomerWishlistProductAddedEventTest extends TestCase
{
    public function testWebhookPayloadContract(): void
    {
        ...
        ], CustomerWishlistProductAddedEvent::getAvailableData()->toArray());
    }
    ...
    public function testEventCarriesWishlistProductAndCustomer(): void
    {
        ...
        $event = new CustomerWishlistProductAddedEvent($salesChannelContext, $wishlistId, $productId, $customerId);

        static::assertSame(CustomerWishlistProductAddedEvent::EVENT_NAME, $event->getName());
