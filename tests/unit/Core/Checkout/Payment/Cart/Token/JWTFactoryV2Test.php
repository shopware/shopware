...
class JWTFactoryV2Test extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $configuration->withValidationConstraints(new NoopConstraint());
    ...
    {
        $configuration = Configuration::forSymmetricSigner(new TestSigner(), new TestKey());
        $configuration->withValidationConstraints(new StrictValidAt(new FrozenClock(new \DateTimeImmutable('now - 1 day'))));
