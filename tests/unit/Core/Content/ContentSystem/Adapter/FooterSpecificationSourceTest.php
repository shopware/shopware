...
use Shopware\Core\Content\ContentSystem\Adapter\FooterSpecificationSource;
...
class FooterSpecificationSourceTest extends TestCase
{
    ...
    {
        static::expectExceptionObject(new DecorationPatternException(FooterSpecificationSource::class));
