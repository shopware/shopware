...
class ContentSectionTest extends TestCase
{
     ...
     */
    public static function routePathSegmentProvider(): \Generator
    {
     ...
     */
    public static function buildLayoutTagProvider(): \Generator
    {
    ...
    #[DataProvider('routePathSegmentProvider')]
    ...
    #[DataProvider('buildLayoutTagProvider')]
     ...
     */
    public static function buildRouteCacheTagsProvider(): \Generator
    {
