...
class SetCustomerGroupCustomFieldActionTest extends TestCase
{
    ...
    /**
     * @param EntityRepository<CustomerGroupCollection>|null $repository
     */
    private function createAction(?Connection $connection = null, ?EntityRepository $repository = null): SetCustomerGroupCustomFieldAction
    {
        return new SetCustomerGroupCustomFieldAction(
