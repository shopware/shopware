...
class ImportExportExceptionTest extends TestCase
{
    ...
    {
        yield [
            'exceptionFunction' => static fn () => ImportExportException::invalidFileAccessToken(),
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::fileNotFound('notFoundFile'),
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::processingError('Cannot merge file'),
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::requiredByUser('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::invalidIdentifier('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::decorationPattern('foo'),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
            'errorCode' => '500',
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::profileNotFound('null'),
            'statusCode' => Response::HTTP_NOT_FOUND,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::couldNotOpenFile('foo'),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::couldNotCreateFile('foo'),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::couldNotCopyFile('foo'),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::couldNotWriteToBuffer(),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::fieldCannotBeExported('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::fileEmpty('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::fileNotReadable('foo'),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::filePathNotFound(),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::invalidFileContent('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::logEntityNotFound('bar'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::profileWithoutMappings('bar'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::profileWrongType('bar', 'foo'),
            'statusCode' => Response::HTTP_NOT_FOUND,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::unexpectedFileType('foo', 'bar'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::unknownActivity('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::invalidRequestParameter('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::missingPrivilege(['foo', 'bar']),
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::profileSearchEmpty(),
            'statusCode' => Response::HTTP_NOT_FOUND,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::importCommandFailed('Some message that explains the error.'),
            'statusCode' => Response::HTTP_INTERNAL_SERVER_ERROR,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::duplicateTechnicalName('foo'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::deserializationFailed('id', 'foo', 'bar'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::deserializationFailed('id', null, 'bar'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
            'errorCode' => 'CONTENT__IMPORT_EXPORT__DESERIALIZE_FAILED',
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::invalidInstanceType('foo', 'bar'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
        ...
        yield [
            'exceptionFunction' => static fn () => ImportExportException::serializerNotFound('test'),
            'statusCode' => Response::HTTP_BAD_REQUEST,
