...
namespace {
    require_once __DIR__ . '/JsonlRowParserFunctionMock.php';
}
...
namespace Shopware\Tests\Unit\Core\Content\ProductExport\Validator {
    ...
    class JsonlRowParserTest extends TestCase
    {
        ...
        public function testParseThrowsExceptionWhenLineSplitFails(): void
        {
            JsonlRowParserFunctionMock::$forcePregSplitFailure = true;
            $parser = new JsonlRowParser();
            ...
            try {
                ...
                JsonlRowParserFunctionMock::$forcePregSplitFailure = false;
            }
        }
    }
}
