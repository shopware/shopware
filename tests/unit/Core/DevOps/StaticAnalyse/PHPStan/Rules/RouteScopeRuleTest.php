...
class RouteScopeRuleTest extends RuleTestCase
{
    ...
    public function testRouteScopeRule(): void
    {
        $this->analyse([__DIR__ . '/data/RouteScope/ControllerWithRouteAttribute.php'], [
            [
                'Method Shopware\Tests\Unit\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\RouteScope\ControllerWithRouteAttribute::resetScope() has no route scope defined. Please add a route scope to the method or the class.',
                22,
            ],
        ]);
        ...
        $this->analyse([__DIR__ . '/data/RouteScope/ControllerWithoutRouteAttribute.php'], [
            [
                'Method Shopware\Tests\Unit\Core\DevOps\StaticAnalyse\PHPStan\Rules\data\RouteScope\ControllerWithoutRouteAttribute::withoutScope() has no route scope defined. Please add a route scope to the method or the class.',
                15,
            ],
        ]);
    }
