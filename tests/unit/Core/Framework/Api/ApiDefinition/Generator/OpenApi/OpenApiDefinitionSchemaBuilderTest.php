...
class OpenApiDefinitionSchemaBuilderTest extends TestCase
{
    ...
    public function testTypeConversion(): void
    {
        ...
        $properties = json_decode($schema['Simple']->toJson(), true, 512, \JSON_THROW_ON_ERROR)['properties'];
    ...
    public function testExtensionConversion(): void
    {
        ...
        $properties = json_decode($schema['SimpleExtended']->toJson(), true, 512, \JSON_THROW_ON_ERROR)['properties'];
    ...
    public function testAssociationDescriptions(): void
    {
        ...
        $properties = json_decode($schema['Complex']->toJson(), true, 512, \JSON_THROW_ON_ERROR)['properties'];
