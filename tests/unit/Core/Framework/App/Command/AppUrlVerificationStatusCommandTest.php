...
class AppUrlVerificationStatusCommandTest extends TestCase
{
    ...
    protected function setUp(): void
    {
        ...
        $command = new AppUrlVerificationStatusCommand($this->shopIdProvider, $this->verifier);
    ...
    public function testNoStateShowsWarningAndSucceeds(): void
    {
        ...
        static::assertStringContainsString('No verification status found. Run "app:url:verify".', $output);
    }
    ...
    public function testPassStateShowsOkAndDetails(): void
    {
        ...
        $this->shopIdProvider->method('getShopIdWithoutVerification')->willReturn($shopId);
