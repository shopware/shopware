 ...
 * @internal
 */
#[CoversClass(CustomFieldPersister::class)]
class CustomFieldPersisterTest extends TestCase
{
    ...
    public function testPersistWithExternalFile(): void
    {
        ...
        $persister = new CustomFieldPersister($sharedPersister);
        $persister->persist($this->createContext($this->tmpDir));
    }
    ...
    private function createContext(string $appDir): AppLifecycleContext
    {
