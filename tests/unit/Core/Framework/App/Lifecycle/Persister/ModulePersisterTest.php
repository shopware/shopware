...
use Shopware\Core\Framework\App\Lifecycle\Persister\ModulePersister;
 ...
 * @internal
 */
#[CoversClass(ModulePersister::class)]
class ModulePersisterTest extends TestCase
{
    ...
    public function testPersistDoesNothingWithoutAppSecret(): void
    {
        ...
        $persister = new ModulePersister($appRepository);
        $persister->persist($this->buildContext(hasSecret: false));
    ...
    public function testPersistClearsModulesWhenNoAdminSection(): void
    {
        ...
        $persister = new ModulePersister($appRepository);
        $persister->persist($this->buildContext(hasSecret: true, admin: null));
    ...
    public function testPersistModulesWithMainModuleOnly(): void
    {
        ...
        $persister = new ModulePersister($appRepository);
        $persister->persist($this->buildContext(hasSecret: true, admin: $admin));
    ...
    private function buildContext(bool $hasSecret, ?Admin $admin = null): AppLifecycleContext
    {
        $app = new AppEntity();
