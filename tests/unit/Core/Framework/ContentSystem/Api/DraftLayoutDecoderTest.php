...
class DraftLayoutDecoderTest extends TestCase
{
    ...
    {
        $tree = $this->decoder()->decode([['id' => 'el-1', 'component' => 'Sw:Block']]);
    ...
    #[TestDox('decode wraps a raw property payload into the storage value envelope')]
    public function testDecodeWrapsPropertiesIntoStoredValues(): void
    {
