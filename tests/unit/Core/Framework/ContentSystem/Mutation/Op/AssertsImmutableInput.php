 ...
 * style, attributed specifications, and slot children recursively. Leaf value objects are held by reference, so
 * the strict comparison detects a swapped object as well as a changed scalar.
 *
 * @internal
 *
...
trait AssertsImmutableInput
{
    ...
    private function snapshotElement(ContentElement $element): array
    {
        ...
        return [
            ...
            'attributedSpecifications' => $element->getAttributedSpecifications(),
            'slots' => $slots,
        ];
    }
}
