...
class ResolvedValueIndexFactoryTest extends TestCase
{
     ...
     */
    #[TestDox('respects custom keyProperty in keyed delivery and assigns its own ref')]
     ...
     */
    #[TestDox('creates distinct refs when resolving one config against different inputs')]
     ...
     */
    #[TestDox('shares the provider ref when broadcast delivery hands the provider instance')]
     ...
     */
    #[TestDox('gives keyed delivery its own ref, distinct from the provider map')]
     ...
     */
    #[TestDox('gives indexed delivery its own ref, distinct from the provider list')]
     ...
     */
    #[TestDox('gives sliced delivery its own ref for its chunk, distinct from the provider list')]
     ...
     */
    #[TestDox('gives iterator delivery its own ref, distinct from the provider map')]
     ...
     */
    #[TestDox('takes its own ref for dotted broadcast delivery of the traversed value')]
    ...
    #[TestDox('shares one null-valued ref across all null-resolved loaders')]
     ...
     */
    #[TestDox('assigns distinct refs to replaced loader-resolved values and preserves their emission slots')]
     ...
     */
    #[TestDox('assigns distinct refs to replaced loader-resolved object values and preserves their instances')]
