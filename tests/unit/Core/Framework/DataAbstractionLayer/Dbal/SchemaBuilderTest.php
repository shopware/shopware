...
class SchemaBuilderTest extends TestCase
{
    ...
    public function testForeignKeys(): void
    {
        ...
        static::assertTrue($table->hasForeignKey('fk_2f88a1b9efb9c8a5'));
        static::assertTrue($table->hasForeignKey('fk_2f88a1b9bc8650a2'));
        static::assertTrue($table->hasForeignKey('fk_2f88a1b9cb816034'));

        $associationFk = $table->getForeignKey('fk_2f88a1b9efb9c8a5');
        ...
        $associationFk2 = $table->getForeignKey('fk_2f88a1b9bc8650a2');
        ...
        $associationFk3 = $table->getForeignKey('fk_2f88a1b9cb816034');
