...
class ConfigurationTest extends TestCase
{
    ...
    public function testProductSearchKeywordRelevantKeywordCountNode(): void
    {
        $configuration = new Configuration();
        ...
        static::assertInstanceOf(ArrayNodeDefinition::class, $productNode = $nodes['product']);

        $nodes = $productNode->getChildNodeDefinitions();
