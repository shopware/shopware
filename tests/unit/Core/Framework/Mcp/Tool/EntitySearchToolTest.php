...
class EntitySearchToolTest extends TestCase
{
    public function testSearchWithDefaultCriteria(): void
    {
        ...
        $tool = new EntitySearchTool($registry, $criteriaBuilder, $contextProvider);
        $output = ($tool)('product');
    ...
    public function testSearchWithPagination(): void
    {
        ...
        static::assertSame(42, $data['total']);
    ...
    public function testDeniesAccessWithoutReadPermission(): void
    {
        ...
        $tool = new EntitySearchTool($registry, $this->createMock(RequestCriteriaBuilder::class), $contextProvider);
        $output = ($tool)('product');
