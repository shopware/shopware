...
class CustomEntityNameValidatorTest extends TestCase
{
    ...
    /**
     * A name may only contain letters, digits, underscores and dollar signs. Any other character
     * (whitespace or punctuation) is what would let a name break out of its identifier position, so
     * those are the relevant cases to reject - no full statements needed to prove it.
     *
