...
class OrderAdminSearchIndexerTest extends TestCase
{
    ...
    public function testFetching(): void
    {
        ...
        static::assertIsArray($document['transactions']);
        static::assertSame('2233445566778899aabb00112233ccdd', $document['transactions']['id']);
        static::assertSame('3344556677889900aabb00112233ccdd', $document['transactions']['stateMachineState']['id']);
        static::assertSame(1, $document['transactions']['stateMachineState']['_count']);
        static::assertSame('4455667788990011aabb00112233ccdd', $document['transactions']['paymentMethodId']);
        static::assertIsArray($document['deliveries']);
        static::assertSame('5566778899001122aabb00112233ccdd', $document['deliveries']['id']);
        static::assertSame('6677889900112233aabb00112233ccdd', $document['deliveries']['stateMachineState']['id']);
        static::assertSame(1, $document['deliveries']['stateMachineState']['_count']);
        static::assertSame('7788990011223344aabb00112233ccdd', $document['deliveries']['shippingMethodId']);
        static::assertSame('8899001122334455aabb00112233ccdd', $document['deliveries']['shippingOrderAddress']['countryId']);
