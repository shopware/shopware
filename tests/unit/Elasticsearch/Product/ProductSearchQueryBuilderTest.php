            ...
            'expected' => self::disMax([
                ...
                self::bool([
                    self::disMax([
                        ...
                        self::matchPhrasePrefix('name.' . Defaults::LANGUAGE_SYSTEM . '.search', 'foo 2023', 0.4, 3, 10),
                    ], 1000),
                    self::disMax([
                        self::must('ean', ['foo', '2023'], 2),
                        self::matchPhrase('ean.search', 'foo 2023', 4),
                        self::match('ean.search', 'foo 2023', 0.4, 0, 'and', 10),
                        self::matchPhrasePrefix('ean.search', 'foo 2023', 0.4, 3, 10),
                    ], 2000),
                    self::nested('tags', self::disMax([
                        ...
                        self::matchPhrasePrefix('tags.name.search', 'foo 2023', 0.4, 3, 10),
                    ], 500)),
                    self::nested('parent', self::disMax([
                        ...
                        self::matchPhrasePrefix('parent.name.' . Defaults::LANGUAGE_SYSTEM . '.search', 'foo 2023', 0.4, 3, 10),
                    ], 800)),
                ]),
            ]),
        ];
        ...
        yield 'Test multiple custom fields with terms' => [
            ...
            'expected' => self::disMax([
                ...
                self::disMax([
                    ...
                    self::matchPhrasePrefix($prefix . 'evolvesText.search', 'foo 2023', 0.4, 3, 10),
                ], 500),
            ]),
        ];
    }
            ...
            'expected' => self::disMax([
                ...
                self::disMax([
                    self::disMax([
                        ...
                        self::matchPhrasePrefix($prefixCfLang1 . 'evolvesText.search', 'foo 2023', 0.4, 3, 10),
                    ], 500),
                    self::disMax([
                        ...
                        self::matchPhrasePrefix($prefixCfLang2 . 'evolvesText.search', 'foo 2023', 0.4, 3, 10),
                    ], 400),
                ]),
            ]),
        ];
