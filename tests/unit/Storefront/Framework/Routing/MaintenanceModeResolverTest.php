...
class MaintenanceModeResolverTest extends TestCase
{
    ...
    private static function getRequest(
        ...
        $request->attributes->set(SalesChannelRequestAttribute::IS_SALES_CHANNEL_REQUEST->value, $isSalesChannelRequest);
        $request->attributes->set(SalesChannelRequestAttribute::SALES_CHANNEL_MAINTENANCE->value, $isMaintenanceModeActive);
        $request->attributes->set(SalesChannelRequestAttribute::SALES_CHANNEL_MAINTENANCE_IP_ALLOW_LIST->value, json_encode($allowedIpAddresses, \JSON_THROW_ON_ERROR));
