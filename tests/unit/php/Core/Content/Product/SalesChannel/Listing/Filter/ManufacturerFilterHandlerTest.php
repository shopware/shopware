...
use Shopware\Core\Content\Product\SalesChannel\Listing\Filter\ManufacturerFilterHandler;
 ...
 * @internal
 *
 * @covers \Shopware\Core\Content\Product\SalesChannel\Listing\Filter\ManufacturerFilterHandler
 */
class ManufacturerFilterHandlerTest extends TestCase
{
    private ManufacturerFilterHandler $handler;

    protected function setUp(): void
    {
        $this->handler = new ManufacturerFilterHandler();
    }
