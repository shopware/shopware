...
use Shopware\Core\Content\Product\SalesChannel\Listing\Filter\PropertyFilterHandler;
 ...
 * @internal
 *
 * @covers \Shopware\Core\Content\Product\SalesChannel\Listing\Filter\PropertyFilterHandler
 */
class PropertyFilterHandlerTest extends TestCase
{
    public function testDeactivateFilter(): void
    {
        ...
        $handler = new PropertyFilterHandler(
    ...
    {
        $request = new Request([], [PropertyFilterHandler::PROPERTY_GROUP_IDS_REQUEST_PARAM => ['color', 'size']]);
        $request->setMethod(Request::METHOD_POST);
    ...
    public function testProcess(): void
    {
        ...
        $handler = new PropertyFilterHandler($repository, $this->createMock(Connection::class));
