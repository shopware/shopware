...
use Shopware\Core\Content\Product\SalesChannel\Listing\Processor\AggregationProcessor;
 ...
 * @internal
 *
 * @covers \Shopware\Core\Content\Product\SalesChannel\Listing\Processor\AggregationProcessor
 */
class AggregationProcessorTest extends TestCase
{
    ...
    {
        $processor = new AggregationProcessor(
            [new FooFilterHandler(), new BarFilterHandler()],
            $this->createMock(EventDispatcherInterface::class)
        );
 ...
 * @internal
 */
class FooFilterHandler extends AbstractFilterHandler
{
 ...
 * @internal
 */
class BarFilterHandler extends AbstractFilterHandler
{
    public function getDecorated(): AbstractFilterHandler
    {
        throw new DecorationPatternException(self::class);
