...
use Shopware\Core\Content\Product\SalesChannel\Listing\Processor\PagingProcessor;
 ...
 * @internal
 *
 * @covers \Shopware\Core\Content\Product\SalesChannel\Listing\Processor\PagingProcessor
 */
class PagingProcessorTest extends TestCase
{
    ...
    public function testPrepare(Request $request, Criteria $expected, string $method = Request::METHOD_GET): void
    {
        ...
        $processor = new PagingProcessor($config);
