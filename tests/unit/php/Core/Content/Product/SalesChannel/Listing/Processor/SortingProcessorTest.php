...
use Shopware\Core\Content\Product\SalesChannel\Listing\Processor\SortingProcessor;
 ...
 * @internal
 *
 * @covers \Shopware\Core\Content\Product\SalesChannel\Listing\Processor\SortingProcessor
 */
class SortingProcessorTest extends TestCase
{
    ...
    private function buildSortings(): StaticEntityRepository
    {
